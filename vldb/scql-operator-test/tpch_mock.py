...
if __name__ == "__main__":
    ...
    SF = args.sf
    if args.party == "both":
        generate_lineitem(target + "ant_lineitem.csv", args.row)
        generate_lineitem(target + "isv_lineitem.csv", args.row)
        generate_orders(target + "isv_orders.csv", args.row)
        generate_part(target + "isv_part.csv", args.row)
    elif args.party == "isv":
        generate_lineitem(target + "isv_lineitem.csv", args.row)
        generate_orders(target + "isv_orders.csv", args.row)
        generate_part(target + "isv_part.csv", args.row)
