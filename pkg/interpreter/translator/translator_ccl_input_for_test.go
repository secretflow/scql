...
4 [label="Abs:{in:[In:{t_5,},],out:[Out:{t_6,},],attr:[],party:[alice,]}"]
5 [label="Ceil:{in:[In:{t_5,},],out:[Out:{t_7,},],attr:[],party:[alice,]}"]
6 [label="Floor:{in:[In:{t_5,},],out:[Out:{t_8,},],attr:[],party:[alice,]}"]
7 [label="Round:{in:[In:{t_5,},],out:[Out:{t_9,},],attr:[],party:[alice,]}"]
8 [label="Radians:{in:[In:{t_5,},],out:[Out:{t_10,},],attr:[],party:[alice,]}"]
9 [label="Degrees:{in:[In:{t_5,},],out:[Out:{t_11,},],attr:[],party:[alice,]}"]
10 [label="Ln:{in:[In:{t_5,},],out:[Out:{t_12,},],attr:[],party:[alice,]}"]
11 [label="Log10:{in:[In:{t_5,},],out:[Out:{t_13,},],attr:[],party:[alice,]}"]
12 [label="Log2:{in:[In:{t_5,},],out:[Out:{t_14,},],attr:[],party:[alice,]}"]
13 [label="Sqrt:{in:[In:{t_5,},],out:[Out:{t_15,},],attr:[],party:[alice,]}"]
14 [label="Exp:{in:[In:{t_5,},],out:[Out:{t_16,},],attr:[],party:[alice,]}"]
15 [label="publish:{in:[In:{t_6,t_7,t_8,t_9,t_10,t_11,t_12,t_13,t_14,t_15,t_16,},],out:[Out:{t_17,t_18,t_19,t_20,t_21,t_22,t_23,t_24,t_25,t_26,t_27,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_2:{join_int_0:PRIVATE:INT64}"]
10 -> 15 [label = "t_12:{plain_int_0:PRIVATE:FLOAT64}"]
11 -> 15 [label = "t_13:{plain_int_0:PRIVATE:FLOAT64}"]
12 -> 15 [label = "t_14:{plain_int_0:PRIVATE:FLOAT64}"]
13 -> 15 [label = "t_15:{plain_int_0:PRIVATE:FLOAT64}"]
14 -> 15 [label = "t_16:{plain_int_0:PRIVATE:FLOAT64}"]
2 -> 3 [label = "t_3:{join_int_0:PRIVATE:INT64}"]
3 -> 10 [label = "t_5:{plain_int_0:PRIVATE:INT64}"]
3 -> 11 [label = "t_5:{plain_int_0:PRIVATE:INT64}"]
3 -> 12 [label = "t_5:{plain_int_0:PRIVATE:INT64}"]
3 -> 13 [label = "t_5:{plain_int_0:PRIVATE:INT64}"]
...
3 -> 9 [label = "t_5:{plain_int_0:PRIVATE:INT64}"]
4 -> 15 [label = "t_6:{plain_int_0:PRIVATE:INT64}"]
5 -> 15 [label = "t_7:{plain_int_0:PRIVATE:INT64}"]
6 -> 15 [label = "t_8:{plain_int_0:PRIVATE:INT64}"]
7 -> 15 [label = "t_9:{plain_int_0:PRIVATE:INT64}"]
8 -> 15 [label = "t_10:{plain_int_0:PRIVATE:FLOAT64}"]
9 -> 15 [label = "t_11:{plain_int_0:PRIVATE:FLOAT64}"]
...
11 [label="percentile_disc:{in:[Group:{t_18,},In:{t_19,},],out:[Out:{t_21,},OutGroup:{t_20,},],attr:[percent:0.5,],party:[alice,bob,carol,]}"]
12 [label="count:{in:[Group:{t_18,},In:{t_18,},],out:[Out:{t_22,},],attr:[],party:[alice,bob,carol,]}"]
13 [label="make_public:{in:[In:{t_18,},],out:[Out:{t_23,},],attr:[],party:[alice,bob,carol,]}"]
14 [label="filter:{in:[Filter:{t_23,},In:{t_16,t_17,t_22,},],out:[Out:{t_24,t_25,t_26,},],attr:[],party:[alice,bob,carol,]}"]
15 [label="make_public:{in:[In:{t_20,},],out:[Out:{t_27,},],attr:[],party:[alice,bob,carol,]}"]
16 [label="filter:{in:[Filter:{t_27,},In:{t_21,},],out:[Out:{t_28,},],attr:[],party:[alice,bob,carol,]}"]
17 [label="make_constant:{in:[],out:[Out:{t_29,},],attr:[scalar:4,],party:[alice,bob,carol,]}"]
18 [label="broadcast:{in:[In:{t_29,},ShapeRefTensor:{t_26,},],out:[Out:{t_30,},],attr:[],party:[alice,bob,carol,]}"]
19 [label="make_private:{in:[In:{t_26,},],out:[Out:{t_31,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
20 [label="make_private:{in:[In:{t_30,},],out:[Out:{t_32,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
21 [label="GreaterEqual:{in:[Left:{t_31,},Right:{t_32,},],out:[Out:{t_33,},],attr:[],party:[alice,]}"]
22 [label="make_public:{in:[In:{t_33,},],out:[Out:{t_34,},],attr:[],party:[alice,bob,carol,]}"]
23 [label="apply_filter:{in:[Filter:{t_34,},In:{t_24,t_25,t_28,t_26,},],out:[Out:{t_35,t_36,t_37,t_38,},],attr:[],party:[alice,bob,carol,]}"]
24 [label="make_private:{in:[In:{t_35,},],out:[Out:{t_39,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
25 [label="make_private:{in:[In:{t_36,},],out:[Out:{t_41,},],attr:[reveal_to:bob,],party:[alice,bob,carol,]}"]
26 [label="copy:{in:[In:{t_41,},],out:[Out:{t_42,},],attr:[input_party_codes:bob,output_party_codes:alice,],party:[bob,alice,]}"]
27 [label="make_private:{in:[In:{t_37,},],out:[Out:{t_44,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
28 [label="publish:{in:[In:{t_39,t_42,t_44,},],out:[Out:{t_40,t_43,t_45,},],attr:[],party:[alice,]}"]
...
11 -> 15 [label = "t_20:{group_mark:SECRET:BOOL}"]
11 -> 16 [label = "t_21:{aggregate_int_0:SECRET:INT64}"]
12 -> 14 [label = "t_22:{group_mark:SECRET:INT64}"]
13 -> 14 [label = "t_23:{group_mark:PUBLIC:BOOL}"]
14 -> 18 [label = "t_26:{group_mark:SECRET:INT64}"]
14 -> 19 [label = "t_26:{group_mark:SECRET:INT64}"]
14 -> 23 [label = "t_24:{groupby_string_0:SECRET:STRING}"]
14 -> 23 [label = "t_25:{groupby_string_0:SECRET:STRING}"]
14 -> 23 [label = "t_26:{group_mark:SECRET:INT64}"]
15 -> 16 [label = "t_27:{group_mark:PUBLIC:BOOL}"]
16 -> 23 [label = "t_28:{aggregate_int_0:SECRET:INT64}"]
17 -> 18 [label = "t_29:{constant_data:PUBLIC:INT64}"]
18 -> 20 [label = "t_30:{constant_data:PUBLIC:INT64}"]
19 -> 21 [label = "t_31:{group_mark:PRIVATE:INT64}"]
2 -> 3 [label = "t_5:{join_int_0:PRIVATE:INT64}"]
2 -> 4 [label = "t_6:{join_int_0:PRIVATE:INT64}"]
20 -> 21 [label = "t_32:{constant_data:PRIVATE:INT64}"]
21 -> 22 [label = "t_33:{GreaterEqual_out:PRIVATE:BOOL}"]
22 -> 23 [label = "t_34:{GreaterEqual_out:PUBLIC:BOOL}"]
23 -> 24 [label = "t_35:{groupby_string_0:SECRET:STRING}"]
23 -> 25 [label = "t_36:{groupby_string_0:SECRET:STRING}"]
23 -> 27 [label = "t_37:{aggregate_int_0:SECRET:INT64}"]
24 -> 28 [label = "t_39:{groupby_string_0:PRIVATE:STRING}"]
25 -> 26 [label = "t_41:{groupby_string_0:PRIVATE:STRING}"]
26 -> 28 [label = "t_42:{groupby_string_0:PRIVATE:STRING}"]
27 -> 28 [label = "t_44:{aggregate_int_0:PRIVATE:INT64}"]
...
8 -> 10 [label = "t_15:{aggregate_int_0:SECRET:INT64}"]
8 -> 14 [label = "t_16:{groupby_string_0:SECRET:STRING}"]
8 -> 14 [label = "t_17:{groupby_string_0:SECRET:STRING}"]
...
5 [label="percentile_disc:{in:[GroupId:{t_7,},GroupNum:{t_8,},In:{t_6,},],out:[Out:{t_9,},],attr:[percent:0.3,],party:[alice,]}"]
...
12 [label="publish:{in:[In:{t_15,t_16,},],out:[Out:{t_18,t_19,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_2:{join_int_0:PRIVATE:INT64}"]
10 -> 11 [label = "t_14:{GreaterEqual_out:PRIVATE:BOOL}"]
11 -> 12 [label = "t_15:{join_int_0_firstrow:PRIVATE:INT64}"]
11 -> 12 [label = "t_16:{plain_int_0_percentile_disc:PRIVATE:INT64}"]
2 -> 3 [label = "t_3:{join_int_0:PRIVATE:INT64}"]
...
5 -> 11 [label = "t_9:{plain_int_0_percentile_disc:PRIVATE:INT64}"]
...
1 -> 2 [label = "t_2:{join_int_0:PRIVATE:INT64}"]
10 -> 11 [label = "t_14:{GreaterEqual_out:PRIVATE:BOOL}"]
11 -> 13 [label = "t_15:{join_int_0_firstrow:PRIVATE:INT64}"]
11 -> 13 [label = "t_16:{plain_int_0_sum:PRIVATE:INT64}"]
11 -> 13 [label = "t_17:{group_id_count:PRIVATE:INT64}"]
12 -> 13 [label = "t_18:{Column#362:PRIVATE:INT64}"]
13 -> 14 [label = "t_19:{plain_int_0_sum:PRIVATE:INT64}"]
13 -> 14 [label = "t_22:{Column#362:PRIVATE:INT64}"]
13 -> 15 [label = "t_20:{join_int_0_firstrow:PRIVATE:INT64}"]
14 -> 15 [label = "t_23:{Greater_out:PRIVATE:BOOL}"]
15 -> 16 [label = "t_24:{join_int_0_firstrow:PRIVATE:INT64}"]
2 -> 3 [label = "t_3:{join_int_0:PRIVATE:INT64}"]
3 -> 4 [label = "t_5:{join_int_0:PRIVATE:INT64}"]
3 -> 5 [label = "t_6:{plain_int_0:PRIVATE:INT64}"]
3 -> 6 [label = "t_5:{join_int_0:PRIVATE:INT64}"]
...
3 [label="filter_by_index:{in:[Data:{t_0,t_1,},RowsIndexFilter:{t_3,},],out:[Out:{t_5,t_6,},],attr:[],party:[alice,]}"]
4 [label="group:{in:[Key:{t_5,},],out:[GroupId:{t_7,},GroupNum:{t_8,},],attr:[],party:[alice,]}"]
5 [label="PercentRank:{in:[Key:{t_6,},PartitionId:{t_7,},PartitionNum:{t_8,},],out:[Out:{t_9,},],attr:[reverse:[0],],party:[alice,]}"]
6 [label="publish:{in:[In:{t_5,t_9,},],out:[Out:{t_10,t_11,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_2:{join_int_0:PRIVATE:INT64}"]
...
4 -> 5 [label = "t_7:{group_id:PRIVATE:INT64}"]
4 -> 5 [label = "t_8:{group_num:PRIVATE:INT64}"]
5 -> 6 [label = "t_9:{Out:PRIVATE:FLOAT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false},
	},
...
2 [label="join:{in:[Left:{t_0,},Right:{t_2,},],out:[LeftJoinIndex:{t_3,},RightJoinIndex:{t_4,},],attr:[input_party_codes:[alice bob],join_type:0,psi_algorithm:0,],party:[alice,bob,]}"]
3 [label="filter_by_index:{in:[Data:{t_1,},RowsIndexFilter:{t_3,},],out:[Out:{t_5,},],attr:[],party:[alice,]}"]
4 [label="publish:{in:[In:{t_5,},],out:[Out:{t_6,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_2:{join_int_0:PRIVATE:INT64}"]
2 -> 3 [label = "t_3:{join_int_0:PRIVATE:INT64}"]
...
3 [label="join:{in:[Left:{t_1,},Right:{t_3,},],out:[LeftJoinIndex:{t_4,},RightJoinIndex:{t_5,},],attr:[input_party_codes:[alice bob],join_type:0,psi_algorithm:0,],party:[alice,bob,]}"]
4 [label="filter_by_index:{in:[Data:{t_1,t_2,},RowsIndexFilter:{t_4,},],out:[Out:{t_6,t_7,},],attr:[],party:[alice,]}"]
5 [label="Add:{in:[Left:{t_6,},Right:{t_7,},],out:[Out:{t_8,},],attr:[],party:[alice,]}"]
...
3 [label="join:{in:[Left:{t_1,},Right:{t_3,},],out:[LeftJoinIndex:{t_4,},RightJoinIndex:{t_5,},],attr:[input_party_codes:[alice bob],join_type:0,psi_algorithm:0,],party:[alice,bob,]}"]
4 [label="filter_by_index:{in:[Data:{t_1,t_2,},RowsIndexFilter:{t_4,},],out:[Out:{t_6,t_7,},],attr:[],party:[alice,]}"]
5 [label="reduce_avg:{in:[In:{t_6,},],out:[Out:{t_8,},],attr:[],party:[alice,]}"]
6 [label="reduce_sum:{in:[In:{t_7,},],out:[Out:{t_9,},],attr:[],party:[alice,]}"]
7 [label="Add:{in:[Left:{t_8,},Right:{t_9,},],out:[Out:{t_10,},],attr:[],party:[alice,]}"]
...
1 -> 4 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
1 -> 4 [label = "t_2:{plain_int_1:PRIVATE:INT64}"]
10 -> 11 [label = "t_13:{Add_out:PRIVATE:FLOAT64}"]
11 -> 12 [label = "t_14:{plain_int_0:PRIVATE:INT64}"]
11 -> 12 [label = "t_15:{Add_out:PRIVATE:FLOAT64}"]
11 -> 13 [label = "t_14:{plain_int_0:PRIVATE:INT64}"]
12 -> 13 [label = "t_16:{Greater_out:PRIVATE:BOOL}"]
13 -> 14 [label = "t_17:{plain_int_0:PRIVATE:INT64}"]
2 -> 3 [label = "t_3:{plain_int_0:PRIVATE:INT64}"]
3 -> 4 [label = "t_4:{plain_int_0:PRIVATE:INT64}"]
4 -> 5 [label = "t_6:{plain_int_0:PRIVATE:INT64}"]
4 -> 6 [label = "t_7:{plain_int_1:PRIVATE:INT64}"]
5 -> 7 [label = "t_8:{plain_int_0:PRIVATE:FLOAT64}"]
6 -> 7 [label = "t_9:{plain_int_1:PRIVATE:INT64}"]
7 -> 10 [label = "t_10:{Add_out:PRIVATE:FLOAT64}"]
7 -> 9 [label = "t_10:{Add_out:PRIVATE:FLOAT64}"]
...
3 [label="filter_by_index:{in:[Data:{t_1,t_2,},RowsIndexFilter:{t_4,},],out:[Out:{t_6,t_7,},],attr:[],party:[alice,]}"]
4 [label="make_constant:{in:[],out:[Out:{t_8,},],attr:[scalar:2,],party:[alice,bob,carol,]}"]
5 [label="broadcast:{in:[In:{t_8,},ShapeRefTensor:{t_7,},],out:[Out:{t_9,},],attr:[],party:[alice,]}"]
6 [label="Pow:{in:[Left:{t_7,},Right:{t_9,},],out:[Out:{t_10,},],attr:[],party:[alice,]}"]
7 [label="make_constant:{in:[],out:[Out:{t_11,},],attr:[scalar:3,],party:[alice,bob,carol,]}"]
8 [label="broadcast:{in:[In:{t_11,},ShapeRefTensor:{t_6,},],out:[Out:{t_12,},],attr:[],party:[alice,]}"]
9 [label="Pow:{in:[Left:{t_6,},Right:{t_12,},],out:[Out:{t_13,},],attr:[],party:[alice,]}"]
10 [label="publish:{in:[In:{t_10,t_13,},],out:[Out:{t_14,t_15,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_1:{plain_float_0:PRIVATE:FLOAT32}"]
0 -> 3 [label = "t_2:{plain_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_3:{join_int_0:PRIVATE:INT64}"]
2 -> 3 [label = "t_4:{join_int_0:PRIVATE:INT64}"]
3 -> 5 [label = "t_7:{plain_int_0:PRIVATE:INT64}"]
3 -> 6 [label = "t_7:{plain_int_0:PRIVATE:INT64}"]
3 -> 8 [label = "t_6:{plain_float_0:PRIVATE:FLOAT32}"]
3 -> 9 [label = "t_6:{plain_float_0:PRIVATE:FLOAT32}"]
4 -> 5 [label = "t_8:{constant_data:PUBLIC:INT64}"]
5 -> 6 [label = "t_9:{constant_data:PRIVATE:INT64}"]
6 -> 10 [label = "t_10:{Pow_out:PRIVATE:INT64}"]
7 -> 8 [label = "t_11:{constant_data:PUBLIC:INT64}"]
8 -> 9 [label = "t_12:{constant_data:PRIVATE:INT64}"]
9 -> 10 [label = "t_13:{Pow_out:PRIVATE:FLOAT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
...
4 [label="Tan:{in:[In:{t_8,},],out:[Out:{t_9,},],attr:[],party:[alice,]}"]
5 [label="Tan:{in:[In:{t_7,},],out:[Out:{t_10,},],attr:[],party:[alice,]}"]
6 [label="make_constant:{in:[],out:[Out:{t_11,},],attr:[scalar:1,],party:[alice,bob,carol,]}"]
7 [label="Tan:{in:[In:{t_8,},],out:[Out:{t_12,},],attr:[],party:[alice,]}"]
8 [label="broadcast:{in:[In:{t_11,},ShapeRefTensor:{t_12,},],out:[Out:{t_13,},],attr:[],party:[alice,]}"]
9 [label="Div:{in:[Left:{t_13,},Right:{t_12,},],out:[Out:{t_14,},],attr:[],party:[alice,]}"]
10 [label="make_constant:{in:[],out:[Out:{t_15,},],attr:[scalar:1,],party:[alice,bob,carol,]}"]
11 [label="Tan:{in:[In:{t_7,},],out:[Out:{t_16,},],attr:[],party:[alice,]}"]
12 [label="broadcast:{in:[In:{t_15,},ShapeRefTensor:{t_16,},],out:[Out:{t_17,},],attr:[],party:[alice,]}"]
13 [label="Div:{in:[Left:{t_17,},Right:{t_16,},],out:[Out:{t_18,},],attr:[],party:[alice,]}"]
14 [label="ASin:{in:[In:{t_8,},],out:[Out:{t_19,},],attr:[],party:[alice,]}"]
15 [label="ASin:{in:[In:{t_7,},],out:[Out:{t_20,},],attr:[],party:[alice,]}"]
16 [label="ATan:{in:[In:{t_8,},],out:[Out:{t_21,},],attr:[],party:[alice,]}"]
17 [label="ATan:{in:[In:{t_7,},],out:[Out:{t_22,},],attr:[],party:[alice,]}"]
18 [label="publish:{in:[In:{t_6,t_9,t_10,t_14,t_18,t_19,t_20,t_21,t_22,},],out:[Out:{t_23,t_24,t_25,t_26,t_27,t_28,t_29,t_30,t_31,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_1:{plain_float_0:PRIVATE:FLOAT32}"]
0 -> 3 [label = "t_2:{plain_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_3:{join_int_0:PRIVATE:INT64}"]
10 -> 12 [label = "t_15:{constant_data:PUBLIC:INT64}"]
11 -> 12 [label = "t_16:{plain_float_0:PRIVATE:FLOAT64}"]
11 -> 13 [label = "t_16:{plain_float_0:PRIVATE:FLOAT64}"]
12 -> 13 [label = "t_17:{constant_data:PRIVATE:INT64}"]
13 -> 18 [label = "t_18:{Div_out:PRIVATE:FLOAT64}"]
14 -> 18 [label = "t_19:{plain_int_0:PRIVATE:FLOAT64}"]
15 -> 18 [label = "t_20:{plain_float_0:PRIVATE:FLOAT64}"]
16 -> 18 [label = "t_21:{plain_int_0:PRIVATE:FLOAT64}"]
17 -> 18 [label = "t_22:{plain_float_0:PRIVATE:FLOAT64}"]
2 -> 3 [label = "t_4:{join_int_0:PRIVATE:INT64}"]
3 -> 11 [label = "t_7:{plain_float_0:PRIVATE:FLOAT32}"]
3 -> 14 [label = "t_8:{plain_int_0:PRIVATE:INT64}"]
3 -> 15 [label = "t_7:{plain_float_0:PRIVATE:FLOAT32}"]
3 -> 16 [label = "t_8:{plain_int_0:PRIVATE:INT64}"]
3 -> 17 [label = "t_7:{plain_float_0:PRIVATE:FLOAT32}"]
3 -> 18 [label = "t_6:{join_int_0:PRIVATE:INT64}"]
3 -> 4 [label = "t_8:{plain_int_0:PRIVATE:INT64}"]
3 -> 5 [label = "t_7:{plain_float_0:PRIVATE:FLOAT32}"]
3 -> 7 [label = "t_8:{plain_int_0:PRIVATE:INT64}"]
4 -> 18 [label = "t_9:{plain_int_0:PRIVATE:FLOAT64}"]
5 -> 18 [label = "t_10:{plain_float_0:PRIVATE:FLOAT64}"]
6 -> 8 [label = "t_11:{constant_data:PUBLIC:INT64}"]
7 -> 8 [label = "t_12:{plain_int_0:PRIVATE:FLOAT64}"]
7 -> 9 [label = "t_12:{plain_int_0:PRIVATE:FLOAT64}"]
8 -> 9 [label = "t_13:{constant_data:PRIVATE:INT64}"]
9 -> 18 [label = "t_14:{Div_out:PRIVATE:FLOAT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
...
2 [label="join:{in:[Left:{t_0,},Right:{t_2,},],out:[LeftJoinIndex:{t_3,},RightJoinIndex:{t_4,},],attr:[input_party_codes:[alice bob],join_type:0,psi_algorithm:0,],party:[alice,bob,]}"]
3 [label="filter_by_index:{in:[Data:{t_1,},RowsIndexFilter:{t_3,},],out:[Out:{t_5,},],attr:[],party:[alice,]}"]
4 [label="make_constant:{in:[],out:[Out:{t_6,},],attr:[scalar:-1,],party:[alice,bob,carol,]}"]
5 [label="make_constant:{in:[],out:[Out:{t_7,},],attr:[scalar:0,],party:[alice,bob,carol,]}"]
6 [label="broadcast:{in:[In:{t_7,},ShapeRefTensor:{t_5,},],out:[Out:{t_8,},],attr:[],party:[alice,]}"]
7 [label="Minus:{in:[Left:{t_8,},Right:{t_5,},],out:[Out:{t_9,},],attr:[],party:[alice,]}"]
8 [label="broadcast:{in:[In:{t_6,},ShapeRefTensor:{t_9,},],out:[Out:{t_10,},],attr:[],party:[alice,]}"]
9 [label="If:{in:[Condition:{t_5,},ValueIfFalse:{t_9,},ValueIfTrue:{t_10,},],out:[Out:{t_11,},],attr:[],party:[alice,]}"]
10 [label="publish:{in:[In:{t_11,},],out:[Out:{t_12,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_1:{plain_float_0:PRIVATE:FLOAT32}"]
1 -> 2 [label = "t_2:{join_int_0:PRIVATE:INT64}"]
2 -> 3 [label = "t_3:{join_int_0:PRIVATE:INT64}"]
3 -> 6 [label = "t_5:{plain_float_0:PRIVATE:FLOAT32}"]
3 -> 7 [label = "t_5:{plain_float_0:PRIVATE:FLOAT32}"]
3 -> 9 [label = "t_5:{plain_float_0:PRIVATE:FLOAT32}"]
4 -> 8 [label = "t_6:{constant_data:PUBLIC:FLOAT64}"]
5 -> 6 [label = "t_7:{constant_data:PUBLIC:INT64}"]
6 -> 7 [label = "t_8:{constant_data:PRIVATE:INT64}"]
7 -> 8 [label = "t_9:{Minus_out:PRIVATE:FLOAT64}"]
7 -> 9 [label = "t_9:{Minus_out:PRIVATE:FLOAT64}"]
8 -> 9 [label = "t_10:{constant_data:PRIVATE:FLOAT64}"]
9 -> 10 [label = "t_11:{constant_data:PRIVATE:FLOAT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
...
4 [label="is_null:{in:[In:{t_8,},],out:[Out:{t_11,},],attr:[],party:[alice,]}"]
5 [label="not:{in:[In:{t_11,},],out:[Out:{t_12,},],attr:[],party:[alice,]}"]
6 [label="coalesce:{in:[Exprs:{t_7,t_10,},],out:[Out:{t_13,},],attr:[],party:[alice,]}"]
7 [label="make_constant:{in:[],out:[Out:{t_14,},],attr:[scalar:null,],party:[alice,bob,carol,]}"]
8 [label="broadcast:{in:[In:{t_14,},ShapeRefTensor:{t_9,},],out:[Out:{t_15,},],attr:[],party:[alice,]}"]
9 [label="ifnull:{in:[AltValue:{t_15,},Expr:{t_9,},],out:[Out:{t_16,},],attr:[],party:[alice,]}"]
10 [label="publish:{in:[In:{t_12,t_13,t_16,},],out:[Out:{t_17,t_18,t_19,},],attr:[],party:[alice,]}"]
...
3 -> 6 [label = "t_10:{plain_float_1:PRIVATE:FLOAT32}"]
3 -> 6 [label = "t_7:{compare_float_0:PRIVATE:FLOAT32}"]
3 -> 8 [label = "t_9:{join_string_0:PRIVATE:STRING}"]
3 -> 9 [label = "t_9:{join_string_0:PRIVATE:STRING}"]
4 -> 5 [label = "t_11:{isnull_out:PRIVATE:BOOL}"]
5 -> 10 [label = "t_12:{isnull_out:PRIVATE:BOOL}"]
6 -> 10 [label = "t_13:{coalesce_out:PRIVATE:FLOAT64}"]
7 -> 8 [label = "t_14:{constant_data:PUBLIC:STRING}"]
8 -> 9 [label = "t_15:{constant_data:PRIVATE:STRING}"]
9 -> 10 [label = "t_16:{ifnull_out:PRIVATE:STRING}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
...
2 [label="join:{in:[Left:{t_0,},Right:{t_1,},],out:[LeftJoinIndex:{t_2,},RightJoinIndex:{t_3,},],attr:[input_party_codes:[alice bob],join_type:0,psi_algorithm:0,],party:[alice,bob,]}"]
3 [label="filter_by_index:{in:[Data:{t_0,},RowsIndexFilter:{t_2,},],out:[Out:{t_4,},],attr:[],party:[alice,]}"]
4 [label="arrow_substr:{in:[In:{t_4,},],out:[Out:{t_5,},],attr:[func_name:utf8_slice_codeunits,func_opt_type:SliceOptions,],party:[alice,]}"]
5 [label="arrow_substr:{in:[In:{t_4,},],out:[Out:{t_6,},],attr:[func_name:utf8_slice_codeunits,func_opt_type:SliceOptions,],party:[alice,]}"]
6 [label="publish:{in:[In:{t_5,t_6,},],out:[Out:{t_7,t_8,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_string_0:PRIVATE:STRING}"]
0 -> 3 [label = "t_0:{join_string_0:PRIVATE:STRING}"]
1 -> 2 [label = "t_1:{join_string_0:PRIVATE:STRING}"]
2 -> 3 [label = "t_2:{join_string_0:PRIVATE:INT64}"]
3 -> 4 [label = "t_4:{join_string_0:PRIVATE:STRING}"]
3 -> 5 [label = "t_4:{join_string_0:PRIVATE:STRING}"]
4 -> 6 [label = "t_5:{arrow_substr_out:PRIVATE:STRING}"]
5 -> 6 [label = "t_6:{arrow_substr_out:PRIVATE:STRING}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
...
3 -> 7 [label = "t_5:{plain_int_0:PRIVATE:INT64}"]
3 -> 9 [label = "t_5:{plain_int_0:PRIVATE:INT64}"]
4 -> 8 [label = "t_6:{constant_data:PUBLIC:INT64}"]
5 -> 6 [label = "t_7:{constant_data:PUBLIC:INT64}"]
6 -> 7 [label = "t_8:{constant_data:PRIVATE:INT64}"]
7 -> 8 [label = "t_9:{Minus_out:PRIVATE:INT64}"]
7 -> 9 [label = "t_9:{Minus_out:PRIVATE:INT64}"]
8 -> 9 [label = "t_10:{constant_data:PRIVATE:INT64}"]
...
4 [label="reduce_count:{in:[In:{t_4,},],out:[Out:{t_5,},],attr:[],party:[bob,]}"]
...
2 -> 3 [label = "t_3:{join_string_0:PRIVATE:INT64}"]
3 -> 4 [label = "t_4:{join_string_0:PRIVATE:STRING}"]
4 -> 5 [label = "t_5:{join_string_0:PRIVATE:INT64}"]
...
1 [label="runsql:{in:[],out:[Out:{t_1,},],attr:[sql:select any_value(t_0.expr_52) as expr_243 from (select any_value(tb.groupby_int_0) as expr_52,count(1) as expr_242 from bob.tbl_0 as tb group by tb.groupby_int_0 having count(1)>=4) as t_0 group by t_0.expr_52;,table_refs:[bob.tbl_0],],party:[bob,]}"]
2 [label="make_share:{in:[In:{t_0,},],out:[Out:{t_2,},],attr:[],party:[alice,bob,carol,]}"]
3 [label="make_share:{in:[In:{t_1,},],out:[Out:{t_3,},],attr:[],party:[alice,bob,carol,]}"]
4 [label="concat:{in:[In:{t_2,t_3,},],out:[Out:{t_4,},],attr:[axis:0,],party:[alice,bob,carol,]}"]
5 [label="make_private:{in:[In:{t_4,},],out:[Out:{t_5,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
...
3 [label="filter_by_index:{in:[Data:{t_1,t_2,t_3,},RowsIndexFilter:{t_6,},],out:[Out:{t_7,t_8,t_9,},],attr:[],party:[bob,]}"]
4 [label="runsql:{in:[],out:[Out:{t_10,t_11,t_12,},],attr:[sql:select carol.agg_en_pl_int_0,carol.cp_jn_pl_int_0,carol.gb_en_pl_int_0 from carol.tbl_3 as carol;,table_refs:[carol.tbl_3],],party:[carol,]}"]
5 [label="join:{in:[Left:{t_8,},Right:{t_11,},],out:[LeftJoinIndex:{t_13,},RightJoinIndex:{t_14,},],attr:[input_party_codes:[bob carol],join_type:0,psi_algorithm:0,],party:[bob,carol,]}"]
6 [label="filter_by_index:{in:[Data:{t_7,t_9,},RowsIndexFilter:{t_13,},],out:[Out:{t_15,t_16,},],attr:[],party:[bob,]}"]
7 [label="filter_by_index:{in:[Data:{t_10,t_12,},RowsIndexFilter:{t_14,},],out:[Out:{t_17,t_18,},],attr:[],party:[carol,]}"]
8 [label="make_share:{in:[In:{t_16,},],out:[Out:{t_19,},],attr:[],party:[alice,bob,carol,]}"]
9 [label="make_share:{in:[In:{t_18,},],out:[Out:{t_20,},],attr:[],party:[alice,bob,carol,]}"]
10 [label="make_share:{in:[In:{t_15,},],out:[Out:{t_21,},],attr:[],party:[alice,bob,carol,]}"]
11 [label="make_share:{in:[In:{t_17,},],out:[Out:{t_22,},],attr:[],party:[alice,bob,carol,]}"]
12 [label="shuffle:{in:[In:{t_19,t_20,t_21,t_19,t_22,t_20,},],out:[Out:{t_23,t_24,t_25,t_26,t_27,t_28,},],attr:[],party:[alice,bob,carol,]}"]
13 [label="make_private:{in:[In:{t_23,},],out:[Out:{t_29,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
14 [label="make_private:{in:[In:{t_24,},],out:[Out:{t_30,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
15 [label="make_share:{in:[In:{t_29,},],out:[Out:{t_31,},],attr:[],party:[alice,bob,carol,]}"]
16 [label="make_share:{in:[In:{t_30,},],out:[Out:{t_32,},],attr:[],party:[alice,bob,carol,]}"]
17 [label="sort:{in:[In:{t_31,t_32,t_25,t_26,t_27,t_28,},Key:{t_31,t_32,},],out:[Out:{t_33,t_34,t_35,t_36,t_37,t_38,},],attr:[reverse:false,],party:[alice,bob,carol,]}"]
18 [label="group_mark:{in:[Key:{t_33,t_34,},],out:[Group:{t_39,},],attr:[],party:[alice,bob,carol,]}"]
19 [label="count:{in:[Group:{t_39,},In:{t_39,},],out:[Out:{t_40,},],attr:[],party:[alice,bob,carol,]}"]
20 [label="min:{in:[Group:{t_39,},In:{t_35,},],out:[Out:{t_41,},],attr:[],party:[alice,bob,carol,]}"]
21 [label="max:{in:[Group:{t_39,},In:{t_37,},],out:[Out:{t_42,},],attr:[],party:[alice,bob,carol,]}"]
22 [label="shuffle:{in:[In:{t_40,t_41,t_42,t_36,t_38,t_39,},],out:[Out:{t_43,t_44,t_45,t_46,t_47,t_48,},],attr:[],party:[alice,bob,carol,]}"]
23 [label="make_public:{in:[In:{t_48,},],out:[Out:{t_49,},],attr:[],party:[alice,bob,carol,]}"]
24 [label="filter:{in:[Filter:{t_49,},In:{t_43,t_44,t_45,t_46,t_47,},],out:[Out:{t_50,t_51,t_52,t_53,t_54,},],attr:[],party:[alice,bob,carol,]}"]
25 [label="make_constant:{in:[],out:[Out:{t_55,},],attr:[scalar:4,],party:[alice,bob,carol,]}"]
26 [label="broadcast:{in:[In:{t_55,},ShapeRefTensor:{t_50,},],out:[Out:{t_56,},],attr:[],party:[alice,bob,carol,]}"]
27 [label="make_private:{in:[In:{t_50,},],out:[Out:{t_57,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
28 [label="make_private:{in:[In:{t_56,},],out:[Out:{t_58,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
29 [label="GreaterEqual:{in:[Left:{t_57,},Right:{t_58,},],out:[Out:{t_59,},],attr:[],party:[alice,]}"]
30 [label="make_private:{in:[In:{t_53,},],out:[Out:{t_60,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
31 [label="make_private:{in:[In:{t_54,},],out:[Out:{t_61,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
32 [label="make_private:{in:[In:{t_51,},],out:[Out:{t_62,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
33 [label="make_private:{in:[In:{t_52,},],out:[Out:{t_63,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
34 [label="apply_filter:{in:[Filter:{t_59,},In:{t_60,t_61,t_57,t_62,t_63,},],out:[Out:{t_64,t_65,t_66,t_67,t_68,},],attr:[],party:[alice,]}"]
35 [label="publish:{in:[In:{t_66,t_64,t_65,t_67,t_68,},],out:[Out:{t_69,t_70,t_71,t_72,t_73,},],attr:[],party:[alice,]}"]
...
10 -> 12 [label = "t_21:{ag_pl_en_int_0:SECRET:INT64}"]
11 -> 12 [label = "t_22:{agg_en_pl_int_0:SECRET:INT64}"]
12 -> 13 [label = "t_23:{gb_pl_en_int_0:SECRET:INT64}"]
12 -> 14 [label = "t_24:{gb_en_pl_int_0:SECRET:INT64}"]
12 -> 17 [label = "t_25:{ag_pl_en_int_0:SECRET:INT64}"]
12 -> 17 [label = "t_26:{gb_pl_en_int_0:SECRET:INT64}"]
12 -> 17 [label = "t_27:{agg_en_pl_int_0:SECRET:INT64}"]
12 -> 17 [label = "t_28:{gb_en_pl_int_0:SECRET:INT64}"]
13 -> 15 [label = "t_29:{gb_pl_en_int_0:PRIVATE:INT64}"]
14 -> 16 [label = "t_30:{gb_en_pl_int_0:PRIVATE:INT64}"]
15 -> 17 [label = "t_31:{gb_pl_en_int_0:SECRET:INT64}"]
15 -> 17 [label = "t_31:{gb_pl_en_int_0:SECRET:INT64}"]
16 -> 17 [label = "t_32:{gb_en_pl_int_0:SECRET:INT64}"]
16 -> 17 [label = "t_32:{gb_en_pl_int_0:SECRET:INT64}"]
17 -> 18 [label = "t_33:{gb_pl_en_int_0:SECRET:INT64}"]
17 -> 18 [label = "t_34:{gb_en_pl_int_0:SECRET:INT64}"]
17 -> 20 [label = "t_35:{ag_pl_en_int_0:SECRET:INT64}"]
17 -> 21 [label = "t_37:{agg_en_pl_int_0:SECRET:INT64}"]
17 -> 22 [label = "t_36:{gb_pl_en_int_0:SECRET:INT64}"]
17 -> 22 [label = "t_38:{gb_en_pl_int_0:SECRET:INT64}"]
18 -> 19 [label = "t_39:{group_mark:SECRET:BOOL}"]
18 -> 19 [label = "t_39:{group_mark:SECRET:BOOL}"]
18 -> 20 [label = "t_39:{group_mark:SECRET:BOOL}"]
18 -> 21 [label = "t_39:{group_mark:SECRET:BOOL}"]
18 -> 22 [label = "t_39:{group_mark:SECRET:BOOL}"]
19 -> 22 [label = "t_40:{group_mark:SECRET:INT64}"]
2 -> 3 [label = "t_6:{jn_pl_cp_int_0:PRIVATE:INT64}"]
20 -> 22 [label = "t_41:{ag_pl_en_int_0:SECRET:INT64}"]
21 -> 22 [label = "t_42:{agg_en_pl_int_0:SECRET:INT64}"]
22 -> 23 [label = "t_48:{group_mark:SECRET:BOOL}"]
22 -> 24 [label = "t_43:{group_mark:SECRET:INT64}"]
22 -> 24 [label = "t_44:{ag_pl_en_int_0:SECRET:INT64}"]
22 -> 24 [label = "t_45:{agg_en_pl_int_0:SECRET:INT64}"]
22 -> 24 [label = "t_46:{gb_pl_en_int_0:SECRET:INT64}"]
22 -> 24 [label = "t_47:{gb_en_pl_int_0:SECRET:INT64}"]
23 -> 24 [label = "t_49:{group_mark:PUBLIC:BOOL}"]
24 -> 26 [label = "t_50:{group_mark:SECRET:INT64}"]
24 -> 27 [label = "t_50:{group_mark:SECRET:INT64}"]
24 -> 30 [label = "t_53:{gb_pl_en_int_0:SECRET:INT64}"]
24 -> 31 [label = "t_54:{gb_en_pl_int_0:SECRET:INT64}"]
24 -> 32 [label = "t_51:{ag_pl_en_int_0:SECRET:INT64}"]
24 -> 33 [label = "t_52:{agg_en_pl_int_0:SECRET:INT64}"]
25 -> 26 [label = "t_55:{constant_data:PUBLIC:INT64}"]
26 -> 28 [label = "t_56:{constant_data:PUBLIC:INT64}"]
27 -> 29 [label = "t_57:{group_mark:PRIVATE:INT64}"]
27 -> 34 [label = "t_57:{group_mark:PRIVATE:INT64}"]
28 -> 29 [label = "t_58:{constant_data:PRIVATE:INT64}"]
29 -> 34 [label = "t_59:{GreaterEqual_out:PRIVATE:BOOL}"]
3 -> 5 [label = "t_8:{cp_pl_jn_int_0:PRIVATE:INT64}"]
3 -> 6 [label = "t_7:{ag_pl_en_int_0:PRIVATE:INT64}"]
3 -> 6 [label = "t_9:{gb_pl_en_int_0:PRIVATE:INT64}"]
30 -> 34 [label = "t_60:{gb_pl_en_int_0:PRIVATE:INT64}"]
31 -> 34 [label = "t_61:{gb_en_pl_int_0:PRIVATE:INT64}"]
32 -> 34 [label = "t_62:{ag_pl_en_int_0:PRIVATE:INT64}"]
33 -> 34 [label = "t_63:{agg_en_pl_int_0:PRIVATE:INT64}"]
34 -> 35 [label = "t_64:{gb_pl_en_int_0:PRIVATE:INT64}"]
34 -> 35 [label = "t_65:{gb_en_pl_int_0:PRIVATE:INT64}"]
34 -> 35 [label = "t_66:{group_mark:PRIVATE:INT64}"]
34 -> 35 [label = "t_67:{ag_pl_en_int_0:PRIVATE:INT64}"]
34 -> 35 [label = "t_68:{agg_en_pl_int_0:PRIVATE:INT64}"]
4 -> 5 [label = "t_11:{cp_jn_pl_int_0:PRIVATE:INT64}"]
4 -> 7 [label = "t_10:{agg_en_pl_int_0:PRIVATE:INT64}"]
4 -> 7 [label = "t_12:{gb_en_pl_int_0:PRIVATE:INT64}"]
5 -> 6 [label = "t_13:{cp_pl_jn_int_0:PRIVATE:INT64}"]
5 -> 7 [label = "t_14:{cp_jn_pl_int_0:PRIVATE:INT64}"]
6 -> 10 [label = "t_15:{ag_pl_en_int_0:PRIVATE:INT64}"]
6 -> 8 [label = "t_16:{gb_pl_en_int_0:PRIVATE:INT64}"]
7 -> 11 [label = "t_17:{agg_en_pl_int_0:PRIVATE:INT64}"]
7 -> 9 [label = "t_18:{gb_en_pl_int_0:PRIVATE:INT64}"]
8 -> 12 [label = "t_19:{gb_pl_en_int_0:SECRET:INT64}"]
8 -> 12 [label = "t_19:{gb_pl_en_int_0:SECRET:INT64}"]
9 -> 12 [label = "t_20:{gb_en_pl_int_0:SECRET:INT64}"]
9 -> 12 [label = "t_20:{gb_en_pl_int_0:SECRET:INT64}"]
...
2 [label="join:{in:[Left:{t_0,},Right:{t_3,},],out:[LeftJoinIndex:{t_4,},RightJoinIndex:{t_5,},],attr:[input_party_codes:[alice bob],join_type:0,psi_algorithm:0,],party:[alice,bob,]}"]
3 [label="filter_by_index:{in:[Data:{t_1,t_2,},RowsIndexFilter:{t_5,},],out:[Out:{t_6,t_7,},],attr:[],party:[bob,]}"]
4 [label="runsql:{in:[],out:[Out:{t_8,t_9,},],attr:[sql:select carol.cp_jn_pl_int_0,carol.cp_jn_pl_int_1 from carol.tbl_3 as carol;,table_refs:[carol.tbl_3],],party:[carol,]}"]
5 [label="join:{in:[Left:{t_6,},Right:{t_8,},],out:[LeftJoinIndex:{t_10,},RightJoinIndex:{t_11,},],attr:[input_party_codes:[bob carol],join_type:0,psi_algorithm:0,],party:[bob,carol,]}"]
6 [label="filter_by_index:{in:[Data:{t_6,t_7,},RowsIndexFilter:{t_10,},],out:[Out:{t_12,t_13,},],attr:[],party:[bob,]}"]
7 [label="filter_by_index:{in:[Data:{t_8,t_9,},RowsIndexFilter:{t_11,},],out:[Out:{t_14,t_15,},],attr:[],party:[carol,]}"]
8 [label="copy:{in:[In:{t_14,},],out:[Out:{t_16,},],attr:[input_party_codes:carol,output_party_codes:bob,],party:[carol,bob,]}"]
9 [label="Greater:{in:[Left:{t_12,},Right:{t_16,},],out:[Out:{t_17,},],attr:[],party:[bob,]}"]
10 [label="make_share:{in:[In:{t_13,},],out:[Out:{t_18,},],attr:[],party:[alice,bob,carol,]}"]
11 [label="make_share:{in:[In:{t_15,},],out:[Out:{t_19,},],attr:[],party:[alice,bob,carol,]}"]
12 [label="Greater:{in:[Left:{t_18,},Right:{t_19,},],out:[Out:{t_20,},],attr:[],party:[alice,bob,carol,]}"]
13 [label="copy:{in:[In:{t_17,},],out:[Out:{t_21,},],attr:[input_party_codes:bob,output_party_codes:alice,],party:[bob,alice,]}"]
14 [label="make_private:{in:[In:{t_20,},],out:[Out:{t_23,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
15 [label="publish:{in:[In:{t_21,t_23,},],out:[Out:{t_22,t_24,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{pl_jn_cp_int_0:PRIVATE:INT64}"]
...
10 -> 12 [label = "t_18:{cp_pl_jn_int_1:SECRET:INT64}"]
11 -> 12 [label = "t_19:{cp_jn_pl_int_1:SECRET:INT64}"]
12 -> 14 [label = "t_20:{Greater_out:SECRET:BOOL}"]
13 -> 15 [label = "t_21:{Greater_out:PRIVATE:BOOL}"]
14 -> 15 [label = "t_23:{Greater_out:PRIVATE:BOOL}"]
2 -> 3 [label = "t_5:{jn_pl_cp_int_0:PRIVATE:INT64}"]
3 -> 5 [label = "t_6:{cp_pl_jn_int_0:PRIVATE:INT64}"]
3 -> 6 [label = "t_6:{cp_pl_jn_int_0:PRIVATE:INT64}"]
3 -> 6 [label = "t_7:{cp_pl_jn_int_1:PRIVATE:INT64}"]
4 -> 5 [label = "t_8:{cp_jn_pl_int_0:PRIVATE:INT64}"]
4 -> 7 [label = "t_8:{cp_jn_pl_int_0:PRIVATE:INT64}"]
4 -> 7 [label = "t_9:{cp_jn_pl_int_1:PRIVATE:INT64}"]
5 -> 6 [label = "t_10:{cp_pl_jn_int_0:PRIVATE:INT64}"]
5 -> 7 [label = "t_11:{cp_jn_pl_int_0:PRIVATE:INT64}"]
6 -> 10 [label = "t_13:{cp_pl_jn_int_1:PRIVATE:INT64}"]
6 -> 9 [label = "t_12:{cp_pl_jn_int_0:PRIVATE:INT64}"]
7 -> 11 [label = "t_15:{cp_jn_pl_int_1:PRIVATE:INT64}"]
7 -> 8 [label = "t_14:{cp_jn_pl_int_0:PRIVATE:INT64}"]
8 -> 9 [label = "t_16:{cp_jn_pl_int_0:PRIVATE:INT64}"]
9 -> 13 [label = "t_17:{Greater_out:PRIVATE:BOOL}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
...
2 [label="join:{in:[Left:{t_0,},Right:{t_2,},],out:[LeftJoinIndex:{t_3,},RightJoinIndex:{t_4,},],attr:[input_party_codes:[alice bob],join_type:0,psi_algorithm:0,],party:[alice,bob,]}"]
3 [label="filter_by_index:{in:[Data:{t_1,},RowsIndexFilter:{t_4,},],out:[Out:{t_5,},],attr:[],party:[bob,]}"]
4 [label="runsql:{in:[],out:[Out:{t_6,},],attr:[sql:select carol.cp_jn_pl_int_0 from carol.tbl_3 as carol;,table_refs:[carol.tbl_3],],party:[carol,]}"]
5 [label="join:{in:[Left:{t_5,},Right:{t_6,},],out:[LeftJoinIndex:{t_7,},RightJoinIndex:{t_8,},],attr:[input_party_codes:[bob carol],join_type:0,psi_algorithm:0,],party:[bob,carol,]}"]
6 [label="filter_by_index:{in:[Data:{t_5,},RowsIndexFilter:{t_7,},],out:[Out:{t_9,},],attr:[],party:[bob,]}"]
7 [label="filter_by_index:{in:[Data:{t_6,},RowsIndexFilter:{t_8,},],out:[Out:{t_10,},],attr:[],party:[carol,]}"]
8 [label="copy:{in:[In:{t_10,},],out:[Out:{t_11,},],attr:[input_party_codes:carol,output_party_codes:bob,],party:[carol,bob,]}"]
9 [label="Greater:{in:[Left:{t_9,},Right:{t_11,},],out:[Out:{t_12,},],attr:[],party:[bob,]}"]
10 [label="copy:{in:[In:{t_12,},],out:[Out:{t_13,},],attr:[input_party_codes:bob,output_party_codes:alice,],party:[bob,alice,]}"]
11 [label="publish:{in:[In:{t_13,},],out:[Out:{t_14,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{pl_jn_cp_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_2:{jn_pl_cp_int_0:PRIVATE:INT64}"]
1 -> 3 [label = "t_1:{cp_pl_jn_int_0:PRIVATE:INT64}"]
10 -> 11 [label = "t_13:{Greater_out:PRIVATE:BOOL}"]
...
4 -> 5 [label = "t_6:{cp_jn_pl_int_0:PRIVATE:INT64}"]
4 -> 7 [label = "t_6:{cp_jn_pl_int_0:PRIVATE:INT64}"]
5 -> 6 [label = "t_7:{cp_pl_jn_int_0:PRIVATE:INT64}"]
5 -> 7 [label = "t_8:{cp_jn_pl_int_0:PRIVATE:INT64}"]
6 -> 9 [label = "t_9:{cp_pl_jn_int_0:PRIVATE:INT64}"]
7 -> 8 [label = "t_10:{cp_jn_pl_int_0:PRIVATE:INT64}"]
8 -> 9 [label = "t_11:{cp_jn_pl_int_0:PRIVATE:INT64}"]
...
26 [label="make_constant:{in:[],out:[Out:{t_29,},],attr:[scalar:4,],party:[alice,bob,carol,]}"]
...
8 [label="filter_by_index:{in:[Data:{t_6,},RowsIndexFilter:{t_11,},],out:[Out:{t_12,},],attr:[],party:[alice,]}"]
9 [label="publish:{in:[In:{t_12,},],out:[Out:{t_13,},],attr:[],party:[alice,]}"]
...
7 -> 8 [label = "t_11:{join_int_1:PRIVATE:INT64}"]
8 -> 9 [label = "t_12:{encrypt_float_1:PRIVATE:FLOAT32}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
...
2 [label="join:{in:[Left:{t_0,},Right:{t_1,},],out:[LeftJoinIndex:{t_2,},RightJoinIndex:{t_3,},],attr:[input_party_codes:[alice bob],join_type:0,psi_algorithm:0,],party:[alice,bob,]}"]
3 [label="filter_by_index:{in:[Data:{t_0,},RowsIndexFilter:{t_2,},],out:[Out:{t_4,},],attr:[],party:[alice,]}"]
4 [label="dump_file:{in:[In:{t_4,},],out:[Out:{t_5,},],attr:[field_deliminator:,,file_path:/tmp/output_alice.txt,line_terminator:
,quoting_style:0,],party:[alice,]}"]
...
2 [label="join:{in:[Left:{t_0,},Right:{t_1,},],out:[LeftJoinIndex:{t_2,},RightJoinIndex:{t_3,},],attr:[input_party_codes:[alice bob],join_type:0,psi_algorithm:0,],party:[alice,bob,]}"]
3 [label="filter_by_index:{in:[Data:{t_0,},RowsIndexFilter:{t_2,},],out:[Out:{t_4,},],attr:[],party:[alice,]}"]
4 [label="group:{in:[Key:{t_4,},],out:[GroupId:{t_5,},GroupNum:{t_6,},],attr:[],party:[alice,]}"]
5 [label="count:{in:[GroupId:{t_5,},GroupNum:{t_6,},In:{t_5,},],out:[Out:{t_7,},],attr:[],party:[alice,]}"]
6 [label="sum:{in:[GroupId:{t_5,},GroupNum:{t_6,},In:{t_4,},],out:[Out:{t_8,},],attr:[],party:[alice,]}"]
7 [label="max:{in:[GroupId:{t_5,},GroupNum:{t_6,},In:{t_4,},],out:[Out:{t_9,},],attr:[],party:[alice,]}"]
8 [label="min:{in:[GroupId:{t_5,},GroupNum:{t_6,},In:{t_4,},],out:[Out:{t_10,},],attr:[],party:[alice,]}"]
9 [label="firstrow:{in:[GroupId:{t_5,},GroupNum:{t_6,},In:{t_4,},],out:[Out:{t_11,},],attr:[],party:[alice,]}"]
10 [label="make_constant:{in:[],out:[Out:{t_12,},],attr:[scalar:4,],party:[alice,bob,carol,]}"]
11 [label="broadcast:{in:[In:{t_12,},ShapeRefTensor:{t_7,},],out:[Out:{t_13,},],attr:[],party:[alice,]}"]
12 [label="GreaterEqual:{in:[Left:{t_7,},Right:{t_13,},],out:[Out:{t_14,},],attr:[],party:[alice,]}"]
13 [label="apply_filter:{in:[Filter:{t_14,},In:{t_11,t_7,t_8,t_9,t_10,},],out:[Out:{t_15,t_16,t_17,t_18,t_19,},],attr:[],party:[alice,]}"]
14 [label="publish:{in:[In:{t_15,t_16,t_17,t_18,t_19,},],out:[Out:{t_20,t_21,t_22,t_23,t_24,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{plain_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{plain_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
10 -> 11 [label = "t_12:{constant_data:PUBLIC:INT64}"]
11 -> 12 [label = "t_13:{constant_data:PRIVATE:INT64}"]
12 -> 13 [label = "t_14:{GreaterEqual_out:PRIVATE:BOOL}"]
13 -> 14 [label = "t_15:{plain_int_0_firstrow:PRIVATE:INT64}"]
13 -> 14 [label = "t_16:{group_id_count:PRIVATE:INT64}"]
13 -> 14 [label = "t_17:{plain_int_0_sum:PRIVATE:INT64}"]
13 -> 14 [label = "t_18:{plain_int_0_max:PRIVATE:INT64}"]
13 -> 14 [label = "t_19:{plain_int_0_min:PRIVATE:INT64}"]
2 -> 3 [label = "t_2:{plain_int_0:PRIVATE:INT64}"]
3 -> 4 [label = "t_4:{plain_int_0:PRIVATE:INT64}"]
...
4 -> 5 [label = "t_5:{group_id:PRIVATE:INT64}"]
4 -> 5 [label = "t_5:{group_id:PRIVATE:INT64}"]
4 -> 5 [label = "t_6:{group_num:PRIVATE:INT64}"]
4 -> 6 [label = "t_5:{group_id:PRIVATE:INT64}"]
4 -> 6 [label = "t_6:{group_num:PRIVATE:INT64}"]
4 -> 7 [label = "t_5:{group_id:PRIVATE:INT64}"]
4 -> 7 [label = "t_6:{group_num:PRIVATE:INT64}"]
4 -> 8 [label = "t_5:{group_id:PRIVATE:INT64}"]
4 -> 8 [label = "t_6:{group_num:PRIVATE:INT64}"]
4 -> 9 [label = "t_5:{group_id:PRIVATE:INT64}"]
4 -> 9 [label = "t_6:{group_num:PRIVATE:INT64}"]
5 -> 11 [label = "t_7:{group_id_count:PRIVATE:INT64}"]
5 -> 12 [label = "t_7:{group_id_count:PRIVATE:INT64}"]
5 -> 13 [label = "t_7:{group_id_count:PRIVATE:INT64}"]
6 -> 13 [label = "t_8:{plain_int_0_sum:PRIVATE:INT64}"]
7 -> 13 [label = "t_9:{plain_int_0_max:PRIVATE:INT64}"]
8 -> 13 [label = "t_10:{plain_int_0_min:PRIVATE:INT64}"]
9 -> 13 [label = "t_11:{plain_int_0_firstrow:PRIVATE:INT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
...
5 [label="filter_by_index:{in:[Data:{t_4,t_5,},RowsIndexFilter:{t_8,},],out:[Out:{t_10,t_11,},],attr:[],party:[alice,]}"]
6 [label="group:{in:[Key:{t_11,},],out:[GroupId:{t_12,},GroupNum:{t_13,},],attr:[],party:[alice,]}"]
7 [label="count_distinct:{in:[GroupId:{t_12,},GroupNum:{t_13,},In:{t_10,},],out:[Out:{t_14,},],attr:[],party:[alice,]}"]
8 [label="sum:{in:[GroupId:{t_12,},GroupNum:{t_13,},In:{t_10,},],out:[Out:{t_15,},],attr:[],party:[alice,]}"]
9 [label="max:{in:[GroupId:{t_12,},GroupNum:{t_13,},In:{t_10,},],out:[Out:{t_16,},],attr:[],party:[alice,]}"]
10 [label="min:{in:[GroupId:{t_12,},GroupNum:{t_13,},In:{t_10,},],out:[Out:{t_17,},],attr:[],party:[alice,]}"]
11 [label="firstrow:{in:[GroupId:{t_12,},GroupNum:{t_13,},In:{t_11,},],out:[Out:{t_18,},],attr:[],party:[alice,]}"]
12 [label="count:{in:[GroupId:{t_12,},GroupNum:{t_13,},In:{t_12,},],out:[Out:{t_19,},],attr:[],party:[alice,]}"]
13 [label="make_constant:{in:[],out:[Out:{t_20,},],attr:[scalar:4,],party:[alice,bob,carol,]}"]
14 [label="broadcast:{in:[In:{t_20,},ShapeRefTensor:{t_19,},],out:[Out:{t_21,},],attr:[],party:[alice,]}"]
15 [label="GreaterEqual:{in:[Left:{t_19,},Right:{t_21,},],out:[Out:{t_22,},],attr:[],party:[alice,]}"]
16 [label="apply_filter:{in:[Filter:{t_22,},In:{t_18,t_14,t_15,t_16,t_17,t_19,},],out:[Out:{t_23,t_24,t_25,t_26,t_27,t_28,},],attr:[],party:[alice,]}"]
17 [label="publish:{in:[In:{t_23,t_24,t_25,t_26,t_27,},],out:[Out:{t_29,t_30,t_31,t_32,t_33,},],attr:[],party:[alice,]}"]
...
1 -> 3 [label = "t_3:{plain_int_0:PRIVATE:INT64}"]
10 -> 16 [label = "t_17:{compare_int_0_min:PRIVATE:INT64}"]
11 -> 16 [label = "t_18:{groupby_int_0_firstrow:PRIVATE:INT64}"]
12 -> 14 [label = "t_19:{group_id_count:PRIVATE:INT64}"]
12 -> 15 [label = "t_19:{group_id_count:PRIVATE:INT64}"]
12 -> 16 [label = "t_19:{group_id_count:PRIVATE:INT64}"]
13 -> 14 [label = "t_20:{constant_data:PUBLIC:INT64}"]
14 -> 15 [label = "t_21:{constant_data:PRIVATE:INT64}"]
15 -> 16 [label = "t_22:{GreaterEqual_out:PRIVATE:BOOL}"]
16 -> 17 [label = "t_23:{groupby_int_0_firstrow:PRIVATE:INT64}"]
16 -> 17 [label = "t_24:{compare_int_0_count_distinct:PRIVATE:INT64}"]
16 -> 17 [label = "t_25:{compare_int_0_sum:PRIVATE:INT64}"]
16 -> 17 [label = "t_26:{compare_int_0_max:PRIVATE:INT64}"]
16 -> 17 [label = "t_27:{compare_int_0_min:PRIVATE:INT64}"]
...
5 -> 11 [label = "t_11:{groupby_int_0:PRIVATE:INT64}"]
5 -> 6 [label = "t_11:{groupby_int_0:PRIVATE:INT64}"]
5 -> 7 [label = "t_10:{compare_int_0:PRIVATE:INT64}"]
5 -> 8 [label = "t_10:{compare_int_0:PRIVATE:INT64}"]
5 -> 9 [label = "t_10:{compare_int_0:PRIVATE:INT64}"]
6 -> 10 [label = "t_12:{group_id:PRIVATE:INT64}"]
6 -> 10 [label = "t_13:{group_num:PRIVATE:INT64}"]
6 -> 11 [label = "t_12:{group_id:PRIVATE:INT64}"]
6 -> 11 [label = "t_13:{group_num:PRIVATE:INT64}"]
6 -> 12 [label = "t_12:{group_id:PRIVATE:INT64}"]
6 -> 12 [label = "t_12:{group_id:PRIVATE:INT64}"]
6 -> 12 [label = "t_13:{group_num:PRIVATE:INT64}"]
6 -> 7 [label = "t_12:{group_id:PRIVATE:INT64}"]
6 -> 7 [label = "t_13:{group_num:PRIVATE:INT64}"]
6 -> 8 [label = "t_12:{group_id:PRIVATE:INT64}"]
6 -> 8 [label = "t_13:{group_num:PRIVATE:INT64}"]
6 -> 9 [label = "t_12:{group_id:PRIVATE:INT64}"]
6 -> 9 [label = "t_13:{group_num:PRIVATE:INT64}"]
7 -> 16 [label = "t_14:{compare_int_0_count_distinct:PRIVATE:INT64}"]
8 -> 16 [label = "t_15:{compare_int_0_sum:PRIVATE:INT64}"]
9 -> 16 [label = "t_16:{compare_int_0_max:PRIVATE:INT64}"]
}`, `
pipeline 0 {
Batched: false
...
Inputs: [t_10 t_11]
Outputs: [t_14 t_15 t_16 t_17 t_18 t_19 t_20]
}
pipeline 3 {
Batched: false
node: [broadcast_14 GreaterEqual_15 apply_filter_16]
Inputs: [t_14 t_15 t_16 t_17 t_18 t_19 t_20]
Outputs: [t_23 t_24 t_25 t_26 t_27]
}
pipeline 4 {
Batched: false
node: [publish_17]
Inputs: [t_23 t_24 t_25 t_26 t_27]
Outputs: []
}
`, testConf{groupThreshold: 0, batched: true, revealGroupCount: false}},
...
3 [label="filter_by_index:{in:[Data:{t_0,},RowsIndexFilter:{t_3,},],out:[Out:{t_5,},],attr:[],party:[alice,]}"]
4 [label="unique:{in:[Key:{t_5,},],out:[UniqueKey:{t_6,},],attr:[],party:[alice,]}"]
5 [label="reduce_count:{in:[In:{t_6,},],out:[Out:{t_7,},],attr:[],party:[alice,]}"]
6 [label="reduce_sum:{in:[In:{t_5,},],out:[Out:{t_8,},],attr:[],party:[alice,]}"]
7 [label="reduce_max:{in:[In:{t_5,},],out:[Out:{t_9,},],attr:[],party:[alice,]}"]
8 [label="reduce_min:{in:[In:{t_5,},],out:[Out:{t_10,},],attr:[],party:[alice,]}"]
9 [label="publish:{in:[In:{t_7,t_8,t_9,t_10,},],out:[Out:{t_11,t_12,t_13,t_14,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{compare_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_2:{plain_int_0:PRIVATE:INT64}"]
2 -> 3 [label = "t_3:{plain_int_0:PRIVATE:INT64}"]
3 -> 4 [label = "t_5:{compare_int_0:PRIVATE:INT64}"]
3 -> 6 [label = "t_5:{compare_int_0:PRIVATE:INT64}"]
3 -> 7 [label = "t_5:{compare_int_0:PRIVATE:INT64}"]
3 -> 8 [label = "t_5:{compare_int_0:PRIVATE:INT64}"]
4 -> 5 [label = "t_6:{compare_int_0:PRIVATE:INT64}"]
5 -> 9 [label = "t_7:{compare_int_0:PRIVATE:INT64}"]
6 -> 9 [label = "t_8:{compare_int_0:PRIVATE:INT64}"]
7 -> 9 [label = "t_9:{compare_int_0:PRIVATE:INT64}"]
8 -> 9 [label = "t_10:{compare_int_0:PRIVATE:INT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
...
6 [label="join:{in:[Left:{t_7,},Right:{t_8,},],out:[LeftJoinIndex:{t_9,},RightJoinIndex:{t_10,},],attr:[input_party_codes:[bob carol],join_type:1,psi_algorithm:0,],party:[bob,carol,]}"]
7 [label="copy:{in:[In:{t_9,},],out:[Out:{t_11,},],attr:[input_party_codes:bob,output_party_codes:alice,],party:[bob,alice,]}"]
8 [label="filter_by_index:{in:[Data:{t_6,},RowsIndexFilter:{t_11,},],out:[Out:{t_12,},],attr:[],party:[alice,]}"]
9 [label="publish:{in:[In:{t_12,},],out:[Out:{t_13,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
...
6 -> 7 [label = "t_9:{join_int_1:PRIVATE:INT64}"]
7 -> 8 [label = "t_11:{join_int_1:PRIVATE:INT64}"]
8 -> 9 [label = "t_12:{plain_int_0:PRIVATE:INT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
...
2 [label="join:{in:[Left:{t_1,},Right:{t_2,},],out:[LeftJoinIndex:{t_3,},RightJoinIndex:{t_4,},],attr:[input_party_codes:[alice bob],join_type:0,psi_algorithm:0,],party:[alice,bob,]}"]
3 [label="filter_by_index:{in:[Data:{t_0,},RowsIndexFilter:{t_3,},],out:[Out:{t_5,},],attr:[],party:[alice,]}"]
4 [label="Add:{in:[Left:{t_5,},Right:{t_5,},],out:[Out:{t_6,},],attr:[],party:[alice,]}"]
5 [label="reduce_max:{in:[In:{t_6,},],out:[Out:{t_7,},],attr:[],party:[alice,]}"]
6 [label="publish:{in:[In:{t_7,},],out:[Out:{t_8,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{aggregate_float_0:PRIVATE:FLOAT32}"]
1 -> 2 [label = "t_2:{plain_int_0:PRIVATE:INT64}"]
2 -> 3 [label = "t_3:{plain_int_0:PRIVATE:INT64}"]
3 -> 4 [label = "t_5:{aggregate_float_0:PRIVATE:FLOAT32}"]
3 -> 4 [label = "t_5:{aggregate_float_0:PRIVATE:FLOAT32}"]
4 -> 5 [label = "t_6:{Add_out:PRIVATE:FLOAT64}"]
5 -> 6 [label = "t_7:{Add_out:PRIVATE:FLOAT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
...
2 [label="join:{in:[Left:{t_0,},Right:{t_1,},],out:[LeftJoinIndex:{t_2,},RightJoinIndex:{t_3,},],attr:[input_party_codes:[alice bob],join_type:0,psi_algorithm:0,],party:[alice,bob,]}"]
3 [label="filter_by_index:{in:[Data:{t_0,},RowsIndexFilter:{t_2,},],out:[Out:{t_4,},],attr:[],party:[alice,]}"]
4 [label="shape:{in:[In:{t_4,},],out:[Out:{t_5,},],attr:[axis:0,],party:[alice,]}"]
5 [label="reduce_sum:{in:[In:{t_4,},],out:[Out:{t_6,},],attr:[],party:[alice,]}"]
6 [label="reduce_max:{in:[In:{t_4,},],out:[Out:{t_7,},],attr:[],party:[alice,]}"]
7 [label="reduce_min:{in:[In:{t_4,},],out:[Out:{t_8,},],attr:[],party:[alice,]}"]
8 [label="reduce_avg:{in:[In:{t_4,},],out:[Out:{t_9,},],attr:[],party:[alice,]}"]
9 [label="publish:{in:[In:{t_5,t_6,t_7,t_8,t_9,},],out:[Out:{t_10,t_11,t_12,t_13,t_14,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{plain_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{plain_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
2 -> 3 [label = "t_2:{plain_int_0:PRIVATE:INT64}"]
...
3 -> 8 [label = "t_4:{plain_int_0:PRIVATE:INT64}"]
4 -> 9 [label = "t_5:{plain_int_0:PRIVATE:INT64}"]
5 -> 9 [label = "t_6:{plain_int_0:PRIVATE:INT64}"]
6 -> 9 [label = "t_7:{plain_int_0:PRIVATE:INT64}"]
7 -> 9 [label = "t_8:{plain_int_0:PRIVATE:INT64}"]
8 -> 9 [label = "t_9:{plain_int_0:PRIVATE:FLOAT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
...
5 [label="broadcast:{in:[In:{t_5,},ShapeRefTensor:{t_4,},],out:[Out:{t_6,},],attr:[],party:[alice,]}"]
6 [label="Add:{in:[Left:{t_4,},Right:{t_6,},],out:[Out:{t_7,},],attr:[],party:[alice,]}"]
...
4 -> 5 [label = "t_5:{constant_data:PUBLIC:INT64}"]
5 -> 6 [label = "t_6:{constant_data:PRIVATE:INT64}"]
6 -> 7 [label = "t_7:{Add_out:PRIVATE:INT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
...
4 [label="make_constant:{in:[],out:[Out:{t_5,},],attr:[scalar:1,],party:[alice,bob,carol,]}"]
5 [label="broadcast:{in:[In:{t_5,},ShapeRefTensor:{t_4,},],out:[Out:{t_6,},],attr:[],party:[alice,]}"]
6 [label="Equal:{in:[Left:{t_4,},Right:{t_6,},],out:[Out:{t_7,},],attr:[],party:[alice,]}"]
7 [label="make_constant:{in:[],out:[Out:{t_8,},],attr:[scalar:2,],party:[alice,bob,carol,]}"]
8 [label="broadcast:{in:[In:{t_8,},ShapeRefTensor:{t_4,},],out:[Out:{t_9,},],attr:[],party:[alice,]}"]
9 [label="Equal:{in:[Left:{t_4,},Right:{t_9,},],out:[Out:{t_10,},],attr:[],party:[alice,]}"]
10 [label="make_constant:{in:[],out:[Out:{t_11,},],attr:[scalar:3,],party:[alice,bob,carol,]}"]
11 [label="broadcast:{in:[In:{t_11,},ShapeRefTensor:{t_4,},],out:[Out:{t_12,},],attr:[],party:[alice,]}"]
12 [label="Equal:{in:[Left:{t_4,},Right:{t_12,},],out:[Out:{t_13,},],attr:[],party:[alice,]}"]
13 [label="LogicalOr:{in:[Left:{t_10,},Right:{t_13,},],out:[Out:{t_14,},],attr:[],party:[alice,]}"]
14 [label="LogicalOr:{in:[Left:{t_7,},Right:{t_14,},],out:[Out:{t_15,},],attr:[],party:[alice,]}"]
15 [label="publish:{in:[In:{t_15,},],out:[Out:{t_16,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{plain_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{plain_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
10 -> 11 [label = "t_11:{constant_data:PUBLIC:INT64}"]
11 -> 12 [label = "t_12:{constant_data:PRIVATE:INT64}"]
12 -> 13 [label = "t_13:{Equal_out:PRIVATE:BOOL}"]
13 -> 14 [label = "t_14:{LogicalOr_out:PRIVATE:BOOL}"]
...
4 -> 5 [label = "t_5:{constant_data:PUBLIC:INT64}"]
5 -> 6 [label = "t_6:{constant_data:PRIVATE:INT64}"]
6 -> 14 [label = "t_7:{Equal_out:PRIVATE:BOOL}"]
7 -> 8 [label = "t_8:{constant_data:PUBLIC:INT64}"]
8 -> 9 [label = "t_9:{constant_data:PRIVATE:INT64}"]
9 -> 13 [label = "t_10:{Equal_out:PRIVATE:BOOL}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
