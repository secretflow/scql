...
0 [label="runsql:{in:[],out:[Out:{t_0,},],attr:[sql:select tbl_1.plain_float_0 from alice.tbl_1 join alice.tbl_2;,table_refs:[alice.tbl_1 alice.tbl_2],],party:[alice,]}"]
...
0 [label="runsql:{in:[],out:[Out:{t_0,t_1,t_2,},],attr:[sql:select t_0.expr_125 as r1,percent_rank() over (partition by t_0.r1 order by t_0.r2 desc) as r2,t_0.r3 from (select t_0.r1,t_0.r2,t_0.r3,rank() over (partition by t_0.r1 order by t_0.r2 desc) as expr_125 from (select ta.plain_int_0 as r1,ta.plain_float_0 as r2,row_number() over (partition by ta.plain_int_0 order by ta.plain_float_0 desc) as r3 from alice.tbl_0 as ta) as t_0) as t_0;,table_refs:[alice.tbl_0],],party:[alice,]}"]
1 [label="publish:{in:[In:{t_0,t_1,t_2,},],out:[Out:{t_3,t_4,t_5,},],attr:[],party:[alice,]}"]
0 -> 1 [label = "t_0:{Column#127:PRIVATE:INT64}"]
0 -> 1 [label = "t_1:{Column#128:PRIVATE:FLOAT64}"]
0 -> 1 [label = "t_2:{Column#129:PRIVATE:INT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false},
...
2 [label="join:{in:[Left:{t_0,},Right:{t_2,},],out:[LeftJoinIndex:{t_5,},RightJoinIndex:{t_6,},],attr:[input_party_codes:[alice bob],join_type:0,psi_algorithm:0,],party:[alice,bob,]}"]
3 [label="filter_by_index:{in:[Data:{t_1,},RowsIndexFilter:{t_5,},],out:[Out:{t_7,},],attr:[],party:[alice,]}"]
4 [label="filter_by_index:{in:[Data:{t_3,t_4,},RowsIndexFilter:{t_6,},],out:[Out:{t_8,t_9,},],attr:[],party:[bob,]}"]
...
7 [label="make_share:{in:[In:{t_9,},],out:[Out:{t_12,},],attr:[],party:[alice,bob,carol,]}"]
8 [label="sort:{in:[In:{t_10,t_11,t_12,t_10,t_11,t_12,},Key:{t_10,t_11,t_12,},],out:[Out:{t_13,t_14,t_15,t_16,t_17,t_18,},],attr:[reverse:[false false false],],party:[alice,bob,carol,]}"]
9 [label="partition_mark:{in:[Key:{t_13,},],out:[Group:{t_19,},],attr:[],party:[alice,bob,carol,]}"]
10 [label="count:{in:[Group:{t_19,},In:{t_19,},],out:[Out:{t_20,},],attr:[],party:[alice,bob,carol,]}"]
11 [label="sort:{in:[In:{t_16,t_17,t_18,t_16,t_20,},Key:{t_16,t_17,t_18,},],out:[Out:{t_21,t_22,t_23,t_24,t_25,},],attr:[reverse:[false false false],],party:[alice,bob,carol,]}"]
12 [label="partition_mark:{in:[Key:{t_21,},],out:[Group:{t_26,},],attr:[],party:[alice,bob,carol,]}"]
13 [label="order_mark:{in:[Key:{t_21,t_22,t_23,},],out:[Group:{t_27,},],attr:[],party:[alice,bob,carol,]}"]
14 [label="rank:{in:[Group:{t_26,},In:{t_27,},],out:[Out:{t_28,},],attr:[],party:[alice,bob,carol,]}"]
15 [label="make_private:{in:[In:{t_24,},],out:[Out:{t_29,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
16 [label="make_private:{in:[In:{t_28,},],out:[Out:{t_31,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
17 [label="make_private:{in:[In:{t_25,},],out:[Out:{t_33,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
18 [label="publish:{in:[In:{t_29,t_31,t_33,},],out:[Out:{t_30,t_32,t_34,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_1:{rank_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_2:{join_int_0:PRIVATE:INT64}"]
1 -> 4 [label = "t_3:{rank_float_0:PRIVATE:FLOAT32}"]
1 -> 4 [label = "t_4:{rank_float_1:PRIVATE:FLOAT32}"]
10 -> 11 [label = "t_20:{group_mark:SECRET:INT64}"]
11 -> 12 [label = "t_21:{rank_int_0:SECRET:INT64}"]
11 -> 13 [label = "t_21:{rank_int_0:SECRET:INT64}"]
11 -> 13 [label = "t_22:{rank_float_0:SECRET:FLOAT32}"]
11 -> 13 [label = "t_23:{rank_float_1:SECRET:FLOAT32}"]
11 -> 15 [label = "t_24:{rank_int_0:SECRET:INT64}"]
11 -> 17 [label = "t_25:{group_mark:SECRET:INT64}"]
12 -> 14 [label = "t_26:{group_mark:SECRET:BOOL}"]
13 -> 14 [label = "t_27:{group_mark:SECRET:INT64}"]
14 -> 16 [label = "t_28:{group_mark:SECRET:INT64}"]
15 -> 18 [label = "t_29:{rank_int_0:PRIVATE:INT64}"]
16 -> 18 [label = "t_31:{group_mark:PRIVATE:INT64}"]
17 -> 18 [label = "t_33:{group_mark:PRIVATE:INT64}"]
2 -> 3 [label = "t_5:{join_int_0:PRIVATE:INT64}"]
2 -> 4 [label = "t_6:{join_int_0:PRIVATE:INT64}"]
3 -> 5 [label = "t_7:{rank_int_0:PRIVATE:INT64}"]
4 -> 6 [label = "t_8:{rank_float_0:PRIVATE:FLOAT32}"]
4 -> 7 [label = "t_9:{rank_float_1:PRIVATE:FLOAT32}"]
5 -> 8 [label = "t_10:{rank_int_0:SECRET:INT64}"]
5 -> 8 [label = "t_10:{rank_int_0:SECRET:INT64}"]
5 -> 8 [label = "t_10:{rank_int_0:SECRET:INT64}"]
6 -> 8 [label = "t_11:{rank_float_0:SECRET:FLOAT32}"]
6 -> 8 [label = "t_11:{rank_float_0:SECRET:FLOAT32}"]
6 -> 8 [label = "t_11:{rank_float_0:SECRET:FLOAT32}"]
7 -> 8 [label = "t_12:{rank_float_1:SECRET:FLOAT32}"]
7 -> 8 [label = "t_12:{rank_float_1:SECRET:FLOAT32}"]
7 -> 8 [label = "t_12:{rank_float_1:SECRET:FLOAT32}"]
8 -> 11 [label = "t_16:{rank_int_0:SECRET:INT64}"]
8 -> 11 [label = "t_16:{rank_int_0:SECRET:INT64}"]
8 -> 11 [label = "t_16:{rank_int_0:SECRET:INT64}"]
8 -> 11 [label = "t_17:{rank_float_0:SECRET:FLOAT32}"]
8 -> 11 [label = "t_17:{rank_float_0:SECRET:FLOAT32}"]
8 -> 11 [label = "t_18:{rank_float_1:SECRET:FLOAT32}"]
8 -> 11 [label = "t_18:{rank_float_1:SECRET:FLOAT32}"]
8 -> 9 [label = "t_13:{rank_int_0:SECRET:INT64}"]
9 -> 10 [label = "t_19:{group_mark:SECRET:BOOL}"]
9 -> 10 [label = "t_19:{group_mark:SECRET:BOOL}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}}, {`SELECT rank() OVER(PARTITION BY ta.rank_int_0 ORDER BY tb.rank_int_0) FROM alice.tbl_0 as ta JOIN bob.tbl_0 as tb ON ta.join_int_0 = tb.join_int_0`, `digraph G {
0 [label="runsql:{in:[],out:[Out:{t_0,t_1,},],attr:[sql:select ta.join_int_0,ta.rank_int_0 from alice.tbl_0 as ta;,table_refs:[alice.tbl_0],],party:[alice,]}"]
1 [label="runsql:{in:[],out:[Out:{t_2,t_3,},],attr:[sql:select tb.join_int_0,tb.rank_int_0 from bob.tbl_0 as tb;,table_refs:[bob.tbl_0],],party:[bob,]}"]
...
7 [label="sort:{in:[In:{t_8,t_9,},Key:{t_8,t_9,},],out:[Out:{t_10,t_11,},],attr:[reverse:[false false],],party:[alice,bob,carol,]}"]
8 [label="partition_mark:{in:[Key:{t_10,},],out:[Group:{t_12,},],attr:[],party:[alice,bob,carol,]}"]
9 [label="order_mark:{in:[Key:{t_10,t_11,},],out:[Group:{t_13,},],attr:[],party:[alice,bob,carol,]}"]
10 [label="rank:{in:[Group:{t_12,},In:{t_13,},],out:[Out:{t_14,},],attr:[],party:[alice,bob,carol,]}"]
11 [label="make_private:{in:[In:{t_14,},],out:[Out:{t_15,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
12 [label="publish:{in:[In:{t_15,},],out:[Out:{t_16,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_1:{rank_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_2:{join_int_0:PRIVATE:INT64}"]
1 -> 4 [label = "t_3:{rank_int_0:PRIVATE:INT64}"]
10 -> 11 [label = "t_14:{group_mark:SECRET:INT64}"]
11 -> 12 [label = "t_15:{group_mark:PRIVATE:INT64}"]
2 -> 3 [label = "t_4:{join_int_0:PRIVATE:INT64}"]
2 -> 4 [label = "t_5:{join_int_0:PRIVATE:INT64}"]
3 -> 5 [label = "t_6:{rank_int_0:PRIVATE:INT64}"]
4 -> 6 [label = "t_7:{rank_int_0:PRIVATE:INT64}"]
5 -> 7 [label = "t_8:{rank_int_0:SECRET:INT64}"]
5 -> 7 [label = "t_8:{rank_int_0:SECRET:INT64}"]
6 -> 7 [label = "t_9:{rank_int_0:SECRET:INT64}"]
6 -> 7 [label = "t_9:{rank_int_0:SECRET:INT64}"]
7 -> 8 [label = "t_10:{rank_int_0:SECRET:INT64}"]
7 -> 9 [label = "t_10:{rank_int_0:SECRET:INT64}"]
7 -> 9 [label = "t_11:{rank_int_0:SECRET:INT64}"]
8 -> 10 [label = "t_12:{group_mark:SECRET:BOOL}"]
9 -> 10 [label = "t_13:{group_mark:SECRET:INT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}}, {`SELECT rank() OVER(PARTITION BY ta.join_int_0 ORDER BY ta.plain_int_0) FROM alice.tbl_0 as ta JOIN bob.tbl_0 as tb ON ta.join_int_0 = tb.join_int_0`, `digraph G {
0 [label="runsql:{in:[],out:[Out:{t_0,t_1,},],attr:[sql:select ta.join_int_0,ta.plain_int_0 from alice.tbl_0 as ta;,table_refs:[alice.tbl_0],],party:[alice,]}"]
1 [label="runsql:{in:[],out:[Out:{t_2,},],attr:[sql:select tb.join_int_0 from bob.tbl_0 as tb;,table_refs:[bob.tbl_0],],party:[bob,]}"]
2 [label="join:{in:[Left:{t_0,},Right:{t_2,},],out:[LeftJoinIndex:{t_3,},RightJoinIndex:{},],attr:[input_party_codes:[alice bob],join_type:0,psi_algorithm:0,],party:[alice,bob,]}"]
...
8 [label="sort:{in:[In:{t_10,t_11,t_12,t_10,t_11,},Key:{t_10,t_11,},],out:[Out:{t_13,t_14,t_15,t_16,t_17,},],attr:[reverse:[false false],],party:[alice,bob,carol,]}"]
9 [label="group_mark:{in:[Key:{t_13,t_14,},],out:[Group:{t_18,},],attr:[],party:[alice,bob,carol,]}"]
10 [label="sort:{in:[In:{t_15,},Key:{t_13,t_14,t_15,},],out:[Out:{t_19,},],attr:[reverse:[false false false],],party:[alice,bob,carol,]}"]
...
8 [label="sort:{in:[In:{t_9,t_10,t_11,},Key:{t_9,t_10,},],out:[Out:{t_12,t_13,t_14,},],attr:[reverse:[false false],],party:[alice,bob,carol,]}"]
9 [label="partition_mark:{in:[Key:{t_12,},],out:[Group:{t_15,},],attr:[],party:[alice,bob,carol,]}"]
10 [label="order_mark:{in:[Key:{t_12,t_13,},],out:[Group:{t_16,},],attr:[],party:[alice,bob,carol,]}"]
11 [label="percent_rank:{in:[Group:{t_15,},In:{t_16,},],out:[Out:{t_17,},],attr:[],party:[alice,bob,carol,]}"]
12 [label="make_private:{in:[In:{t_14,},],out:[Out:{t_18,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
13 [label="make_private:{in:[In:{t_17,},],out:[Out:{t_20,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
14 [label="publish:{in:[In:{t_18,t_20,},],out:[Out:{t_19,t_21,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_1:{rank_float_0:PRIVATE:FLOAT32}"]
1 -> 2 [label = "t_2:{join_int_0:PRIVATE:INT64}"]
1 -> 4 [label = "t_3:{rank_float_0:PRIVATE:FLOAT32}"]
10 -> 11 [label = "t_16:{group_mark:SECRET:INT64}"]
11 -> 13 [label = "t_17:{group_mark:SECRET:FLOAT64}"]
12 -> 14 [label = "t_18:{join_int_0:PRIVATE:INT64}"]
13 -> 14 [label = "t_20:{group_mark:PRIVATE:FLOAT64}"]
2 -> 3 [label = "t_4:{join_int_0:PRIVATE:INT64}"]
2 -> 4 [label = "t_5:{join_int_0:PRIVATE:INT64}"]
...
8 -> 10 [label = "t_12:{rank_float_0:SECRET:FLOAT32}"]
8 -> 10 [label = "t_13:{rank_float_0:SECRET:FLOAT32}"]
8 -> 12 [label = "t_14:{join_int_0:SECRET:INT64}"]
8 -> 9 [label = "t_12:{rank_float_0:SECRET:FLOAT32}"]
9 -> 11 [label = "t_15:{group_mark:SECRET:BOOL}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
...
22 [label="sort:{in:[In:{t_28,},Key:{t_12,t_28,},],out:[Out:{t_29,},],attr:[reverse:[false false],],party:[alice,bob,carol,]}"]
...
17 [label="sort:{in:[In:{t_30,t_31,t_24,t_25,t_26,t_27,},Key:{t_30,t_31,},],out:[Out:{t_32,t_33,t_34,t_35,t_36,t_37,},],attr:[reverse:[false false],],party:[alice,bob,carol,]}"]
...
24 [label="sort:{in:[In:{t_43,t_44,t_35,t_36,t_37,t_38,t_39,t_40,},Key:{t_43,t_44,},],out:[Out:{t_45,t_46,t_47,t_48,t_49,t_50,t_51,t_52,},],attr:[reverse:[false false],],party:[alice,bob,carol,]}"]
...
27 [label="sort:{in:[In:{t_49,},Key:{t_45,t_46,t_49,},],out:[Out:{t_55,},],attr:[reverse:[false false false],],party:[alice,bob,carol,]}"]
...
18 [label="sort:{in:[In:{t_27,t_28,t_29,t_30,t_27,t_31,t_32,t_28,t_33,t_29,t_30,},Key:{t_27,t_28,t_29,t_30,},],out:[Out:{t_34,t_35,t_36,t_37,t_38,t_39,t_40,t_41,t_42,t_43,t_44,},],attr:[reverse:[false false false false],],party:[alice,bob,carol,]}"]
...
21 [label="sort:{in:[In:{t_40,},Key:{t_34,t_35,t_36,t_37,t_40,},],out:[Out:{t_47,},],attr:[reverse:[false false false false false],],party:[alice,bob,carol,]}"]
...
18 [label="sort:{in:[In:{t_27,},Key:{t_24,t_27,},],out:[Out:{t_31,},],attr:[reverse:[false false],],party:[alice,bob,carol,]}"]
...
5 [label="make_share:{in:[In:{t_6,},],out:[Out:{t_8,},],attr:[],party:[alice,bob,carol,]}"]
6 [label="make_share:{in:[In:{t_7,},],out:[Out:{t_9,},],attr:[],party:[alice,bob,carol,]}"]
7 [label="sort:{in:[In:{t_8,t_9,t_8,t_9,},Key:{t_8,t_9,},],out:[Out:{t_10,t_11,t_12,t_13,},],attr:[reverse:[false false],],party:[alice,bob,carol,]}"]
...
4 -> 5 [label = "t_4:{plain_int_0:PRIVATE:INT64}"]
	...
	{`select t1.plain_int_0, t2.plain_int_0 from alice.tbl_1 as t1 join bob.tbl_0 as t2 join bob.tbl_1 as t3 join bob.tbl_2 as t4 where t1.plain_int_0 = t2.plain_int_0 and t2.plain_int_0 = t3.plain_int_0 and t3.plain_int_0 = t4.plain_int_0 order by t1.plain_int_0 desc, t2.plain_int_0 asc`, `digraph G {
0 [label="runsql:{in:[],out:[Out:{t_0,},],attr:[sql:select t1.plain_int_0 from alice.tbl_1 as t1;,table_refs:[alice.tbl_1],],party:[alice,]}"]
1 [label="runsql:{in:[],out:[Out:{t_1,},],attr:[sql:select t2.plain_int_0 from (select t2.plain_int_0,t3.plain_int_0 from (bob.tbl_0 as t2 join bob.tbl_1 as t3 on t2.plain_int_0=t3.plain_int_0)) as t2 join bob.tbl_2 as t4 on t2.plain_int_0=t4.plain_int_0;,table_refs:[bob.tbl_0 bob.tbl_1 bob.tbl_2],],party:[bob,]}"]
2 [label="join:{in:[Left:{t_0,},Right:{t_1,},],out:[LeftJoinIndex:{t_2,},RightJoinIndex:{t_3,},],attr:[input_party_codes:[alice bob],join_type:0,psi_algorithm:0,],party:[alice,bob,]}"]
3 [label="filter_by_index:{in:[Data:{t_0,},RowsIndexFilter:{t_2,},],out:[Out:{t_4,},],attr:[],party:[alice,]}"]
4 [label="filter_by_index:{in:[Data:{t_1,},RowsIndexFilter:{t_3,},],out:[Out:{t_5,},],attr:[],party:[bob,]}"]
5 [label="make_share:{in:[In:{t_4,},],out:[Out:{t_6,},],attr:[],party:[alice,bob,carol,]}"]
6 [label="make_share:{in:[In:{t_5,},],out:[Out:{t_7,},],attr:[],party:[alice,bob,carol,]}"]
7 [label="Sort:{in:[In:{t_6,t_7,},Key:{t_6,t_7,},],out:[Out:{t_8,t_9,},],attr:[reverse:[true false],],party:[alice,bob,carol,]}"]
8 [label="make_private:{in:[In:{t_8,},],out:[Out:{t_10,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
9 [label="make_private:{in:[In:{t_9,},],out:[Out:{t_12,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
10 [label="publish:{in:[In:{t_10,t_12,},],out:[Out:{t_11,t_13,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{plain_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{plain_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
1 -> 4 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
...
3 -> 5 [label = "t_4:{plain_int_0:PRIVATE:INT64}"]
4 -> 6 [label = "t_5:{plain_int_0:PRIVATE:INT64}"]
5 -> 7 [label = "t_6:{plain_int_0:SECRET:INT64}"]
5 -> 7 [label = "t_6:{plain_int_0:SECRET:INT64}"]
6 -> 7 [label = "t_7:{plain_int_0:SECRET:INT64}"]
6 -> 7 [label = "t_7:{plain_int_0:SECRET:INT64}"]
7 -> 8 [label = "t_8:{plain_int_0:SECRET:INT64}"]
7 -> 9 [label = "t_9:{plain_int_0:SECRET:INT64}"]
8 -> 10 [label = "t_10:{plain_int_0:PRIVATE:INT64}"]
9 -> 10 [label = "t_12:{plain_int_0:PRIVATE:INT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
}
