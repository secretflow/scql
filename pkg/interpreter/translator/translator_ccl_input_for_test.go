...
10 [label="percent_rank:{in:[Group:{t_15,},In:{t_15,},],out:[Out:{t_16,},],attr:[],party:[alice,bob,carol,]}"]
11 [label="make_private:{in:[In:{t_14,},],out:[Out:{t_17,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
12 [label="make_private:{in:[In:{t_16,},],out:[Out:{t_19,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
13 [label="publish:{in:[In:{t_17,t_19,},],out:[Out:{t_18,t_20,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_1:{rank_float_0:PRIVATE:FLOAT32}"]
1 -> 2 [label = "t_2:{join_int_0:PRIVATE:INT64}"]
1 -> 4 [label = "t_3:{rank_float_0:PRIVATE:FLOAT32}"]
10 -> 12 [label = "t_16:{group_mark:SECRET:FLOAT64}"]
11 -> 13 [label = "t_17:{join_int_0:PRIVATE:INT64}"]
12 -> 13 [label = "t_19:{group_mark:PRIVATE:FLOAT64}"]
2 -> 3 [label = "t_4:{join_int_0:PRIVATE:INT64}"]
2 -> 4 [label = "t_5:{join_int_0:PRIVATE:INT64}"]
...
8 -> 11 [label = "t_14:{join_int_0:SECRET:INT64}"]
8 -> 9 [label = "t_12:{rank_float_0:SECRET:FLOAT32}"]
9 -> 10 [label = "t_15:{group_mark:SECRET:BOOL}"]
9 -> 10 [label = "t_15:{group_mark:SECRET:BOOL}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
