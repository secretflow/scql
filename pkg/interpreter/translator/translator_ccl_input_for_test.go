...
5 [label="Abs:{in:[In:{t_6,},],out:[Out:{t_8,},],attr:[],party:[alice,]}"]
6 [label="Ceil:{in:[In:{t_6,},],out:[Out:{t_9,},],attr:[],party:[alice,]}"]
7 [label="Floor:{in:[In:{t_6,},],out:[Out:{t_10,},],attr:[],party:[alice,]}"]
8 [label="Round:{in:[In:{t_6,},],out:[Out:{t_11,},],attr:[],party:[alice,]}"]
9 [label="Radians:{in:[In:{t_6,},],out:[Out:{t_12,},],attr:[],party:[alice,]}"]
10 [label="Degrees:{in:[In:{t_6,},],out:[Out:{t_13,},],attr:[],party:[alice,]}"]
11 [label="Ln:{in:[In:{t_6,},],out:[Out:{t_14,},],attr:[],party:[alice,]}"]
12 [label="Log10:{in:[In:{t_6,},],out:[Out:{t_15,},],attr:[],party:[alice,]}"]
13 [label="Log2:{in:[In:{t_6,},],out:[Out:{t_16,},],attr:[],party:[alice,]}"]
14 [label="Sqrt:{in:[In:{t_6,},],out:[Out:{t_17,},],attr:[],party:[alice,]}"]
15 [label="Exp:{in:[In:{t_6,},],out:[Out:{t_18,},],attr:[],party:[alice,]}"]
16 [label="publish:{in:[In:{t_8,t_9,t_10,t_11,t_12,t_13,t_14,t_15,t_16,t_17,t_18,},],out:[Out:{t_19,t_20,t_21,t_22,t_23,t_24,t_25,t_26,t_27,t_28,t_29,},],attr:[],party:[alice,]}"]
...
10 -> 16 [label = "t_13:{plain_int_0:PRIVATE:FLOAT64}"]
11 -> 16 [label = "t_14:{plain_int_0:PRIVATE:FLOAT64}"]
12 -> 16 [label = "t_15:{plain_int_0:PRIVATE:FLOAT64}"]
13 -> 16 [label = "t_16:{plain_int_0:PRIVATE:FLOAT64}"]
14 -> 16 [label = "t_17:{plain_int_0:PRIVATE:FLOAT64}"]
15 -> 16 [label = "t_18:{plain_int_0:PRIVATE:FLOAT64}"]
2 -> 3 [label = "t_3:{join_int_0:PRIVATE:INT64}"]
2 -> 4 [label = "t_4:{join_int_0:PRIVATE:INT64}"]
3 -> 10 [label = "t_6:{plain_int_0:PRIVATE:INT64}"]
3 -> 11 [label = "t_6:{plain_int_0:PRIVATE:INT64}"]
3 -> 12 [label = "t_6:{plain_int_0:PRIVATE:INT64}"]
3 -> 13 [label = "t_6:{plain_int_0:PRIVATE:INT64}"]
3 -> 14 [label = "t_6:{plain_int_0:PRIVATE:INT64}"]
3 -> 15 [label = "t_6:{plain_int_0:PRIVATE:INT64}"]
...
5 -> 16 [label = "t_8:{plain_int_0:PRIVATE:INT64}"]
6 -> 16 [label = "t_9:{plain_int_0:PRIVATE:INT64}"]
7 -> 16 [label = "t_10:{plain_int_0:PRIVATE:INT64}"]
8 -> 16 [label = "t_11:{plain_int_0:PRIVATE:INT64}"]
9 -> 16 [label = "t_12:{plain_int_0:PRIVATE:FLOAT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false}},
}

var translateWithCCLTestCases = []sPair{
	{`SELECT ta.plain_int_0 FROM alice.tbl_0 as ta WHERE ta.plain_int_0 = ANY(SELECT ta.plain_int_0 + ta.plain_int_1 + 1 FROM alice.tbl_0 AS ta INNER JOIN bob.tbl_0 AS tb ON ta.plain_int_0 = tb.plain_int_0)`,
		`digraph G {
...
5 [label="filter_by_index:{in:[Data:{t_3,},RowsIndexFilter:{t_5,},],out:[Out:{t_8,},],attr:[],party:[bob,]}"]
6 [label="Add:{in:[Left:{t_6,},Right:{t_7,},],out:[Out:{t_9,},],attr:[],party:[alice,]}"]
7 [label="make_constant:{in:[],out:[Out:{t_10,},],attr:[scalar:1,],party:[alice,bob,carol,]}"]
8 [label="broadcast:{in:[In:{t_10,},ShapeRefTensor:{t_9,},],out:[Out:{t_11,},],attr:[],party:[alice,]}"]
9 [label="Add:{in:[Left:{t_9,},Right:{t_11,},],out:[Out:{t_12,},],attr:[],party:[alice,]}"]
10 [label="psi_in:{in:[Left:{t_0,},Right:{t_12,},],out:[Out:{t_13,},],attr:[in_type:2,input_party_codes:[alice alice],psi_algorithm:0,reveal_to:[alice],],party:[alice,alice,]}"]
11 [label="apply_filter:{in:[Filter:{t_13,},In:{t_0,t_13,},],out:[Out:{t_14,t_15,},],attr:[],party:[alice,]}"]
12 [label="publish:{in:[In:{t_14,},],out:[Out:{t_16,},],attr:[],party:[alice,]}"]
...
10 -> 11 [label = "t_13:{psi_in_out:PRIVATE:BOOL}"]
10 -> 11 [label = "t_13:{psi_in_out:PRIVATE:BOOL}"]
11 -> 12 [label = "t_14:{plain_int_0:PRIVATE:INT64}"]
2 -> 3 [label = "t_3:{plain_int_0:PRIVATE:INT64}"]
2 -> 5 [label = "t_3:{plain_int_0:PRIVATE:INT64}"]
3 -> 4 [label = "t_4:{plain_int_0:PRIVATE:INT64}"]
3 -> 5 [label = "t_5:{plain_int_0:PRIVATE:INT64}"]
4 -> 6 [label = "t_6:{plain_int_0:PRIVATE:INT64}"]
4 -> 6 [label = "t_7:{plain_int_1:PRIVATE:INT64}"]
6 -> 8 [label = "t_9:{Add_out:PRIVATE:INT64}"]
6 -> 9 [label = "t_9:{Add_out:PRIVATE:INT64}"]
7 -> 8 [label = "t_10:{constant_data:PUBLIC:INT64}"]
8 -> 9 [label = "t_11:{constant_data:PRIVATE:INT64}"]
9 -> 10 [label = "t_12:{Add_out:PRIVATE:INT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false}},
	{`SELECT ta.plain_int_0 FROM alice.tbl_0 as ta WHERE ta.plain_int_0 > (SELECT AVG(ta.plain_int_0) + SUM(ta.plain_int_1) + 1 FROM alice.tbl_0 AS ta INNER JOIN bob.tbl_0 AS tb ON ta.plain_int_0 = tb.plain_int_0)`,
		`digraph G {
0 [label="runsql:{in:[],out:[Out:{t_0,},],attr:[sql:select ta.plain_int_0 from alice.tbl_0 as ta;,table_refs:[alice.tbl_0],],party:[alice,]}"]
1 [label="runsql:{in:[],out:[Out:{t_1,t_2,},],attr:[sql:select ta.plain_int_0,ta.plain_int_1 from alice.tbl_0 as ta;,table_refs:[alice.tbl_0],],party:[alice,]}"]
2 [label="runsql:{in:[],out:[Out:{t_3,},],attr:[sql:select tb.plain_int_0 from bob.tbl_0 as tb;,table_refs:[bob.tbl_0],],party:[bob,]}"]
...
4 [label="filter_by_index:{in:[Data:{t_1,t_2,},RowsIndexFilter:{t_4,},],out:[Out:{t_6,t_7,},],attr:[],party:[alice,]}"]
5 [label="filter_by_index:{in:[Data:{t_3,},RowsIndexFilter:{t_5,},],out:[Out:{t_8,},],attr:[],party:[bob,]}"]
6 [label="reduce_avg:{in:[In:{t_6,},],out:[Out:{t_9,},],attr:[],party:[alice,]}"]
7 [label="reduce_sum:{in:[In:{t_7,},],out:[Out:{t_10,},],attr:[],party:[alice,]}"]
8 [label="Add:{in:[Left:{t_9,},Right:{t_10,},],out:[Out:{t_11,},],attr:[],party:[alice,]}"]
9 [label="make_constant:{in:[],out:[Out:{t_12,},],attr:[scalar:1,],party:[alice,bob,carol,]}"]
10 [label="broadcast:{in:[In:{t_12,},ShapeRefTensor:{t_11,},],out:[Out:{t_13,},],attr:[],party:[alice,]}"]
11 [label="Add:{in:[Left:{t_11,},Right:{t_13,},],out:[Out:{t_14,},],attr:[],party:[alice,]}"]
12 [label="Replicate:{in:[Left:{t_0,},Right:{t_14,},],out:[LeftOut:{t_15,},RightOut:{t_16,},],attr:[input_party_codes:[alice alice],],party:[alice,alice,]}"]
13 [label="Greater:{in:[Left:{t_15,},Right:{t_16,},],out:[Out:{t_17,},],attr:[],party:[alice,]}"]
14 [label="apply_filter:{in:[Filter:{t_17,},In:{t_15,t_16,},],out:[Out:{t_18,t_19,},],attr:[],party:[alice,]}"]
15 [label="publish:{in:[In:{t_18,},],out:[Out:{t_20,},],attr:[],party:[alice,]}"]
0 -> 12 [label = "t_0:{plain_int_0:PRIVATE:INT64}"]
1 -> 3 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
1 -> 4 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
1 -> 4 [label = "t_2:{plain_int_1:PRIVATE:INT64}"]
...
12 -> 13 [label = "t_16:{Add_out:PRIVATE:FLOAT64}"]
12 -> 14 [label = "t_15:{plain_int_0:PRIVATE:INT64}"]
12 -> 14 [label = "t_16:{Add_out:PRIVATE:FLOAT64}"]
13 -> 14 [label = "t_17:{Greater_out:PRIVATE:BOOL}"]
14 -> 15 [label = "t_18:{plain_int_0:PRIVATE:INT64}"]
2 -> 3 [label = "t_3:{plain_int_0:PRIVATE:INT64}"]
2 -> 5 [label = "t_3:{plain_int_0:PRIVATE:INT64}"]
3 -> 4 [label = "t_4:{plain_int_0:PRIVATE:INT64}"]
3 -> 5 [label = "t_5:{plain_int_0:PRIVATE:INT64}"]
4 -> 6 [label = "t_6:{plain_int_0:PRIVATE:INT64}"]
4 -> 7 [label = "t_7:{plain_int_1:PRIVATE:INT64}"]
6 -> 8 [label = "t_9:{plain_int_0:PRIVATE:FLOAT64}"]
7 -> 8 [label = "t_10:{plain_int_1:PRIVATE:INT64}"]
8 -> 10 [label = "t_11:{Add_out:PRIVATE:FLOAT64}"]
8 -> 11 [label = "t_11:{Add_out:PRIVATE:FLOAT64}"]
...
3 [label="filter_by_index:{in:[Data:{t_0,t_1,t_2,},RowsIndexFilter:{t_7,},],out:[Out:{t_9,t_10,t_11,},],attr:[],party:[alice,]}"]
4 [label="filter_by_index:{in:[Data:{t_3,t_4,t_5,t_6,},RowsIndexFilter:{t_8,},],out:[Out:{t_12,t_13,t_14,t_15,},],attr:[],party:[bob,]}"]
5 [label="copy:{in:[In:{t_13,},],out:[Out:{t_16,},],attr:[input_party_codes:bob,output_party_codes:alice,],party:[bob,alice,]}"]
6 [label="Greatest:{in:[In:{t_10,t_16,},],out:[Out:{t_17,},],attr:[],party:[alice,]}"]
7 [label="copy:{in:[In:{t_14,},],out:[Out:{t_18,},],attr:[input_party_codes:bob,output_party_codes:alice,],party:[bob,alice,]}"]
8 [label="Least:{in:[In:{t_10,t_18,},],out:[Out:{t_19,},],attr:[],party:[alice,]}"]
9 [label="copy:{in:[In:{t_15,},],out:[Out:{t_20,},],attr:[input_party_codes:bob,output_party_codes:alice,],party:[bob,alice,]}"]
10 [label="Greatest:{in:[In:{t_11,t_20,},],out:[Out:{t_21,},],attr:[],party:[alice,]}"]
11 [label="publish:{in:[In:{t_17,t_19,t_21,},],out:[Out:{t_22,t_23,t_24,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
...
10 -> 11 [label = "t_21:{plain_timestamp_0:PRIVATE:TIMESTAMP}"]
2 -> 3 [label = "t_7:{join_int_0:PRIVATE:INT64}"]
2 -> 4 [label = "t_8:{join_int_0:PRIVATE:INT64}"]
3 -> 10 [label = "t_11:{plain_timestamp_0:PRIVATE:TIMESTAMP}"]
3 -> 6 [label = "t_10:{plain_int_0:PRIVATE:INT64}"]
3 -> 8 [label = "t_10:{plain_int_0:PRIVATE:INT64}"]
4 -> 5 [label = "t_13:{plain_float_0:PRIVATE:FLOAT32}"]
4 -> 7 [label = "t_14:{plain_int_0:PRIVATE:INT64}"]
4 -> 9 [label = "t_15:{plain_timestamp_0:PRIVATE:TIMESTAMP}"]
5 -> 6 [label = "t_16:{plain_float_0:PRIVATE:FLOAT32}"]
6 -> 11 [label = "t_17:{plain_int_0:PRIVATE:FLOAT64}"]
7 -> 8 [label = "t_18:{plain_int_0:PRIVATE:INT64}"]
8 -> 11 [label = "t_19:{plain_int_0:PRIVATE:INT64}"]
9 -> 10 [label = "t_20:{plain_timestamp_0:PRIVATE:TIMESTAMP}"]
}`, ``, testConf{groupThreshold: 0, batched: false}},
...
5 [label="make_constant:{in:[],out:[Out:{t_10,},],attr:[scalar:2,],party:[alice,bob,carol,]}"]
6 [label="broadcast:{in:[In:{t_10,},ShapeRefTensor:{t_8,},],out:[Out:{t_11,},],attr:[],party:[alice,]}"]
7 [label="Pow:{in:[Left:{t_8,},Right:{t_11,},],out:[Out:{t_12,},],attr:[],party:[alice,]}"]
8 [label="make_constant:{in:[],out:[Out:{t_13,},],attr:[scalar:3,],party:[alice,bob,carol,]}"]
9 [label="broadcast:{in:[In:{t_13,},ShapeRefTensor:{t_7,},],out:[Out:{t_14,},],attr:[],party:[alice,]}"]
10 [label="Pow:{in:[Left:{t_7,},Right:{t_14,},],out:[Out:{t_15,},],attr:[],party:[alice,]}"]
11 [label="publish:{in:[In:{t_12,t_15,},],out:[Out:{t_16,t_17,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
...
1 -> 2 [label = "t_3:{join_int_0:PRIVATE:INT64}"]
1 -> 4 [label = "t_3:{join_int_0:PRIVATE:INT64}"]
10 -> 11 [label = "t_15:{Pow_out:PRIVATE:FLOAT64}"]
2 -> 3 [label = "t_4:{join_int_0:PRIVATE:INT64}"]
2 -> 4 [label = "t_5:{join_int_0:PRIVATE:INT64}"]
3 -> 10 [label = "t_7:{plain_float_0:PRIVATE:FLOAT32}"]
3 -> 6 [label = "t_8:{plain_int_0:PRIVATE:INT64}"]
3 -> 7 [label = "t_8:{plain_int_0:PRIVATE:INT64}"]
3 -> 9 [label = "t_7:{plain_float_0:PRIVATE:FLOAT32}"]
5 -> 6 [label = "t_10:{constant_data:PUBLIC:INT64}"]
6 -> 7 [label = "t_11:{constant_data:PRIVATE:INT64}"]
7 -> 11 [label = "t_12:{Pow_out:PRIVATE:INT64}"]
8 -> 9 [label = "t_13:{constant_data:PUBLIC:INT64}"]
9 -> 10 [label = "t_14:{constant_data:PRIVATE:INT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false}},
...
6 [label="ATan2:{in:[Left:{t_7,},Right:{t_10,},],out:[Out:{t_11,},],attr:[],party:[alice,]}"]
7 [label="publish:{in:[In:{t_11,},],out:[Out:{t_12,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_2:{join_int_0:PRIVATE:INT64}"]
...
4 -> 5 [label = "t_9:{plain_int_0:PRIVATE:INT64}"]
5 -> 6 [label = "t_10:{plain_int_0:PRIVATE:INT64}"]
6 -> 7 [label = "t_11:{ATan2_out:PRIVATE:FLOAT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false}},
...
3 [label="filter_by_index:{in:[Data:{t_0,t_1,t_2,},RowsIndexFilter:{t_4,},],out:[Out:{t_6,t_7,t_8,},],attr:[],party:[alice,]}"]
4 [label="filter_by_index:{in:[Data:{t_3,},RowsIndexFilter:{t_5,},],out:[Out:{t_9,},],attr:[],party:[bob,]}"]
5 [label="Tan:{in:[In:{t_8,},],out:[Out:{t_10,},],attr:[],party:[alice,]}"]
6 [label="Tan:{in:[In:{t_7,},],out:[Out:{t_11,},],attr:[],party:[alice,]}"]
7 [label="make_constant:{in:[],out:[Out:{t_12,},],attr:[scalar:1,],party:[alice,bob,carol,]}"]
8 [label="Tan:{in:[In:{t_8,},],out:[Out:{t_13,},],attr:[],party:[alice,]}"]
9 [label="broadcast:{in:[In:{t_12,},ShapeRefTensor:{t_13,},],out:[Out:{t_14,},],attr:[],party:[alice,]}"]
10 [label="Div:{in:[Left:{t_14,},Right:{t_13,},],out:[Out:{t_15,},],attr:[],party:[alice,]}"]
11 [label="make_constant:{in:[],out:[Out:{t_16,},],attr:[scalar:1,],party:[alice,bob,carol,]}"]
12 [label="Tan:{in:[In:{t_7,},],out:[Out:{t_17,},],attr:[],party:[alice,]}"]
13 [label="broadcast:{in:[In:{t_16,},ShapeRefTensor:{t_17,},],out:[Out:{t_18,},],attr:[],party:[alice,]}"]
14 [label="Div:{in:[Left:{t_18,},Right:{t_17,},],out:[Out:{t_19,},],attr:[],party:[alice,]}"]
15 [label="ASin:{in:[In:{t_8,},],out:[Out:{t_20,},],attr:[],party:[alice,]}"]
16 [label="ASin:{in:[In:{t_7,},],out:[Out:{t_21,},],attr:[],party:[alice,]}"]
17 [label="ATan:{in:[In:{t_8,},],out:[Out:{t_22,},],attr:[],party:[alice,]}"]
18 [label="ATan:{in:[In:{t_7,},],out:[Out:{t_23,},],attr:[],party:[alice,]}"]
19 [label="publish:{in:[In:{t_6,t_10,t_11,t_15,t_19,t_20,t_21,t_22,t_23,},],out:[Out:{t_24,t_25,t_26,t_27,t_28,t_29,t_30,t_31,t_32,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_1:{plain_float_0:PRIVATE:FLOAT32}"]
0 -> 3 [label = "t_2:{plain_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_3:{join_int_0:PRIVATE:INT64}"]
1 -> 4 [label = "t_3:{join_int_0:PRIVATE:INT64}"]
10 -> 19 [label = "t_15:{Div_out:PRIVATE:FLOAT64}"]
11 -> 13 [label = "t_16:{constant_data:PUBLIC:INT64}"]
12 -> 13 [label = "t_17:{plain_float_0:PRIVATE:FLOAT64}"]
12 -> 14 [label = "t_17:{plain_float_0:PRIVATE:FLOAT64}"]
13 -> 14 [label = "t_18:{constant_data:PRIVATE:INT64}"]
14 -> 19 [label = "t_19:{Div_out:PRIVATE:FLOAT64}"]
15 -> 19 [label = "t_20:{plain_int_0:PRIVATE:FLOAT64}"]
16 -> 19 [label = "t_21:{plain_float_0:PRIVATE:FLOAT64}"]
17 -> 19 [label = "t_22:{plain_int_0:PRIVATE:FLOAT64}"]
18 -> 19 [label = "t_23:{plain_float_0:PRIVATE:FLOAT64}"]
2 -> 3 [label = "t_4:{join_int_0:PRIVATE:INT64}"]
2 -> 4 [label = "t_5:{join_int_0:PRIVATE:INT64}"]
3 -> 12 [label = "t_7:{plain_float_0:PRIVATE:FLOAT32}"]
3 -> 15 [label = "t_8:{plain_int_0:PRIVATE:INT64}"]
3 -> 16 [label = "t_7:{plain_float_0:PRIVATE:FLOAT32}"]
3 -> 17 [label = "t_8:{plain_int_0:PRIVATE:INT64}"]
3 -> 18 [label = "t_7:{plain_float_0:PRIVATE:FLOAT32}"]
3 -> 19 [label = "t_6:{join_int_0:PRIVATE:INT64}"]
3 -> 5 [label = "t_8:{plain_int_0:PRIVATE:INT64}"]
3 -> 6 [label = "t_7:{plain_float_0:PRIVATE:FLOAT32}"]
3 -> 8 [label = "t_8:{plain_int_0:PRIVATE:INT64}"]
5 -> 19 [label = "t_10:{plain_int_0:PRIVATE:FLOAT64}"]
6 -> 19 [label = "t_11:{plain_float_0:PRIVATE:FLOAT64}"]
7 -> 9 [label = "t_12:{constant_data:PUBLIC:INT64}"]
8 -> 10 [label = "t_13:{plain_int_0:PRIVATE:FLOAT64}"]
8 -> 9 [label = "t_13:{plain_int_0:PRIVATE:FLOAT64}"]
9 -> 10 [label = "t_14:{constant_data:PRIVATE:INT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false}},
...
11 [label="secret_join:{in:[Left:{t_13,t_12,},LeftKey:{t_12,},Right:{t_8,t_11,},RightKey:{t_8,},],out:[LeftOutput:{t_14,t_15,},RightOutput:{t_16,t_17,},],attr:[input_party_codes:[alice bob carol],],party:[alice,bob,carol,]}"]
12 [label="make_private:{in:[In:{t_15,},],out:[Out:{t_18,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
13 [label="make_private:{in:[In:{t_14,},],out:[Out:{t_20,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
14 [label="make_private:{in:[In:{t_17,},],out:[Out:{t_22,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
15 [label="publish:{in:[In:{t_18,t_20,t_22,},],out:[Out:{t_19,t_21,t_23,},],attr:[],party:[alice,]}"]
...
11 -> 14 [label = "t_17:{Column#362:SECRET:FLOAT32}"]
12 -> 15 [label = "t_18:{join_int_0:PRIVATE:INT64}"]
13 -> 15 [label = "t_20:{aggregate_string_0:PRIVATE:STRING}"]
14 -> 15 [label = "t_22:{Column#362:PRIVATE:FLOAT32}"]
...
Outputs: [t_14 t_15 t_17]
}
pipeline 7 {
Batched: false
node: [make_private_12 make_private_13 make_private_14]
Inputs: [t_14 t_15 t_17]
Outputs: [t_18 t_20 t_22]
}
pipeline 8 {
Batched: false
node: [publish_15]
Inputs: [t_18 t_20 t_22]
Outputs: []
}
...
3 [label="filter_by_index:{in:[Data:{t_0,t_1,},RowsIndexFilter:{t_3,},],out:[Out:{t_5,t_6,},],attr:[],party:[alice,]}"]
4 [label="filter_by_index:{in:[Data:{t_2,},RowsIndexFilter:{t_4,},],out:[Out:{t_7,},],attr:[],party:[bob,]}"]
5 [label="make_constant:{in:[],out:[Out:{t_8,},],attr:[scalar:-1,],party:[alice,bob,carol,]}"]
6 [label="make_constant:{in:[],out:[Out:{t_9,},],attr:[scalar:0,],party:[alice,bob,carol,]}"]
...
1 -> 2 [label = "t_2:{join_int_0:PRIVATE:INT64}"]
1 -> 4 [label = "t_2:{join_int_0:PRIVATE:INT64}"]
10 -> 11 [label = "t_13:{constant_data:PRIVATE:FLOAT64}"]
2 -> 3 [label = "t_3:{join_int_0:PRIVATE:INT64}"]
2 -> 4 [label = "t_4:{join_int_0:PRIVATE:INT64}"]
3 -> 10 [label = "t_6:{plain_float_0:PRIVATE:FLOAT32}"]
3 -> 7 [label = "t_6:{plain_float_0:PRIVATE:FLOAT32}"]
3 -> 8 [label = "t_6:{plain_float_0:PRIVATE:FLOAT32}"]
5 -> 9 [label = "t_8:{constant_data:PUBLIC:FLOAT64}"]
...
0 [label="runsql:{in:[],out:[Out:{t_0,},],attr:[sql:select t_0.expr_242 from (select count(alice.groupby_int_1) as expr_242 from alice.tbl_0 as alice where alice.groupby_int_0>=0 group by alice.groupby_int_1 having (count(alice.groupby_int_1)>0) and (count(alice.groupby_int_1)>=4) limit 3) as t_0;,table_refs:[alice.tbl_0],],party:[alice,]}"]
...
8 [label="make_constant:{in:[],out:[Out:{t_15,},],attr:[scalar:null,],party:[alice,bob,carol,]}"]
...
6 [label="arrow_substr:{in:[In:{t_4,},],out:[Out:{t_7,},],attr:[func_name:utf8_slice_codeunits,func_opt_type:SliceOptions,],party:[alice,]}"]
7 [label="publish:{in:[In:{t_6,t_7,},],out:[Out:{t_8,t_9,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_string_0:PRIVATE:STRING}"]
0 -> 3 [label = "t_0:{join_string_0:PRIVATE:STRING}"]
1 -> 2 [label = "t_1:{join_string_0:PRIVATE:STRING}"]
1 -> 4 [label = "t_1:{join_string_0:PRIVATE:STRING}"]
...
3 -> 5 [label = "t_4:{join_string_0:PRIVATE:STRING}"]
3 -> 6 [label = "t_4:{join_string_0:PRIVATE:STRING}"]
5 -> 7 [label = "t_6:{arrow_substr_out:PRIVATE:STRING}"]
6 -> 7 [label = "t_7:{arrow_substr_out:PRIVATE:STRING}"]
}`, ``, testConf{groupThreshold: 0, batched: false}},
...
0 [label="runsql:{in:[],out:[Out:{t_0,},],attr:[sql:select any_value(t_0.expr_242) as expr_244 from (select count(alice.groupby_int_1) as expr_242 from alice.tbl_0 as alice where alice.groupby_int_0>=0 group by alice.groupby_int_1 having (count(alice.groupby_int_1)>0) and (count(alice.groupby_int_1)>=4) limit 3) as t_0 group by t_0.expr_242;,table_refs:[alice.tbl_0],],party:[alice,]}"]
...
11 [label="make_constant:{in:[],out:[Out:{t_20,},],attr:[scalar:1,],party:[alice,bob,carol,]}"]
...
16 [label="make_constant:{in:[],out:[Out:{t_25,},],attr:[scalar:aa,],party:[alice,bob,carol,]}"]
...
31 [label="make_constant:{in:[],out:[Out:{t_43,},],attr:[scalar:4,],party:[alice,bob,carol,]}"]
...
0 [label="runsql:{in:[],out:[Out:{t_0,t_1,},],attr:[sql:select any_value(1) as expr_244,any_value(ta.aggregate_int_0) as expr_241 from alice.tbl_0 as ta group by ta.aggregate_int_0;,table_refs:[alice.tbl_0],],party:[alice,]}"]
1 [label="runsql:{in:[],out:[Out:{t_2,t_3,},],attr:[sql:select any_value(1) as expr_244,any_value(tbl_0.aggregate_int_0) as expr_241 from bob.tbl_0 group by tbl_0.aggregate_int_0;,table_refs:[bob.tbl_0],],party:[bob,]}"]
...
0 -> 2 [label = "t_0:{Column#244:PRIVATE:BOOL}"]
0 -> 5 [label = "t_1:{Column#241:PRIVATE:INT64}"]
1 -> 3 [label = "t_2:{Column#244:PRIVATE:BOOL}"]
1 -> 6 [label = "t_3:{Column#241:PRIVATE:INT64}"]
10 -> 11 [label = "t_15:{group_mark:SECRET:BOOL}"]
10 -> 12 [label = "t_14:{Column#244:SECRET:BOOL}"]
11 -> 12 [label = "t_16:{group_mark:PUBLIC:BOOL}"]
12 -> 13 [label = "t_17:{Column#244:SECRET:BOOL}"]
13 -> 14 [label = "t_18:{Column#244:PRIVATE:INT64}"]
2 -> 4 [label = "t_4:{Column#244:SECRET:BOOL}"]
3 -> 4 [label = "t_5:{Column#244:SECRET:BOOL}"]
4 -> 8 [label = "t_6:{Column#244:SECRET:BOOL}"]
5 -> 7 [label = "t_7:{Column#241:SECRET:INT64}"]
6 -> 7 [label = "t_8:{Column#241:SECRET:INT64}"]
7 -> 8 [label = "t_9:{Column#241:SECRET:INT64}"]
7 -> 8 [label = "t_9:{Column#241:SECRET:INT64}"]
7 -> 8 [label = "t_9:{Column#241:SECRET:INT64}"]
8 -> 10 [label = "t_11:{Column#244:SECRET:BOOL}"]
...
11 [label="copy:{in:[In:{t_17,},],out:[Out:{t_23,},],attr:[input_party_codes:bob,output_party_codes:alice,],party:[bob,alice,]}"]
12 [label="publish:{in:[In:{t_19,t_20,t_23,t_18,},],out:[Out:{t_21,t_22,t_24,t_25,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_4:{join_int_0:PRIVATE:INT64}"]
...
19 [label="shuffle:{in:[In:{t_26,t_27,t_28,t_29,t_30,t_26,t_31,t_32,t_33,t_27,},],out:[Out:{t_34,t_35,t_36,t_37,t_38,t_39,t_40,t_41,t_42,t_43,},],attr:[],party:[alice,bob,carol,]}"]
20 [label="make_private:{in:[In:{t_34,},],out:[Out:{t_44,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
21 [label="make_private:{in:[In:{t_35,},],out:[Out:{t_45,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
22 [label="make_share:{in:[In:{t_44,},],out:[Out:{t_46,},],attr:[],party:[alice,bob,carol,]}"]
23 [label="make_share:{in:[In:{t_45,},],out:[Out:{t_47,},],attr:[],party:[alice,bob,carol,]}"]
24 [label="sort:{in:[In:{t_46,t_47,t_36,t_37,t_38,t_39,t_40,t_41,t_42,t_43,},Key:{t_46,t_47,},],out:[Out:{t_48,t_49,t_50,t_51,t_52,t_53,t_54,t_55,t_56,t_57,},],attr:[reverse:false,],party:[alice,bob,carol,]}"]
25 [label="group_mark:{in:[Key:{t_48,t_49,},],out:[Group:{t_58,},],attr:[],party:[alice,bob,carol,]}"]
26 [label="count:{in:[Group:{t_58,},In:{t_58,},],out:[Out:{t_59,},],attr:[],party:[alice,bob,carol,]}"]
27 [label="min:{in:[Group:{t_58,},In:{t_51,},],out:[Out:{t_60,},],attr:[],party:[alice,bob,carol,]}"]
28 [label="max:{in:[Group:{t_58,},In:{t_55,},],out:[Out:{t_61,},],attr:[],party:[alice,bob,carol,]}"]
29 [label="shuffle:{in:[In:{t_59,t_60,t_61,t_53,t_57,t_58,},],out:[Out:{t_62,t_63,t_64,t_65,t_66,t_67,},],attr:[],party:[alice,bob,carol,]}"]
30 [label="make_public:{in:[In:{t_67,},],out:[Out:{t_68,},],attr:[],party:[alice,bob,carol,]}"]
31 [label="filter:{in:[Filter:{t_68,},In:{t_62,t_63,t_64,t_65,t_66,},],out:[Out:{t_69,t_70,t_71,t_72,t_73,},],attr:[],party:[alice,bob,carol,]}"]
32 [label="make_constant:{in:[],out:[Out:{t_74,},],attr:[scalar:4,],party:[alice,bob,carol,]}"]
33 [label="broadcast:{in:[In:{t_74,},ShapeRefTensor:{t_69,},],out:[Out:{t_75,},],attr:[],party:[alice,bob,carol,]}"]
34 [label="make_private:{in:[In:{t_69,},],out:[Out:{t_76,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
35 [label="make_private:{in:[In:{t_75,},],out:[Out:{t_77,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
36 [label="GreaterEqual:{in:[Left:{t_76,},Right:{t_77,},],out:[Out:{t_78,},],attr:[],party:[alice,]}"]
37 [label="make_private:{in:[In:{t_72,},],out:[Out:{t_79,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
38 [label="make_private:{in:[In:{t_73,},],out:[Out:{t_80,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
39 [label="make_private:{in:[In:{t_70,},],out:[Out:{t_81,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
40 [label="make_private:{in:[In:{t_71,},],out:[Out:{t_82,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
41 [label="apply_filter:{in:[Filter:{t_78,},In:{t_79,t_80,t_76,t_81,t_82,},],out:[Out:{t_83,t_84,t_85,t_86,t_87,},],attr:[],party:[alice,]}"]
42 [label="publish:{in:[In:{t_85,t_83,t_84,t_86,t_87,},],out:[Out:{t_88,t_89,t_90,t_91,t_92,},],attr:[],party:[alice,]}"]
...
19 -> 21 [label = "t_35:{gb_en_pl_int_0:SECRET:INT64}"]
19 -> 24 [label = "t_36:{pl_jn_cp_int_0:SECRET:INT64}"]
19 -> 24 [label = "t_37:{ag_pl_en_int_0:SECRET:INT64}"]
19 -> 24 [label = "t_38:{cp_pl_jn_int_0:SECRET:INT64}"]
19 -> 24 [label = "t_39:{gb_pl_en_int_0:SECRET:INT64}"]
19 -> 24 [label = "t_40:{jn_pl_cp_int_0:SECRET:INT64}"]
19 -> 24 [label = "t_41:{agg_en_pl_int_0:SECRET:INT64}"]
19 -> 24 [label = "t_42:{cp_jn_pl_int_0:SECRET:INT64}"]
...
20 -> 22 [label = "t_44:{gb_pl_en_int_0:PRIVATE:INT64}"]
21 -> 23 [label = "t_45:{gb_en_pl_int_0:PRIVATE:INT64}"]
22 -> 24 [label = "t_46:{gb_pl_en_int_0:SECRET:INT64}"]
22 -> 24 [label = "t_46:{gb_pl_en_int_0:SECRET:INT64}"]
23 -> 24 [label = "t_47:{gb_en_pl_int_0:SECRET:INT64}"]
23 -> 24 [label = "t_47:{gb_en_pl_int_0:SECRET:INT64}"]
24 -> 25 [label = "t_48:{gb_pl_en_int_0:SECRET:INT64}"]
24 -> 25 [label = "t_49:{gb_en_pl_int_0:SECRET:INT64}"]
24 -> 27 [label = "t_51:{ag_pl_en_int_0:SECRET:INT64}"]
24 -> 28 [label = "t_55:{agg_en_pl_int_0:SECRET:INT64}"]
24 -> 29 [label = "t_53:{gb_pl_en_int_0:SECRET:INT64}"]
24 -> 29 [label = "t_57:{gb_en_pl_int_0:SECRET:INT64}"]
25 -> 26 [label = "t_58:{group_mark:SECRET:BOOL}"]
25 -> 26 [label = "t_58:{group_mark:SECRET:BOOL}"]
25 -> 27 [label = "t_58:{group_mark:SECRET:BOOL}"]
25 -> 28 [label = "t_58:{group_mark:SECRET:BOOL}"]
25 -> 29 [label = "t_58:{group_mark:SECRET:BOOL}"]
26 -> 29 [label = "t_59:{group_mark:SECRET:INT64}"]
27 -> 29 [label = "t_60:{ag_pl_en_int_0:SECRET:INT64}"]
28 -> 29 [label = "t_61:{agg_en_pl_int_0:SECRET:INT64}"]
29 -> 30 [label = "t_67:{group_mark:SECRET:BOOL}"]
29 -> 31 [label = "t_62:{group_mark:SECRET:INT64}"]
29 -> 31 [label = "t_63:{ag_pl_en_int_0:SECRET:INT64}"]
29 -> 31 [label = "t_64:{agg_en_pl_int_0:SECRET:INT64}"]
29 -> 31 [label = "t_65:{gb_pl_en_int_0:SECRET:INT64}"]
29 -> 31 [label = "t_66:{gb_en_pl_int_0:SECRET:INT64}"]
3 -> 8 [label = "t_7:{pl_jn_cp_int_0:PRIVATE:INT64}"]
30 -> 31 [label = "t_68:{group_mark:PUBLIC:BOOL}"]
31 -> 33 [label = "t_69:{group_mark:SECRET:INT64}"]
31 -> 34 [label = "t_69:{group_mark:SECRET:INT64}"]
31 -> 37 [label = "t_72:{gb_pl_en_int_0:SECRET:INT64}"]
31 -> 38 [label = "t_73:{gb_en_pl_int_0:SECRET:INT64}"]
31 -> 39 [label = "t_70:{ag_pl_en_int_0:SECRET:INT64}"]
31 -> 40 [label = "t_71:{agg_en_pl_int_0:SECRET:INT64}"]
32 -> 33 [label = "t_74:{constant_data:PUBLIC:INT64}"]
33 -> 35 [label = "t_75:{constant_data:PUBLIC:INT64}"]
34 -> 36 [label = "t_76:{group_mark:PRIVATE:INT64}"]
34 -> 41 [label = "t_76:{group_mark:PRIVATE:INT64}"]
35 -> 36 [label = "t_77:{constant_data:PRIVATE:INT64}"]
36 -> 41 [label = "t_78:{GreaterEqual_out:PRIVATE:BOOL}"]
37 -> 41 [label = "t_79:{gb_pl_en_int_0:PRIVATE:INT64}"]
38 -> 41 [label = "t_80:{gb_en_pl_int_0:PRIVATE:INT64}"]
39 -> 41 [label = "t_81:{ag_pl_en_int_0:PRIVATE:INT64}"]
...
40 -> 41 [label = "t_82:{agg_en_pl_int_0:PRIVATE:INT64}"]
41 -> 42 [label = "t_83:{gb_pl_en_int_0:PRIVATE:INT64}"]
41 -> 42 [label = "t_84:{gb_en_pl_int_0:PRIVATE:INT64}"]
41 -> 42 [label = "t_85:{group_mark:PRIVATE:INT64}"]
41 -> 42 [label = "t_86:{ag_pl_en_int_0:PRIVATE:INT64}"]
41 -> 42 [label = "t_87:{agg_en_pl_int_0:PRIVATE:INT64}"]
...
0 [label="runsql:{in:[],out:[Out:{t_0,t_1,},],attr:[sql:select any_value(1) as expr_364,any_value(ta.groupby_string_0) as expr_361 from alice.tbl_0 as ta group by ta.groupby_string_0;,table_refs:[alice.tbl_0],],party:[alice,]}"]
1 [label="runsql:{in:[],out:[Out:{t_2,t_3,},],attr:[sql:select any_value(1) as expr_364,any_value(tb.groupby_string_0) as expr_361 from bob.tbl_0 as tb group by tb.groupby_string_0;,table_refs:[bob.tbl_0],],party:[bob,]}"]
2 [label="runsql:{in:[],out:[Out:{t_4,t_5,},],attr:[sql:select any_value(1) as expr_364,any_value(tc.groupby_string_0) as expr_361 from carol.tbl_0 as tc group by tc.groupby_string_0;,table_refs:[carol.tbl_0],],party:[carol,]}"]
...
0 -> 3 [label = "t_0:{Column#364:PRIVATE:BOOL}"]
0 -> 7 [label = "t_1:{Column#361:PRIVATE:STRING}"]
1 -> 4 [label = "t_2:{Column#364:PRIVATE:BOOL}"]
...
14 -> 15 [label = "t_18:{Column#364:PRIVATE:BOOL}"]
15 -> 16 [label = "t_19:{Column#364_firstrow:PRIVATE:BOOL}"]
16 -> 17 [label = "t_20:{Column#364_firstrow:PRIVATE:INT64}"]
2 -> 5 [label = "t_4:{Column#364:PRIVATE:BOOL}"]
2 -> 9 [label = "t_5:{Column#361:PRIVATE:STRING}"]
3 -> 6 [label = "t_6:{Column#364:SECRET:BOOL}"]
4 -> 6 [label = "t_7:{Column#364:SECRET:BOOL}"]
5 -> 6 [label = "t_8:{Column#364:SECRET:BOOL}"]
6 -> 14 [label = "t_9:{Column#364:SECRET:BOOL}"]
...
22 [label="shuffle:{in:[In:{t_31,t_33,t_29,t_34,t_35,t_36,t_30,t_37,t_38,t_32,t_39,},],out:[Out:{t_40,t_41,t_42,t_43,t_44,t_45,t_46,t_47,t_48,t_49,t_50,},],attr:[],party:[alice,bob,carol,]}"]
23 [label="make_private:{in:[In:{t_40,},],out:[Out:{t_51,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
24 [label="make_private:{in:[In:{t_41,},],out:[Out:{t_52,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
25 [label="make_share:{in:[In:{t_51,},],out:[Out:{t_53,},],attr:[],party:[alice,bob,carol,]}"]
26 [label="make_share:{in:[In:{t_52,},],out:[Out:{t_54,},],attr:[],party:[alice,bob,carol,]}"]
27 [label="sort:{in:[In:{t_53,t_54,t_42,t_43,t_44,t_45,t_46,t_47,t_48,t_49,t_50,},Key:{t_53,t_54,},],out:[Out:{t_55,t_56,t_57,t_58,t_59,t_60,t_61,t_62,t_63,t_64,t_65,},],attr:[reverse:false,],party:[alice,bob,carol,]}"]
28 [label="group_mark:{in:[Key:{t_55,t_56,},],out:[Group:{t_66,},],attr:[],party:[alice,bob,carol,]}"]
29 [label="count:{in:[Group:{t_66,},In:{t_66,},],out:[Out:{t_67,},],attr:[],party:[alice,bob,carol,]}"]
30 [label="sort:{in:[In:{t_60,},Key:{t_55,t_56,t_60,},],out:[Out:{t_68,},],attr:[reverse:false,],party:[alice,bob,carol,]}"]
31 [label="group_mark:{in:[Key:{t_68,},],out:[Group:{t_69,},],attr:[],party:[alice,bob,carol,]}"]
32 [label="LogicalOr:{in:[Left:{t_66,},Right:{t_69,},],out:[Out:{t_70,},],attr:[],party:[alice,bob,carol,]}"]
33 [label="sum:{in:[Group:{t_66,},In:{t_70,},],out:[Out:{t_71,},],attr:[],party:[alice,bob,carol,]}"]
34 [label="sum:{in:[Group:{t_66,},In:{t_59,},],out:[Out:{t_72,},],attr:[],party:[alice,bob,carol,]}"]
35 [label="sum:{in:[Group:{t_66,},In:{t_63,},],out:[Out:{t_73,},],attr:[],party:[alice,bob,carol,]}"]
36 [label="shuffle:{in:[In:{t_67,t_71,t_72,t_73,t_66,},],out:[Out:{t_74,t_75,t_76,t_77,t_78,},],attr:[],party:[alice,bob,carol,]}"]
37 [label="make_public:{in:[In:{t_78,},],out:[Out:{t_79,},],attr:[],party:[alice,bob,carol,]}"]
38 [label="filter:{in:[Filter:{t_79,},In:{t_74,t_75,t_76,t_77,},],out:[Out:{t_80,t_81,t_82,t_83,},],attr:[],party:[alice,bob,carol,]}"]
39 [label="make_constant:{in:[],out:[Out:{t_84,},],attr:[scalar:4,],party:[alice,bob,carol,]}"]
40 [label="broadcast:{in:[In:{t_84,},ShapeRefTensor:{t_80,},],out:[Out:{t_85,},],attr:[],party:[alice,bob,carol,]}"]
41 [label="make_private:{in:[In:{t_80,},],out:[Out:{t_86,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
42 [label="make_private:{in:[In:{t_85,},],out:[Out:{t_87,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
43 [label="GreaterEqual:{in:[Left:{t_86,},Right:{t_87,},],out:[Out:{t_88,},],attr:[],party:[alice,]}"]
44 [label="make_public:{in:[In:{t_88,},],out:[Out:{t_89,},],attr:[],party:[alice,bob,carol,]}"]
45 [label="apply_filter:{in:[Filter:{t_89,},In:{t_80,t_81,t_82,t_83,},],out:[Out:{t_90,t_91,t_92,t_93,},],attr:[],party:[alice,bob,carol,]}"]
46 [label="make_private:{in:[In:{t_90,},],out:[Out:{t_94,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
47 [label="make_private:{in:[In:{t_91,},],out:[Out:{t_96,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
48 [label="make_private:{in:[In:{t_92,},],out:[Out:{t_98,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
49 [label="make_private:{in:[In:{t_93,},],out:[Out:{t_100,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
50 [label="publish:{in:[In:{t_94,t_96,t_98,t_100,},],out:[Out:{t_95,t_97,t_99,t_101,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_1:{join_int_0:PRIVATE:INT64}"]
...
22 -> 24 [label = "t_41:{Add_out:SECRET:INT64}"]
22 -> 27 [label = "t_42:{groupby_int_0:SECRET:INT64}"]
22 -> 27 [label = "t_43:{join_int_0:SECRET:INT64}"]
22 -> 27 [label = "t_44:{aggregate_int_0:SECRET:INT64}"]
22 -> 27 [label = "t_45:{encrypt_int_0:SECRET:INT64}"]
22 -> 27 [label = "t_46:{groupby_int_0:SECRET:INT64}"]
22 -> 27 [label = "t_47:{join_int_0:SECRET:INT64}"]
22 -> 27 [label = "t_48:{aggregate_int_0:SECRET:INT64}"]
22 -> 27 [label = "t_49:{groupby_int_0:SECRET:INT64}"]
22 -> 27 [label = "t_50:{join_int_0:SECRET:INT64}"]
23 -> 25 [label = "t_51:{Add_out:PRIVATE:INT64}"]
24 -> 26 [label = "t_52:{Add_out:PRIVATE:INT64}"]
25 -> 27 [label = "t_53:{Add_out:SECRET:INT64}"]
25 -> 27 [label = "t_53:{Add_out:SECRET:INT64}"]
26 -> 27 [label = "t_54:{Add_out:SECRET:INT64}"]
26 -> 27 [label = "t_54:{Add_out:SECRET:INT64}"]
27 -> 28 [label = "t_55:{Add_out:SECRET:INT64}"]
27 -> 28 [label = "t_56:{Add_out:SECRET:INT64}"]
27 -> 30 [label = "t_55:{Add_out:SECRET:INT64}"]
27 -> 30 [label = "t_56:{Add_out:SECRET:INT64}"]
27 -> 30 [label = "t_60:{encrypt_int_0:SECRET:INT64}"]
27 -> 30 [label = "t_60:{encrypt_int_0:SECRET:INT64}"]
27 -> 34 [label = "t_59:{aggregate_int_0:SECRET:INT64}"]
27 -> 35 [label = "t_63:{aggregate_int_0:SECRET:INT64}"]
28 -> 29 [label = "t_66:{group_mark:SECRET:BOOL}"]
28 -> 29 [label = "t_66:{group_mark:SECRET:BOOL}"]
28 -> 32 [label = "t_66:{group_mark:SECRET:BOOL}"]
28 -> 33 [label = "t_66:{group_mark:SECRET:BOOL}"]
28 -> 34 [label = "t_66:{group_mark:SECRET:BOOL}"]
28 -> 35 [label = "t_66:{group_mark:SECRET:BOOL}"]
28 -> 36 [label = "t_66:{group_mark:SECRET:BOOL}"]
29 -> 36 [label = "t_67:{group_mark:SECRET:INT64}"]
3 -> 8 [label = "t_8:{groupby_int_0:PRIVATE:INT64}"]
3 -> 8 [label = "t_9:{join_int_0:PRIVATE:INT64}"]
30 -> 31 [label = "t_68:{encrypt_int_0:SECRET:INT64}"]
31 -> 32 [label = "t_69:{group_mark:SECRET:BOOL}"]
32 -> 33 [label = "t_70:{LogicalOr_out:SECRET:BOOL}"]
33 -> 36 [label = "t_71:{LogicalOr_out:SECRET:INT64}"]
34 -> 36 [label = "t_72:{aggregate_int_0:SECRET:INT64}"]
35 -> 36 [label = "t_73:{aggregate_int_0:SECRET:INT64}"]
36 -> 37 [label = "t_78:{group_mark:SECRET:BOOL}"]
36 -> 38 [label = "t_74:{group_mark:SECRET:INT64}"]
36 -> 38 [label = "t_75:{LogicalOr_out:SECRET:INT64}"]
36 -> 38 [label = "t_76:{aggregate_int_0:SECRET:INT64}"]
36 -> 38 [label = "t_77:{aggregate_int_0:SECRET:INT64}"]
37 -> 38 [label = "t_79:{group_mark:PUBLIC:BOOL}"]
38 -> 40 [label = "t_80:{group_mark:SECRET:INT64}"]
38 -> 41 [label = "t_80:{group_mark:SECRET:INT64}"]
38 -> 45 [label = "t_80:{group_mark:SECRET:INT64}"]
38 -> 45 [label = "t_81:{LogicalOr_out:SECRET:INT64}"]
38 -> 45 [label = "t_82:{aggregate_int_0:SECRET:INT64}"]
38 -> 45 [label = "t_83:{aggregate_int_0:SECRET:INT64}"]
39 -> 40 [label = "t_84:{constant_data:PUBLIC:INT64}"]
...
40 -> 42 [label = "t_85:{constant_data:PUBLIC:INT64}"]
41 -> 43 [label = "t_86:{group_mark:PRIVATE:INT64}"]
42 -> 43 [label = "t_87:{constant_data:PRIVATE:INT64}"]
43 -> 44 [label = "t_88:{GreaterEqual_out:PRIVATE:BOOL}"]
44 -> 45 [label = "t_89:{GreaterEqual_out:PUBLIC:BOOL}"]
45 -> 46 [label = "t_90:{group_mark:SECRET:INT64}"]
45 -> 47 [label = "t_91:{LogicalOr_out:SECRET:INT64}"]
45 -> 48 [label = "t_92:{aggregate_int_0:SECRET:INT64}"]
45 -> 49 [label = "t_93:{aggregate_int_0:SECRET:INT64}"]
46 -> 50 [label = "t_94:{group_mark:PRIVATE:INT64}"]
47 -> 50 [label = "t_96:{LogicalOr_out:PRIVATE:INT64}"]
48 -> 50 [label = "t_98:{aggregate_int_0:PRIVATE:INT64}"]
49 -> 50 [label = "t_100:{aggregate_int_0:PRIVATE:INT64}"]
...
33 [label="make_constant:{in:[],out:[Out:{t_73,},],attr:[scalar:4,],party:[alice,bob,carol,]}"]
...
30 [label="make_constant:{in:[],out:[Out:{t_57,},],attr:[scalar:4,],party:[alice,bob,carol,]}"]
...
16 [label="make_constant:{in:[],out:[Out:{t_23,},],attr:[scalar:0,],party:[alice,bob,carol,]}"]
...
3 [label="filter_by_index:{in:[Data:{t_0,},RowsIndexFilter:{t_2,},],out:[Out:{t_4,},],attr:[],party:[alice,]}"]
4 [label="filter_by_index:{in:[Data:{t_1,},RowsIndexFilter:{t_3,},],out:[Out:{t_5,},],attr:[],party:[bob,]}"]
5 [label="dump_file:{in:[In:{t_4,},],out:[Out:{t_6,},],attr:[field_deliminator:,,file_path:/tmp/output_alice.txt,line_terminator:
,quoting_style:0,],party:[alice,]}"]
6 [label="copy:{in:[In:{t_4,},],out:[Out:{t_7,},],attr:[input_party_codes:alice,output_party_codes:bob,],party:[alice,bob,]}"]
7 [label="dump_file:{in:[In:{t_7,},],out:[Out:{t_8,},],attr:[field_deliminator:,,file_path:/tmp/output_bob.txt,line_terminator:
,quoting_style:0,],party:[bob,]}"]
0 -> 2 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{join_int_0:PRIVATE:INT64}"]
...
6 -> 7 [label = "t_7:{join_int_0:PRIVATE:INT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false}},
...
8 [label="make_constant:{in:[],out:[Out:{t_13,},],attr:[scalar:0,],party:[alice,bob,carol,]}"]
...
10 [label="Greater:{in:[Left:{t_12,},Right:{t_14,},],out:[Out:{t_15,},],attr:[],party:[alice,bob,carol,]}"]
11 [label="make_private:{in:[In:{t_15,},],out:[Out:{t_16,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
12 [label="dump_file:{in:[In:{t_16,},],out:[Out:{t_17,},],attr:[field_deliminator:,,file_path:/tmp/output_alice.txt,line_terminator:
,quoting_style:0,],party:[alice,]}"]
13 [label="make_private:{in:[In:{t_15,},],out:[Out:{t_18,},],attr:[reveal_to:bob,],party:[alice,bob,carol,]}"]
14 [label="dump_file:{in:[In:{t_18,},],out:[Out:{t_19,},],attr:[field_deliminator:,,file_path:/tmp/output_bob.txt,line_terminator:
,quoting_style:0,],party:[bob,]}"]
0 -> 2 [label = "t_1:{join_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_0:{compare_int_0:PRIVATE:INT64}"]
0 -> 3 [label = "t_1:{join_int_0:PRIVATE:INT64}"]
...
1 -> 4 [label = "t_3:{join_int_0:PRIVATE:INT64}"]
10 -> 11 [label = "t_15:{Greater_out:SECRET:BOOL}"]
10 -> 13 [label = "t_15:{Greater_out:SECRET:BOOL}"]
11 -> 12 [label = "t_16:{Greater_out:PRIVATE:BOOL}"]
13 -> 14 [label = "t_18:{Greater_out:PRIVATE:BOOL}"]
2 -> 3 [label = "t_4:{join_int_0:PRIVATE:INT64}"]
2 -> 4 [label = "t_5:{join_int_0:PRIVATE:INT64}"]
...
11 [label="make_constant:{in:[],out:[Out:{t_13,},],attr:[scalar:4,],party:[alice,bob,carol,]}"]
...
14 [label="make_constant:{in:[],out:[Out:{t_22,},],attr:[scalar:4,],party:[alice,bob,carol,]}"]
...
3 [label="filter_by_index:{in:[Data:{t_0,},RowsIndexFilter:{t_2,},],out:[Out:{t_4,},],attr:[],party:[alice,]}"]
4 [label="filter_by_index:{in:[Data:{t_1,},RowsIndexFilter:{t_3,},],out:[Out:{t_5,},],attr:[],party:[bob,]}"]
5 [label="make_constant:{in:[],out:[Out:{t_6,},],attr:[scalar:1,],party:[alice,bob,carol,]}"]
...
8 [label="make_constant:{in:[],out:[Out:{t_9,},],attr:[scalar:2,],party:[alice,bob,carol,]}"]
...
11 [label="make_constant:{in:[],out:[Out:{t_12,},],attr:[scalar:3,],party:[alice,bob,carol,]}"]
...
11 [label="make_constant:{in:[],out:[Out:{t_16,},],attr:[scalar:0,],party:[alice,bob,carol,]}"]
...
15 [label="make_constant:{in:[],out:[Out:{t_30,},],attr:[scalar:4,],party:[alice,bob,carol,]}"]
...
19 [label="make_constant:{in:[],out:[Out:{t_35,},],attr:[scalar:1,],party:[alice,bob,carol,]}"]
20 [label="make_constant:{in:[],out:[Out:{t_36,},],attr:[scalar:0,],party:[alice,bob,carol,]}"]
...
10 [label="filter_by_index:{in:[Data:{t_12,t_13,t_14,},RowsIndexFilter:{t_16,},],out:[Out:{t_23,t_24,t_25,},],attr:[],party:[carol,]}"]
11 [label="make_constant:{in:[],out:[Out:{t_26,},],attr:[scalar:0,],party:[alice,bob,carol,]}"]
...
14 [label="make_constant:{in:[],out:[Out:{t_29,},],attr:[scalar:0,],party:[alice,bob,carol,]}"]
