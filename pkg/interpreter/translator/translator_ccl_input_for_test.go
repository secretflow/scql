...
10 [label="percentile_disc:{in:[Group:{t_18,},In:{t_15,},],out:[Out:{t_19,},],attr:[percent:0.5,],party:[alice,bob,carol,]}"]
11 [label="count:{in:[Group:{t_18,},In:{t_18,},],out:[Out:{t_20,},],attr:[],party:[alice,bob,carol,]}"]
12 [label="shuffle:{in:[In:{t_19,t_16,t_17,t_20,t_18,},],out:[Out:{t_21,t_22,t_23,t_24,t_25,},],attr:[],party:[alice,bob,carol,]}"]
13 [label="make_public:{in:[In:{t_25,},],out:[Out:{t_26,},],attr:[],party:[alice,bob,carol,]}"]
14 [label="filter:{in:[Filter:{t_26,},In:{t_21,t_22,t_23,t_24,},],out:[Out:{t_27,t_28,t_29,t_30,},],attr:[],party:[alice,bob,carol,]}"]
15 [label="make_constant:{in:[],out:[Out:{t_31,},],attr:[scalar:4,],party:[alice,bob,carol,]}"]
16 [label="broadcast:{in:[In:{t_31,},ShapeRefTensor:{t_30,},],out:[Out:{t_32,},],attr:[],party:[alice,bob,carol,]}"]
17 [label="make_private:{in:[In:{t_30,},],out:[Out:{t_33,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
18 [label="make_private:{in:[In:{t_32,},],out:[Out:{t_34,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
19 [label="GreaterEqual:{in:[Left:{t_33,},Right:{t_34,},],out:[Out:{t_35,},],attr:[],party:[alice,]}"]
20 [label="make_public:{in:[In:{t_35,},],out:[Out:{t_36,},],attr:[],party:[alice,bob,carol,]}"]
21 [label="apply_filter:{in:[Filter:{t_36,},In:{t_28,t_29,t_27,t_30,},],out:[Out:{t_37,t_38,t_39,t_40,},],attr:[],party:[alice,bob,carol,]}"]
22 [label="make_private:{in:[In:{t_37,},],out:[Out:{t_41,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
23 [label="make_private:{in:[In:{t_38,},],out:[Out:{t_43,},],attr:[reveal_to:bob,],party:[alice,bob,carol,]}"]
24 [label="copy:{in:[In:{t_43,},],out:[Out:{t_44,},],attr:[input_party_codes:bob,output_party_codes:alice,],party:[bob,alice,]}"]
25 [label="make_private:{in:[In:{t_39,},],out:[Out:{t_46,},],attr:[reveal_to:alice,],party:[alice,bob,carol,]}"]
26 [label="publish:{in:[In:{t_41,t_44,t_46,},],out:[Out:{t_42,t_45,t_47,},],attr:[],party:[alice,]}"]
...
10 -> 12 [label = "t_19:{aggregate_int_0:SECRET:INT64}"]
11 -> 12 [label = "t_20:{group_mark:SECRET:INT64}"]
12 -> 13 [label = "t_25:{group_mark:SECRET:BOOL}"]
12 -> 14 [label = "t_21:{aggregate_int_0:SECRET:INT64}"]
12 -> 14 [label = "t_22:{groupby_string_0:SECRET:STRING}"]
12 -> 14 [label = "t_23:{groupby_string_0:SECRET:STRING}"]
12 -> 14 [label = "t_24:{group_mark:SECRET:INT64}"]
13 -> 14 [label = "t_26:{group_mark:PUBLIC:BOOL}"]
14 -> 16 [label = "t_30:{group_mark:SECRET:INT64}"]
14 -> 17 [label = "t_30:{group_mark:SECRET:INT64}"]
14 -> 21 [label = "t_27:{aggregate_int_0:SECRET:INT64}"]
14 -> 21 [label = "t_28:{groupby_string_0:SECRET:STRING}"]
14 -> 21 [label = "t_29:{groupby_string_0:SECRET:STRING}"]
14 -> 21 [label = "t_30:{group_mark:SECRET:INT64}"]
15 -> 16 [label = "t_31:{constant_data:PUBLIC:INT64}"]
16 -> 18 [label = "t_32:{constant_data:PUBLIC:INT64}"]
17 -> 19 [label = "t_33:{group_mark:PRIVATE:INT64}"]
18 -> 19 [label = "t_34:{constant_data:PRIVATE:INT64}"]
19 -> 20 [label = "t_35:{GreaterEqual_out:PRIVATE:BOOL}"]
2 -> 3 [label = "t_5:{join_int_0:PRIVATE:INT64}"]
2 -> 4 [label = "t_6:{join_int_0:PRIVATE:INT64}"]
20 -> 21 [label = "t_36:{GreaterEqual_out:PUBLIC:BOOL}"]
21 -> 22 [label = "t_37:{groupby_string_0:SECRET:STRING}"]
21 -> 23 [label = "t_38:{groupby_string_0:SECRET:STRING}"]
21 -> 25 [label = "t_39:{aggregate_int_0:SECRET:INT64}"]
22 -> 26 [label = "t_41:{groupby_string_0:PRIVATE:STRING}"]
23 -> 24 [label = "t_43:{groupby_string_0:PRIVATE:STRING}"]
24 -> 26 [label = "t_44:{groupby_string_0:PRIVATE:STRING}"]
25 -> 26 [label = "t_46:{aggregate_int_0:PRIVATE:INT64}"]
...
8 -> 12 [label = "t_16:{groupby_string_0:SECRET:STRING}"]
8 -> 12 [label = "t_17:{groupby_string_0:SECRET:STRING}"]
8 -> 9 [label = "t_13:{groupby_string_0:SECRET:STRING}"]
8 -> 9 [label = "t_14:{groupby_string_0:SECRET:STRING}"]
9 -> 10 [label = "t_18:{group_mark:SECRET:BOOL}"]
