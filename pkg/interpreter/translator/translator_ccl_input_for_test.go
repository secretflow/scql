...
8 [label="sort:{in:[In:{t_10,t_11,t_12,t_10,t_11,t_12,},Key:{t_10,t_11,t_12,},],out:[Out:{t_13,t_14,t_15,t_16,t_17,t_18,},],attr:[reverse:false,],party:[alice,bob,carol,]}"]
...
11 [label="sort:{in:[In:{t_16,t_17,t_18,t_16,t_20,},Key:{t_16,t_17,t_18,},],out:[Out:{t_21,t_22,t_23,t_24,t_25,},],attr:[reverse:false,],party:[alice,bob,carol,]}"]
...
7 [label="sort:{in:[In:{t_8,t_9,},Key:{t_8,t_9,},],out:[Out:{t_10,t_11,},],attr:[reverse:false,],party:[alice,bob,carol,]}"]
...
8 [label="sort:{in:[In:{t_9,t_10,t_11,},Key:{t_9,t_10,},],out:[Out:{t_12,t_13,t_14,},],attr:[reverse:false,],party:[alice,bob,carol,]}"]
...
0 [label="runsql:{in:[],out:[Out:{t_0,},],attr:[sql:select t1.plain_int_0 from alice.tbl_1 as t1;,table_refs:[alice.tbl_1],],party:[alice,]}"]
1 [label="runsql:{in:[],out:[Out:{t_1,t_2,},],attr:[sql:select t2.plain_int_0,t2.add_res from (select t2.plain_int_0,t2.add_res,t3.plain_int_0 from ((select tbl_0.plain_int_0,tbl_0.plain_int_0+1 as add_res from bob.tbl_0) as t2 join bob.tbl_1 as t3 on t2.plain_int_0=t3.plain_int_0)) as t2 join bob.tbl_2 as t4 on t2.plain_int_0=t4.plain_int_0;,table_refs:[bob.tbl_0 bob.tbl_1 bob.tbl_2],],party:[bob,]}"]
2 [label="join:{in:[Left:{t_0,},Right:{t_1,},],out:[LeftJoinIndex:{},RightJoinIndex:{t_3,},],attr:[input_party_codes:[alice bob],join_type:0,psi_algorithm:0,],party:[alice,bob,]}"]
3 [label="filter_by_index:{in:[Data:{t_2,},RowsIndexFilter:{t_3,},],out:[Out:{t_4,},],attr:[],party:[bob,]}"]
4 [label="shape:{in:[In:{t_4,},],out:[Out:{t_5,},],attr:[axis:0,],party:[bob,]}"]
5 [label="reduce_sum:{in:[In:{t_4,},],out:[Out:{t_6,},],attr:[],party:[bob,]}"]
6 [label="copy:{in:[In:{t_5,},],out:[Out:{t_7,},],attr:[input_party_codes:bob,output_party_codes:alice,],party:[bob,alice,]}"]
7 [label="copy:{in:[In:{t_6,},],out:[Out:{t_9,},],attr:[input_party_codes:bob,output_party_codes:alice,],party:[bob,alice,]}"]
8 [label="publish:{in:[In:{t_7,t_9,},],out:[Out:{t_8,t_10,},],attr:[],party:[alice,]}"]
0 -> 2 [label = "t_0:{plain_int_0:PRIVATE:INT64}"]
1 -> 2 [label = "t_1:{plain_int_0:PRIVATE:INT64}"]
1 -> 3 [label = "t_2:{Column#241:PRIVATE:INT64}"]
2 -> 3 [label = "t_3:{plain_int_0:PRIVATE:INT64}"]
3 -> 4 [label = "t_4:{Column#241:PRIVATE:INT64}"]
3 -> 5 [label = "t_4:{Column#241:PRIVATE:INT64}"]
4 -> 6 [label = "t_5:{Column#241:PRIVATE:INT64}"]
5 -> 7 [label = "t_6:{Column#241:PRIVATE:INT64}"]
6 -> 8 [label = "t_7:{Column#241:PRIVATE:INT64}"]
7 -> 8 [label = "t_9:{Column#241:PRIVATE:INT64}"]
}`, ``, testConf{groupThreshold: 0, batched: false, revealGroupCount: false}},
}
