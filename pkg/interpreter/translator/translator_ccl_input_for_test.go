...
6 [label="str_to_date:{in:[Left:{t_8,},Right:{t_9,},],out:[Out:{t_10,},],attr:[],party:[bob,]}"]
...
5 -> 6 [label = "t_9:{constant_data:PUBLIC:STRING}"]
...
6 [label="make_constant:{in:[],out:[Out:{t_9,},],attr:[scalar:1749081600000,],party:[alice,bob,carol,]}"]
