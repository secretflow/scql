...
0 [label="runsql:{in:[],out:[Out:{t_0,t_1,},],attr:[sql:select any_value(1) as expr_112,any_value(ta.aggregate_long_0) as expr_109 from alice.tbl_0 as ta group by ta.aggregate_long_0,table_refs:[alice.tbl_0],],party:[alice,]}"]
1 [label="runsql:{in:[],out:[Out:{t_2,t_3,},],attr:[sql:select any_value(1) as expr_112,any_value(tbl_0.aggregate_long_0) as expr_109 from bob.tbl_0 group by tbl_0.aggregate_long_0,table_refs:[bob.tbl_0],],party:[bob,]}"]
...
0 -> 2 [label = "t_0:{Column#112:PRIVATE:BOOL}"]
0 -> 5 [label = "t_1:{Column#109:PRIVATE:INT64}"]
1 -> 3 [label = "t_2:{Column#112:PRIVATE:BOOL}"]
1 -> 6 [label = "t_3:{Column#109:PRIVATE:INT64}"]
10 -> 11 [label = "t_15:{group_mark:SECRET:BOOL}"]
10 -> 12 [label = "t_14:{Column#112:SECRET:BOOL}"]
11 -> 12 [label = "t_16:{group_mark:PUBLIC:BOOL}"]
12 -> 13 [label = "t_17:{Column#112:SECRET:BOOL}"]
13 -> 14 [label = "t_18:{Column#112:PRIVATE:INT64}"]
2 -> 4 [label = "t_4:{Column#112:SECRET:BOOL}"]
3 -> 4 [label = "t_5:{Column#112:SECRET:BOOL}"]
4 -> 8 [label = "t_6:{Column#112:SECRET:BOOL}"]
5 -> 7 [label = "t_7:{Column#109:SECRET:INT64}"]
6 -> 7 [label = "t_8:{Column#109:SECRET:INT64}"]
7 -> 8 [label = "t_9:{Column#109:SECRET:INT64}"]
7 -> 8 [label = "t_9:{Column#109:SECRET:INT64}"]
7 -> 8 [label = "t_9:{Column#109:SECRET:INT64}"]
8 -> 10 [label = "t_11:{Column#112:SECRET:BOOL}"]
8 -> 9 [label = "t_10:{Column#109:SECRET:INT64}"]
...
0 [label="runsql:{in:[],out:[Out:{t_0,t_1,},],attr:[sql:select any_value(1) as expr_166,any_value(ta.groupby_string_0) as expr_163 from alice.tbl_0 as ta group by ta.groupby_string_0,table_refs:[alice.tbl_0],],party:[alice,]}"]
1 [label="runsql:{in:[],out:[Out:{t_2,t_3,},],attr:[sql:select any_value(1) as expr_166,any_value(tb.groupby_string_0) as expr_163 from bob.tbl_0 as tb group by tb.groupby_string_0,table_refs:[bob.tbl_0],],party:[bob,]}"]
2 [label="runsql:{in:[],out:[Out:{t_4,t_5,},],attr:[sql:select any_value(1) as expr_166,any_value(tc.groupby_string_0) as expr_163 from carol.tbl_0 as tc group by tc.groupby_string_0,table_refs:[carol.tbl_0],],party:[carol,]}"]
...
0 [label="runsql:{in:[],out:[Out:{t_0,},],attr:[sql:select any_value(tbl_1.plain_float_0) as expr_46 from alice.tbl_1 join alice.tbl_2 on tbl_1.plain_long_0=tbl_2.plain_long_0 group by tbl_1.plain_float_0 having count(1)>=4,table_refs:[alice.tbl_1 alice.tbl_2],],party:[alice,]}"]
1 [label="publish:{in:[In:{t_0,},],out:[Out:{t_1,},],attr:[],party:[alice,]}"]
...
0 [label="runsql:{in:[],out:[Out:{t_0,},],attr:[sql:select any_value(ta.groupby_long_0) as expr_110 from alice.tbl_0 as ta group by ta.groupby_long_0,table_refs:[alice.tbl_0],],party:[alice,]}"]
1 [label="runsql:{in:[],out:[Out:{t_1,},],attr:[sql:select any_value(tb.groupby_long_0) as expr_110 from bob.tbl_0 as tb group by tb.groupby_long_0,table_refs:[bob.tbl_0],],party:[bob,]}"]
...
0 [label="runsql:{in:[],out:[Out:{t_0,t_1,},],attr:[sql:select count(1) as expr_167,max(tbl_0.aggregate_long_0) as expr_168 from alice.tbl_0,table_refs:[alice.tbl_0],],party:[alice,]}"]
1 [label="runsql:{in:[],out:[Out:{t_2,t_3,},],attr:[sql:select count(1) as expr_167,max(tbl_1.aggregate_long_0) as expr_168 from bob.tbl_1,table_refs:[bob.tbl_1],],party:[bob,]}"]
2 [label="runsql:{in:[],out:[Out:{t_4,t_5,},],attr:[sql:select count(1) as expr_167,max(tbl_2.aggregate_long_0) as expr_168 from carol.tbl_2,table_refs:[carol.tbl_2],],party:[carol,]}"]
3 [label="make_share:{in:[In:{t_0,},],out:[Out:{t_6,},],attr:[],party:[alice,bob,carol,]}"]
4 [label="make_share:{in:[In:{t_2,},],out:[Out:{t_7,},],attr:[],party:[alice,bob,carol,]}"]
5 [label="make_share:{in:[In:{t_4,},],out:[Out:{t_8,},],attr:[],party:[alice,bob,carol,]}"]
6 [label="concat:{in:[In:{t_6,t_7,t_8,},],out:[Out:{t_9,},],attr:[axis:0,],party:[alice,bob,carol,]}"]
...
0 [label="runsql:{in:[],out:[Out:{t_0,t_1,t_2,},],attr:[sql:select count(1) as expr_167,max(tbl_0.aggregate_long_0) as expr_168,any_value(tbl_0.groupby_long_0) as expr_164 from alice.tbl_0 group by tbl_0.groupby_long_0,table_refs:[alice.tbl_0],],party:[alice,]}"]
1 [label="runsql:{in:[],out:[Out:{t_3,t_4,t_5,},],attr:[sql:select count(1) as expr_167,max(tbl_1.aggregate_long_0) as expr_168,any_value(tbl_1.groupby_long_0) as expr_164 from bob.tbl_1 group by tbl_1.groupby_long_0,table_refs:[bob.tbl_1],],party:[bob,]}"]
2 [label="runsql:{in:[],out:[Out:{t_6,t_7,t_8,},],attr:[sql:select count(1) as expr_167,max(tbl_2.aggregate_long_0) as expr_168,any_value(tbl_2.groupby_long_0) as expr_164 from carol.tbl_2 group by tbl_2.groupby_long_0,table_refs:[carol.tbl_2],],party:[carol,]}"]
