...
func (InviteMemberRequest_InvitationMethod) EnumDescriptor() ([]byte, []int) {
	return file_api_broker_proto_rawDescGZIP(), []int{47, 0}
}
...
func (ChangeEntry_Action) EnumDescriptor() ([]byte, []int) {
	return file_api_broker_proto_rawDescGZIP(), []int{61, 0}
}
...
func (ResourceSpec_ResourceKind) EnumDescriptor() ([]byte, []int) {
	return file_api_broker_proto_rawDescGZIP(), []int{64, 0}
}
...
func (x *ProjectDesc) GetArchived() bool {
	if x != nil {
		return x.Archived
	}
	return false
...
func (x *DeleteProjectRequest) GetComment() string {
	if x != nil {
		return x.Comment
	}
	return ""
...
func (x *ListInvitationsRequest) GetFilter() isListInvitationsRequest_Filter {
	if x != nil {
		return x.Filter
	}
	return nil
...
func (x *ListInvitationsRequest) GetStatus() InvitationStatus {
	if x != nil {
		if x, ok := x.Filter.(*ListInvitationsRequest_Status); ok {
			return x.Status
		}
	}
...
func (x *ListInvitationsRequest) GetInviter() string {
	if x != nil {
		if x, ok := x.Filter.(*ListInvitationsRequest_Inviter); ok {
			return x.Inviter
		}
	}
	return ""
...
func (x *CreateViewResponse) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
func (x *ListViewsRequest) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *ListViewsRequest) GetNames() []string {
	if x != nil {
		return x.Names
	}
	return nil
...
type ListViewsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Status        *Status                `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
	Views         []*TableMeta           `protobuf:"bytes,2,rep,name=views,proto3" json:"views,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListViewsResponse) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
func (x *ListViewsResponse) GetViews() []*TableMeta {
	if x != nil {
		return x.Views
	}
	return nil
...
func (x *DropViewRequest) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *DropViewResponse) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
type ProjectConfig struct {
	...
	LinkRecvTimeoutSec            int64                  `protobuf:"varint,5,opt,name=link_recv_timeout_sec,json=linkRecvTimeoutSec,proto3" json:"link_recv_timeout_sec,omitempty"`
	LinkThrottleWindowSize        int64                  `protobuf:"varint,6,opt,name=link_throttle_window_size,json=linkThrottleWindowSize,proto3" json:"link_throttle_window_size,omitempty"`
	LinkChunkedSendParallelSize   int64                  `protobuf:"varint,7,opt,name=link_chunked_send_parallel_size,json=linkChunkedSendParallelSize,proto3" json:"link_chunked_send_parallel_size,omitempty"`
	GroupByThreshold              *uint64                `protobuf:"varint,8,opt,name=group_by_threshold,json=groupByThreshold,proto3,oneof" json:"group_by_threshold,omitempty"`
	RevealGroupMark               *bool                  `protobuf:"varint,9,opt,name=reveal_group_mark,json=revealGroupMark,proto3,oneof" json:"reveal_group_mark,omitempty"`
	RevealGroupCount              *bool                  `protobuf:"varint,10,opt,name=reveal_group_count,json=revealGroupCount,proto3,oneof" json:"reveal_group_count,omitempty"`
	EnableSessionLoggerSeparation *bool                  `protobuf:"varint,11,opt,name=enable_session_logger_separation,json=enableSessionLoggerSeparation,proto3,oneof" json:"enable_session_logger_separation,omitempty"`
	PsiType                       PsiAlgorithmType       `protobuf:"varint,12,opt,name=psi_type,json=psiType,proto3,enum=scql.pb.PsiAlgorithmType" json:"psi_type,omitempty"`
	Rr22Mode                      Rr22Mode               `protobuf:"varint,13,opt,name=rr22_mode,json=rr22Mode,proto3,enum=scql.pb.Rr22Mode" json:"rr22_mode,omitempty"`
	Batched                       *bool                  `protobuf:"varint,14,opt,name=batched,proto3,oneof" json:"batched,omitempty"`
...
func (x *ProjectConfig) GetRevealGroupCount() bool {
	if x != nil && x.RevealGroupCount != nil {
		return *x.RevealGroupCount
	}
	return false
}

func (x *ProjectConfig) GetEnableSessionLoggerSeparation() bool {
	if x != nil && x.EnableSessionLoggerSeparation != nil {
		return *x.EnableSessionLoggerSeparation
	}
	return false
}

func (x *ProjectConfig) GetPsiType() PsiAlgorithmType {
	if x != nil {
		return x.PsiType
	}
...
func (x *ProjectConfig) GetRr22Mode() Rr22Mode {
	if x != nil {
		return x.Rr22Mode
	}
...
func (x *ProjectConfig) GetBatched() bool {
	if x != nil && x.Batched != nil {
		return *x.Batched
	}
	return false
}

func (x *ProjectConfig) GetTimeZone() string {
	if x != nil {
		return x.TimeZone
	}
	return ""
...
type JobConfig struct {
	...
	LinkThrottleWindowSize        int64                  `protobuf:"varint,6,opt,name=link_throttle_window_size,json=linkThrottleWindowSize,proto3" json:"link_throttle_window_size,omitempty"`
	LinkChunkedSendParallelSize   int64                  `protobuf:"varint,7,opt,name=link_chunked_send_parallel_size,json=linkChunkedSendParallelSize,proto3" json:"link_chunked_send_parallel_size,omitempty"`
	EnableSessionLoggerSeparation *bool                  `protobuf:"varint,8,opt,name=enable_session_logger_separation,json=enableSessionLoggerSeparation,proto3,oneof" json:"enable_session_logger_separation,omitempty"`
	PsiType                       PsiAlgorithmType       `protobuf:"varint,9,opt,name=psi_type,json=psiType,proto3,enum=scql.pb.PsiAlgorithmType" json:"psi_type,omitempty"`
	Rr22Mode                      Rr22Mode               `protobuf:"varint,10,opt,name=rr22_mode,json=rr22Mode,proto3,enum=scql.pb.Rr22Mode" json:"rr22_mode,omitempty"`
	Batched                       *bool                  `protobuf:"varint,11,opt,name=batched,proto3,oneof" json:"batched,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *JobConfig) GetPsiType() PsiAlgorithmType {
	if x != nil {
		return x.PsiType
	}
	return PsiAlgorithmType_AUTO
...
func (x *JobConfig) GetRr22Mode() Rr22Mode {
	if x != nil {
		return x.Rr22Mode
	}
	return Rr22Mode_UNDEFINED
...
func (x *JobConfig) GetBatched() bool {
	if x != nil && x.Batched != nil {
		return *x.Batched
	}
	return false
...
type CheckAndUpdateStatusResponse struct {
	state         protoimpl.MessageState      `protogen:"open.v1"`
	Status        *Status                     `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
	Conflicts     map[string]*ProjectConflict `protobuf:"bytes,2,rep,name=conflicts,proto3" json:"conflicts,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DistributeQueryRequest) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (*Checksum) Descriptor() ([]byte, []int) {
	return file_api_broker_proto_rawDescGZIP(), []int{66}
}
...
func (x *ExchangeJobInfoRequest) Reset() {
	*x = ExchangeJobInfoRequest{}
	mi := &file_api_broker_proto_msgTypes[67]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExchangeJobInfoRequest) Descriptor() ([]byte, []int) {
	return file_api_broker_proto_rawDescGZIP(), []int{67}
}
...
func (*ExchangeJobInfoResponse) Descriptor() ([]byte, []int) {
	return file_api_broker_proto_rawDescGZIP(), []int{68}
}
...
type TableMeta struct {
	...
	SelectString  string                 `protobuf:"bytes,6,opt,name=select_string,json=selectString,proto3" json:"select_string,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (*TableMeta) Descriptor() ([]byte, []int) {
	return file_api_broker_proto_rawDescGZIP(), []int{69}
}
...
func (x *TableMeta) GetSelectString() string {
	if x != nil {
...
func (x *PrivacyPolicy) Reset() {
	*x = PrivacyPolicy{}
	mi := &file_api_broker_proto_msgTypes[70]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PrivacyPolicy) Descriptor() ([]byte, []int) {
	return file_api_broker_proto_rawDescGZIP(), []int{70}
}
...
func (x *ColumnControl) Reset() {
	*x = ColumnControl{}
	mi := &file_api_broker_proto_msgTypes[71]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ColumnControl) Descriptor() ([]byte, []int) {
	return file_api_broker_proto_rawDescGZIP(), []int{71}
}
...
func (x *ColumnDef) Reset() {
	*x = ColumnDef{}
	mi := &file_api_broker_proto_msgTypes[72]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ColumnDef) Descriptor() ([]byte, []int) {
	return file_api_broker_proto_rawDescGZIP(), []int{72}
}
...
func (x *CreateTableRequest_ColumnDesc) Reset() {
	*x = CreateTableRequest_ColumnDesc{}
	mi := &file_api_broker_proto_msgTypes[73]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateTableRequest_ColumnDesc) Descriptor() ([]byte, []int) {
	return file_api_broker_proto_rawDescGZIP(), []int{27, 0}
}
...
func (x *ProjectConflict_ConflictItem) Reset() {
	*x = ProjectConflict_ConflictItem{}
	mi := &file_api_broker_proto_msgTypes[75]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProjectConflict_ConflictItem) Descriptor() ([]byte, []int) {
	return file_api_broker_proto_rawDescGZIP(), []int{51, 0}
}
...
func (x *TableMeta_Column) Reset() {
	*x = TableMeta_Column{}
	mi := &file_api_broker_proto_msgTypes[76]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TableMeta_Column) Descriptor() ([]byte, []int) {
	return file_api_broker_proto_rawDescGZIP(), []int{69, 0}
}
...
var file_api_broker_proto_rawDesc = []byte{
	...
	0x70, 0x75, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x96, 0x02, 0x0a, 0x0c, 0x51, 0x75, 0x65,
	...
	0x09, 0x6a, 0x6f, 0x62, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x15, 0x0a, 0x06, 0x6a, 0x6f,
	0x62, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6a, 0x6f, 0x62, 0x49,
	0x64, 0x22, 0x66, 0x0a, 0x0d, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x2c, 0x0a, 0x06, 0x72,
	0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x73, 0x63,
	0x71, 0x6c, 0x2e, 0x70, 0x62, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x73, 0x75, 0x6c,
	0x74, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x50, 0x0a, 0x0e, 0x53, 0x75, 0x62,
	0x6d, 0x69, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x27, 0x0a, 0x06, 0x73,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6a, 0x6f, 0x62, 0x49, 0x64, 0x22, 0x30, 0x0a, 0x12, 0x46,
	0x65, 0x74, 0x63, 0x68, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x1a, 0x0a, 0x06, 0x6a, 0x6f, 0x62, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x42, 0x03, 0xe0, 0x41, 0x02, 0x52, 0x05, 0x6a, 0x6f, 0x62, 0x49, 0x64, 0x22, 0xb6, 0x01,
	0x0a, 0x0b, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x23, 0x0a,
	...
	,
	...
	0x14, 0x2e, 0x73, 0x63, 0x71, 0x6c, 0x2e, 0x70, 0x62, 0x2e, 0x4a, 0x6f, 0x62, 0x50, 0x72, 0x6f,
	0x67, 0x72, 0x65, 0x73, 0x73, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x22,
	0x9f, 0x01, 0x0a, 0x13, 0x46, 0x65, 0x74, 0x63, 0x68, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x52,
	...
	0x32, 0x14, 0x2e, 0x73, 0x63, 0x71, 0x6c, 0x2e, 0x70, 0x62, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79,
	...
	0x28, 0x0b, 0x32, 0x12, 0x2e, 0x73, 0x63, 0x71, 0x6c, 0x2e, 0x70, 0x62, 0x2e, 0x4a, 0x6f, 0x62,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x09, 0x6a, 0x6f, 0x62, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x22, 0x87, 0x01, 0x0a, 0x13, 0x45, 0x78, 0x70, 0x6c, 0x61, 0x69, 0x6e, 0x51, 0x75, 0x65,
	...
	0x02, 0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x12, 0x31, 0x0a, 0x0a, 0x6a, 0x6f, 0x62, 0x5f,
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x73,
	0x63, 0x71, 0x6c, 0x2e, 0x70, 0x62, 0x2e, 0x4a, 0x6f, 0x62, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x52, 0x09, 0x6a, 0x6f, 0x62, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x6f, 0x0a, 0x14, 0x45,
	0x78, 0x70, 0x6c, 0x61, 0x69, 0x6e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x65, 0x78, 0x70, 0x6c, 0x61, 0x69, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e,
	0x73, 0x63, 0x71, 0x6c, 0x2e, 0x70, 0x62, 0x2e, 0x45, 0x78, 0x70, 0x6c, 0x61, 0x69, 0x6e, 0x49,
	0x6e, 0x66, 0x6f, 0x52, 0x07, 0x65, 0x78, 0x70, 0x6c, 0x61, 0x69, 0x6e, 0x22, 0x30, 0x0a, 0x12,
	0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x1a, 0x0a, 0x06, 0x6a, 0x6f, 0x62, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x42, 0x03, 0xe0, 0x41, 0x02, 0x52, 0x05, 0x6a, 0x6f, 0x62, 0x49, 0x64, 0x22, 0x3e,
	...
	0x63, 0x6f, 0x6e, 0x66, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x73, 0x63, 0x71,
	0x6c, 0x2e, 0x70, 0x62, 0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x42, 0x03, 0xe0, 0x41, 0x02, 0x52, 0x04, 0x63, 0x6f, 0x6e, 0x66, 0x22, 0x5f, 0x0a,
	...
	0x65, 0x63, 0x74, 0x49, 0x64, 0x12, 0x2a, 0x0a, 0x04, 0x63, 0x6f, 0x6e, 0x66, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x73, 0x63, 0x71, 0x6c, 0x2e, 0x70, 0x62, 0x2e, 0x50, 0x72,
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x04, 0x63, 0x6f, 0x6e,
	0x66, 0x22, 0x40, 0x0a, 0x15, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x6a, 0x65,
	0x63, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x27, 0x0a, 0x06, 0x73, 0x74,
	...
	0x74, 0x75, 0x73, 0x22, 0x27, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65,
	0x63, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x64,
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0x71, 0x0a, 0x14,
	...
	0x14, 0x2e, 0x73, 0x63, 0x71, 0x6c, 0x2e, 0x70, 0x62, 0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	0x74, 0x44, 0x65, 0x73, 0x63, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x22,
	0x99, 0x02, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x44, 0x65, 0x73, 0x63, 0x12,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2a, 0x0a, 0x04, 0x63, 0x6f, 0x6e, 0x66, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x16, 0x2e, 0x73, 0x63, 0x71, 0x6c, 0x2e, 0x70, 0x62, 0x2e, 0x50, 0x72, 0x6f,
	0x6a, 0x65, 0x63, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x04, 0x63, 0x6f, 0x6e, 0x66,
	0x12, 0x18, 0x0a, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65,
	...
	0x08, 0x52, 0x08, 0x61, 0x72, 0x63, 0x68, 0x69, 0x76, 0x65, 0x64, 0x22, 0x50, 0x0a, 0x15, 0x41,
	...
	0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x73, 0x63, 0x71, 0x6c, 0x2e, 0x70,
	0x62, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x22, 0x4f, 0x0a, 0x14, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	...
	,
	...
	0x75, 0x73, 0x12, 0x1a, 0x0a, 0x07, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x72, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x07, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x72, 0x42, 0x08,
	0x0a, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x22, 0x80, 0x01, 0x0a, 0x17, 0x4c, 0x69, 0x73,
	...
	,
	...
	0x28, 0x09, 0x52, 0x07, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x70,
	0x6f, 0x73, 0x74, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0a, 0x70, 0x6f, 0x73, 0x74, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x12, 0x31, 0x0a, 0x06, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x73, 0x63,
	0x71, 0x6c, 0x2e, 0x70, 0x62, 0x2e, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x96,
	0x02, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x52, 0x65,
	...
	,
	...
	,
	...
	0x65, 0x63, 0x74, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x18, 0x02,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x22, 0x69, 0x0a, 0x12, 0x4c,
	...
	,
	...
	0x75, 0x73, 0x12, 0x28, 0x0a, 0x05, 0x76, 0x69, 0x65, 0x77, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x12, 0x2e, 0x73, 0x63, 0x71, 0x6c, 0x2e, 0x70, 0x62, 0x2e, 0x54, 0x61, 0x62, 0x6c,
	0x65, 0x4d, 0x65, 0x74, 0x61, 0x52, 0x05, 0x76, 0x69, 0x65, 0x77, 0x73, 0x22, 0x5a, 0x0a, 0x10,
	...
	0x63, 0x74, 0x49, 0x64, 0x12, 0x22, 0x0a, 0x0a, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x6e, 0x61,
	0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x03, 0xe0, 0x41, 0x02, 0x52, 0x09, 0x74,
	0x61, 0x62, 0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x3c, 0x0a, 0x11, 0x44, 0x72, 0x6f, 0x70,
	...
	,
	...
	0x4c, 0x69, 0x73, 0x74, 0x22, 0x3c, 0x0a, 0x11, 0x52, 0x65, 0x76, 0x6f, 0x6b, 0x65, 0x43, 0x43,
	0x4c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x27, 0x0a, 0x06, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x73, 0x63, 0x71, 0x6c,
	0x2e, 0x70, 0x62, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x22, 0x6f, 0x0a, 0x0e, 0x53, 0x68, 0x6f, 0x77, 0x43, 0x43, 0x4c, 0x52, 0x65, 0x71,
	...
	,
	...
	,
	...
	,
	...
	0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x07, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x65,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x03, 0xe0, 0x41, 0x02, 0x52, 0x07, 0x69, 0x6e,
	...
	,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x27, 0x0a, 0x0f, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e,
	0x69, 0x6e, 0x76, 0x69, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x3e,
	0x0a, 0x1b, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x41, 0x6e, 0x64, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x28, 0x09, 0x52, 0x0a, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x73, 0x22, 0xf3,
	0x01, 0x0a, 0x1c, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x41, 0x6e, 0x64, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	,
	...
	,
	...
	0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x52, 0x65,
	0x73, 0x75, 0x6c, 0x74, 0x12, 0x54, 0x0a, 0x16, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x63,
	0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x05,
	...
	0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x73,
	...
	0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x22, 0x93, 0x01, 0x0a, 0x15, 0x43, 0x61, 0x6e, 0x63,
	0x65, 0x6c, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4a, 0x6f, 0x62, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	,
	...
	0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x6a, 0x65,
	0x63, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x72, 0x6f,
	0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x12, 0x27, 0x0a, 0x0f, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x61,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x4c, 0x5f, 0x52, 0x41, 0x4e, 0x4b, 0x10, 0x08, 0x32, 0x89, 0x13, 0x0a, 0x12, 0x49, 0x6e, 0x74,
	...
	0x11, 0x3a, 0x01, 0x2a, 0x22, 0x0c, 0x2f, 0x69, 0x6e, 0x74, 0x72, 0x61, 0x2f, 0x71, 0x75, 0x65,
	0x72, 0x79, 0x12, 0x5d, 0x0a, 0x0b, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x51, 0x75, 0x65, 0x72,
	...
	0x65, 0x22, 0x1e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x18, 0x3a, 0x01, 0x2a, 0x22, 0x13, 0x2f, 0x69,
	0x6e, 0x74, 0x72, 0x61, 0x2f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x2f, 0x73, 0x75, 0x62, 0x6d, 0x69,
	0x74, 0x12, 0x67, 0x0a, 0x0b, 0x46, 0x65, 0x74, 0x63, 0x68, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74,
	...
	0x93, 0x02, 0x17, 0x3a, 0x01, 0x2a, 0x22, 0x12, 0x2f, 0x69, 0x6e, 0x74, 0x72, 0x61, 0x2f, 0x71,
	0x75, 0x65, 0x72, 0x79, 0x2f, 0x66, 0x65, 0x74, 0x63, 0x68, 0x12, 0x6c, 0x0a, 0x0c, 0x45, 0x78,
	...
	0x01, 0x2a, 0x22, 0x14, 0x2f, 0x69, 0x6e, 0x74, 0x72, 0x61, 0x2f, 0x71, 0x75, 0x65, 0x72, 0x79,
	0x2f, 0x65, 0x78, 0x70, 0x6c, 0x61, 0x69, 0x6e, 0x12, 0x68, 0x0a, 0x0b, 0x43, 0x61, 0x6e, 0x63,
	...
	0x69, 0x6e, 0x74, 0x72, 0x61, 0x2f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x2f, 0x63, 0x61, 0x6e, 0x63,
	0x65, 0x6c, 0x12, 0x70, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x6a,
	...
	0x69, 0x6e, 0x74, 0x72, 0x61, 0x2f, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2f, 0x63, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x12, 0x4e, 0x0a, 0x0d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x72,
	...
	0x65, 0x22, 0x1e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x18, 0x3a, 0x01, 0x2a, 0x22, 0x13, 0x2f, 0x69,
	0x6e, 0x74, 0x72, 0x61, 0x2f, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2f, 0x6c, 0x69, 0x73,
	0x74, 0x12, 0x74, 0x0a, 0x0e, 0x41, 0x72, 0x63, 0x68, 0x69, 0x76, 0x65, 0x50, 0x72, 0x6f, 0x6a,
	...
	0x16, 0x2f, 0x69, 0x6e, 0x74, 0x72, 0x61, 0x2f, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2f,
	0x61, 0x72, 0x63, 0x68, 0x69, 0x76, 0x65, 0x12, 0x70, 0x0a, 0x0d, 0x44, 0x65, 0x6c, 0x65, 0x74,
	0x65, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x1d, 0x2e, 0x73, 0x63, 0x71, 0x6c, 0x2e,
	0x70, 0x62, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e, 0x2e, 0x73, 0x63, 0x71, 0x6c, 0x2e, 0x70,
	...
	,
	...
	0x11, 0x2f, 0x69, 0x6e, 0x74, 0x72, 0x61, 0x2f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x2f, 0x6c, 0x69,
	0x73, 0x74, 0x12, 0x60, 0x0a, 0x09, 0x44, 0x72, 0x6f, 0x70, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x12,
	0x19, 0x2e, 0x73, 0x63, 0x71, 0x6c, 0x2e, 0x70, 0x62, 0x2e, 0x44, 0x72, 0x6f, 0x70, 0x54, 0x61,
	0x62, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1a, 0x2e, 0x73, 0x63, 0x71,
	...
	,
	...
	,
}
...
var file_api_broker_proto_msgTypes = make([]protoimpl.MessageInfo, 77)
var file_api_broker_proto_goTypes = []any{
	...
	(*DeleteProjectRequest)(nil),              // 28: scql.pb.DeleteProjectRequest
	(*DeleteProjectResponse)(nil),             // 29: scql.pb.DeleteProjectResponse
	(*ListInvitationsRequest)(nil),            // 30: scql.pb.ListInvitationsRequest
	(*ListInvitationsResponse)(nil),           // 31: scql.pb.ListInvitationsResponse
	(*ProcessInvitationRequest)(nil),          // 32: scql.pb.ProcessInvitationRequest
	(*ProcessInvitationResponse)(nil),         // 33: scql.pb.ProcessInvitationResponse
	(*ProjectInvitation)(nil),                 // 34: scql.pb.ProjectInvitation
	(*CreateTableRequest)(nil),                // 35: scql.pb.CreateTableRequest
	(*CreateViewRequest)(nil),                 // 36: scql.pb.CreateViewRequest
	(*CreateViewResponse)(nil),                // 37: scql.pb.CreateViewResponse
	(*CreateTableResponse)(nil),               // 38: scql.pb.CreateTableResponse
	(*ListTablesRequest)(nil),                 // 39: scql.pb.ListTablesRequest
	(*ListTablesResponse)(nil),                // 40: scql.pb.ListTablesResponse
	(*ListViewsRequest)(nil),                  // 41: scql.pb.ListViewsRequest
	(*ListViewsResponse)(nil),                 // 42: scql.pb.ListViewsResponse
	(*DropTableRequest)(nil),                  // 43: scql.pb.DropTableRequest
	(*DropTableResponse)(nil),                 // 44: scql.pb.DropTableResponse
	(*DropViewRequest)(nil),                   // 45: scql.pb.DropViewRequest
	(*DropViewResponse)(nil),                  // 46: scql.pb.DropViewResponse
	(*GrantCCLRequest)(nil),                   // 47: scql.pb.GrantCCLRequest
	(*GrantCCLResponse)(nil),                  // 48: scql.pb.GrantCCLResponse
	(*RevokeCCLRequest)(nil),                  // 49: scql.pb.RevokeCCLRequest
	(*RevokeCCLResponse)(nil),                 // 50: scql.pb.RevokeCCLResponse
	(*ShowCCLRequest)(nil),                    // 51: scql.pb.ShowCCLRequest
	(*ShowCCLResponse)(nil),                   // 52: scql.pb.ShowCCLResponse
	(*ProjectConfig)(nil),                     // 53: scql.pb.ProjectConfig
	(*JobConfig)(nil),                         // 54: scql.pb.JobConfig
	(*InviteMemberRequest)(nil),               // 55: scql.pb.InviteMemberRequest
	(*InviteMemberResponse)(nil),              // 56: scql.pb.InviteMemberResponse
	(*CheckAndUpdateStatusRequest)(nil),       // 57: scql.pb.CheckAndUpdateStatusRequest
	(*CheckAndUpdateStatusResponse)(nil),      // 58: scql.pb.CheckAndUpdateStatusResponse
	(*ProjectConflict)(nil),                   // 59: scql.pb.ProjectConflict
	(*DistributeQueryRequest)(nil),            // 60: scql.pb.DistributeQueryRequest
	(*DistributeQueryResponse)(nil),           // 61: scql.pb.DistributeQueryResponse
	(*CancelQueryJobRequest)(nil),             // 62: scql.pb.CancelQueryJobRequest
	(*CancelQueryJobResponse)(nil),            // 63: scql.pb.CancelQueryJobResponse
	(*InviteToProjectRequest)(nil),            // 64: scql.pb.InviteToProjectRequest
	(*InviteToProjectResponse)(nil),           // 65: scql.pb.InviteToProjectResponse
	(*ReplyInvitationRequest)(nil),            // 66: scql.pb.ReplyInvitationRequest
	(*ReplyInvitationResponse)(nil),           // 67: scql.pb.ReplyInvitationResponse
	(*SyncInfoRequest)(nil),                   // 68: scql.pb.SyncInfoRequest
	(*ChangeEntry)(nil),                       // 69: scql.pb.ChangeEntry
	(*SyncInfoResponse)(nil),                  // 70: scql.pb.SyncInfoResponse
	(*AskInfoRequest)(nil),                    // 71: scql.pb.AskInfoRequest
	(*ResourceSpec)(nil),                      // 72: scql.pb.ResourceSpec
	(*AskInfoResponse)(nil),                   // 73: scql.pb.AskInfoResponse
	(*Checksum)(nil),                          // 74: scql.pb.Checksum
	(*ExchangeJobInfoRequest)(nil),            // 75: scql.pb.ExchangeJobInfoRequest
	(*ExchangeJobInfoResponse)(nil),           // 76: scql.pb.ExchangeJobInfoResponse
	(*TableMeta)(nil),                         // 77: scql.pb.TableMeta
	(*PrivacyPolicy)(nil),                     // 78: scql.pb.PrivacyPolicy
	(*ColumnControl)(nil),                     // 79: scql.pb.ColumnControl
	(*ColumnDef)(nil),                         // 80: scql.pb.ColumnDef
	(*CreateTableRequest_ColumnDesc)(nil),     // 81: scql.pb.CreateTableRequest.ColumnDesc
	nil,                                       // 82: scql.pb.CheckAndUpdateStatusResponse.ConflictsEntry
	(*ProjectConflict_ConflictItem)(nil),      // 83: scql.pb.ProjectConflict.ConflictItem
	(*TableMeta_Column)(nil),                  // 84: scql.pb.TableMeta.Column
	(*RequestHeader)(nil),                     // 85: scql.pb.RequestHeader
	(*DebugOptions)(nil),                      // 86: scql.pb.DebugOptions
	(*Status)(nil),                            // 87: scql.pb.Status
	(*SQLWarning)(nil),                        // 88: scql.pb.SQLWarning
	(*Tensor)(nil),                            // 89: scql.pb.Tensor
	(*JobProgress)(nil),                       // 90: scql.pb.JobProgress
	(*ExplainInfo)(nil),                       // 91: scql.pb.ExplainInfo
	(*timestamppb.Timestamp)(nil),             // 92: google.protobuf.Timestamp
	(*spu.RuntimeConfig)(nil),                 // 93: spu.pb.RuntimeConfig
	(PsiAlgorithmType)(0),                     // 94: scql.pb.PsiAlgorithmType
	(Rr22Mode)(0),                             // 95: scql.pb.Rr22Mode
	(*PartyId)(nil),                           // 96: scql.pb.PartyId
}
var file_api_broker_proto_depIdxs = []int32{
	85,  // 0: scql.pb.QueryRequest.header:type_name -> scql.pb.RequestHeader
	86,  // 1: scql.pb.QueryRequest.debug_opts:type_name -> scql.pb.DebugOptions
	54,  // 2: scql.pb.QueryRequest.job_config:type_name -> scql.pb.JobConfig
	87,  // 3: scql.pb.QueryResponse.status:type_name -> scql.pb.Status
	12,  // 4: scql.pb.QueryResponse.result:type_name -> scql.pb.QueryResult
	87,  // 5: scql.pb.SubmitResponse.status:type_name -> scql.pb.Status
	88,  // 6: scql.pb.QueryResult.warnings:type_name -> scql.pb.SQLWarning
	89,  // 7: scql.pb.QueryResult.out_columns:type_name -> scql.pb.Tensor
	90,  // 8: scql.pb.JobStatus.progress:type_name -> scql.pb.JobProgress
	87,  // 9: scql.pb.FetchResultResponse.status:type_name -> scql.pb.Status
	...
	54,  // 12: scql.pb.ExplainQueryRequest.job_config:type_name -> scql.pb.JobConfig
	87,  // 13: scql.pb.ExplainQueryResponse.status:type_name -> scql.pb.Status
	91,  // 14: scql.pb.ExplainQueryResponse.explain:type_name -> scql.pb.ExplainInfo
	87,  // 15: scql.pb.CancelQueryResponse.status:type_name -> scql.pb.Status
	53,  // 16: scql.pb.CreateProjectRequest.conf:type_name -> scql.pb.ProjectConfig
	87,  // 17: scql.pb.CreateProjectResponse.status:type_name -> scql.pb.Status
	53,  // 18: scql.pb.UpdateProjectRequest.conf:type_name -> scql.pb.ProjectConfig
	87,  // 19: scql.pb.UpdateProjectResponse.status:type_name -> scql.pb.Status
	87,  // 20: scql.pb.ListProjectsResponse.status:type_name -> scql.pb.Status
	25,  // 21: scql.pb.ListProjectsResponse.projects:type_name -> scql.pb.ProjectDesc
	53,  // 22: scql.pb.ProjectDesc.conf:type_name -> scql.pb.ProjectConfig
	92,  // 23: scql.pb.ProjectDesc.created_at:type_name -> google.protobuf.Timestamp
	87,  // 24: scql.pb.ArchiveProjectResponse.status:type_name -> scql.pb.Status
	87,  // 25: scql.pb.DeleteProjectResponse.status:type_name -> scql.pb.Status
	1,   // 26: scql.pb.ListInvitationsRequest.status:type_name -> scql.pb.InvitationStatus
	87,  // 27: scql.pb.ListInvitationsResponse.status:type_name -> scql.pb.Status
	34,  // 28: scql.pb.ListInvitationsResponse.invitations:type_name -> scql.pb.ProjectInvitation
	0,   // 29: scql.pb.ProcessInvitationRequest.respond:type_name -> scql.pb.InvitationRespond
	87,  // 30: scql.pb.ProcessInvitationResponse.status:type_name -> scql.pb.Status
	25,  // 31: scql.pb.ProjectInvitation.project:type_name -> scql.pb.ProjectDesc
	1,   // 32: scql.pb.ProjectInvitation.status:type_name -> scql.pb.InvitationStatus
	81,  // 33: scql.pb.CreateTableRequest.columns:type_name -> scql.pb.CreateTableRequest.ColumnDesc
	87,  // 34: scql.pb.CreateViewResponse.status:type_name -> scql.pb.Status
	87,  // 35: scql.pb.CreateTableResponse.status:type_name -> scql.pb.Status
	87,  // 36: scql.pb.ListTablesResponse.status:type_name -> scql.pb.Status
	77,  // 37: scql.pb.ListTablesResponse.tables:type_name -> scql.pb.TableMeta
	87,  // 38: scql.pb.ListViewsResponse.status:type_name -> scql.pb.Status
	77,  // 39: scql.pb.ListViewsResponse.views:type_name -> scql.pb.TableMeta
	87,  // 40: scql.pb.DropTableResponse.status:type_name -> scql.pb.Status
	87,  // 41: scql.pb.DropViewResponse.status:type_name -> scql.pb.Status
	79,  // 42: scql.pb.GrantCCLRequest.column_control_list:type_name -> scql.pb.ColumnControl
	87,  // 43: scql.pb.GrantCCLResponse.status:type_name -> scql.pb.Status
	79,  // 44: scql.pb.RevokeCCLRequest.column_control_list:type_name -> scql.pb.ColumnControl
	87,  // 45: scql.pb.RevokeCCLResponse.status:type_name -> scql.pb.Status
	87,  // 46: scql.pb.ShowCCLResponse.status:type_name -> scql.pb.Status
	79,  // 47: scql.pb.ShowCCLResponse.column_control_list:type_name -> scql.pb.ColumnControl
	93,  // 48: scql.pb.ProjectConfig.spu_runtime_cfg:type_name -> spu.pb.RuntimeConfig
	94,  // 49: scql.pb.ProjectConfig.psi_type:type_name -> scql.pb.PsiAlgorithmType
	95,  // 50: scql.pb.ProjectConfig.rr22_mode:type_name -> scql.pb.Rr22Mode
	94,  // 51: scql.pb.JobConfig.psi_type:type_name -> scql.pb.PsiAlgorithmType
	95,  // 52: scql.pb.JobConfig.rr22_mode:type_name -> scql.pb.Rr22Mode
	5,   // 53: scql.pb.InviteMemberRequest.method:type_name -> scql.pb.InviteMemberRequest.InvitationMethod
	87,  // 54: scql.pb.InviteMemberResponse.status:type_name -> scql.pb.Status
	87,  // 55: scql.pb.CheckAndUpdateStatusResponse.status:type_name -> scql.pb.Status
	82,  // 56: scql.pb.CheckAndUpdateStatusResponse.conflicts:type_name -> scql.pb.CheckAndUpdateStatusResponse.ConflictsEntry
	83,  // 57: scql.pb.ProjectConflict.items:type_name -> scql.pb.ProjectConflict.ConflictItem
	85,  // 58: scql.pb.DistributeQueryRequest.header:type_name -> scql.pb.RequestHeader
	3,   // 59: scql.pb.DistributeQueryRequest.client_protocol:type_name -> scql.pb.BrokerProtocolVersion
	96,  // 60: scql.pb.DistributeQueryRequest.client_id:type_name -> scql.pb.PartyId
	74,  // 61: scql.pb.DistributeQueryRequest.client_checksum:type_name -> scql.pb.Checksum
	74,  // 62: scql.pb.DistributeQueryRequest.server_checksum:type_name -> scql.pb.Checksum
	86,  // 63: scql.pb.DistributeQueryRequest.debug_opts:type_name -> scql.pb.DebugOptions
	54,  // 64: scql.pb.DistributeQueryRequest.job_config:type_name -> scql.pb.JobConfig
	92,  // 65: scql.pb.DistributeQueryRequest.created_at:type_name -> google.protobuf.Timestamp
	87,  // 66: scql.pb.DistributeQueryResponse.status:type_name -> scql.pb.Status
	3,   // 67: scql.pb.DistributeQueryResponse.server_protocol:type_name -> scql.pb.BrokerProtocolVersion
	2,   // 68: scql.pb.DistributeQueryResponse.client_checksum_result:type_name -> scql.pb.ChecksumCompareResult
	2,   // 69: scql.pb.DistributeQueryResponse.server_checksum_result:type_name -> scql.pb.ChecksumCompareResult
	74,  // 70: scql.pb.DistributeQueryResponse.expected_server_checksum:type_name -> scql.pb.Checksum
	96,  // 71: scql.pb.CancelQueryJobRequest.client_id:type_name -> scql.pb.PartyId
	87,  // 72: scql.pb.CancelQueryJobResponse.status:type_name -> scql.pb.Status
	96,  // 73: scql.pb.InviteToProjectRequest.client_id:type_name -> scql.pb.PartyId
	25,  // 74: scql.pb.InviteToProjectRequest.project:type_name -> scql.pb.ProjectDesc
	87,  // 75: scql.pb.InviteToProjectResponse.status:type_name -> scql.pb.Status
	96,  // 76: scql.pb.ReplyInvitationRequest.client_id:type_name -> scql.pb.PartyId
	0,   // 77: scql.pb.ReplyInvitationRequest.respond:type_name -> scql.pb.InvitationRespond
	87,  // 78: scql.pb.ReplyInvitationResponse.status:type_name -> scql.pb.Status
	96,  // 79: scql.pb.SyncInfoRequest.client_id:type_name -> scql.pb.PartyId
	69,  // 80: scql.pb.SyncInfoRequest.change_entry:type_name -> scql.pb.ChangeEntry
	6,   // 81: scql.pb.ChangeEntry.action:type_name -> scql.pb.ChangeEntry.Action
	87,  // 82: scql.pb.SyncInfoResponse.status:type_name -> scql.pb.Status
	96,  // 83: scql.pb.AskInfoRequest.client_id:type_name -> scql.pb.PartyId
	72,  // 84: scql.pb.AskInfoRequest.resource_specs:type_name -> scql.pb.ResourceSpec
	7,   // 85: scql.pb.ResourceSpec.kind:type_name -> scql.pb.ResourceSpec.ResourceKind
	87,  // 86: scql.pb.AskInfoResponse.status:type_name -> scql.pb.Status
	96,  // 87: scql.pb.ExchangeJobInfoRequest.client_id:type_name -> scql.pb.PartyId
	74,  // 88: scql.pb.ExchangeJobInfoRequest.server_checksum:type_name -> scql.pb.Checksum
	87,  // 89: scql.pb.ExchangeJobInfoResponse.status:type_name -> scql.pb.Status
	2,   // 90: scql.pb.ExchangeJobInfoResponse.server_checksum_result:type_name -> scql.pb.ChecksumCompareResult
	74,  // 91: scql.pb.ExchangeJobInfoResponse.expected_server_checksum:type_name -> scql.pb.Checksum
	84,  // 92: scql.pb.TableMeta.columns:type_name -> scql.pb.TableMeta.Column
	79,  // 93: scql.pb.PrivacyPolicy.column_control_list:type_name -> scql.pb.ColumnControl
	80,  // 94: scql.pb.ColumnControl.col:type_name -> scql.pb.ColumnDef
	4,   // 95: scql.pb.ColumnControl.constraint:type_name -> scql.pb.Constraint
	59,  // 96: scql.pb.CheckAndUpdateStatusResponse.ConflictsEntry.value:type_name -> scql.pb.ProjectConflict
	8,   // 97: scql.pb.IntraBrokerService.DoQuery:input_type -> scql.pb.QueryRequest
	8,   // 98: scql.pb.IntraBrokerService.SubmitQuery:input_type -> scql.pb.QueryRequest
	11,  // 99: scql.pb.IntraBrokerService.FetchResult:input_type -> scql.pb.FetchResultRequest
	15,  // 100: scql.pb.IntraBrokerService.ExplainQuery:input_type -> scql.pb.ExplainQueryRequest
	17,  // 101: scql.pb.IntraBrokerService.CancelQuery:input_type -> scql.pb.CancelQueryRequest
	19,  // 102: scql.pb.IntraBrokerService.CreateProject:input_type -> scql.pb.CreateProjectRequest
	21,  // 103: scql.pb.IntraBrokerService.UpdateProject:input_type -> scql.pb.UpdateProjectRequest
	23,  // 104: scql.pb.IntraBrokerService.ListProjects:input_type -> scql.pb.ListProjectsRequest
	26,  // 105: scql.pb.IntraBrokerService.ArchiveProject:input_type -> scql.pb.ArchiveProjectRequest
	28,  // 106: scql.pb.IntraBrokerService.DeleteProject:input_type -> scql.pb.DeleteProjectRequest
	55,  // 107: scql.pb.IntraBrokerService.InviteMember:input_type -> scql.pb.InviteMemberRequest
	30,  // 108: scql.pb.IntraBrokerService.ListInvitations:input_type -> scql.pb.ListInvitationsRequest
	32,  // 109: scql.pb.IntraBrokerService.ProcessInvitation:input_type -> scql.pb.ProcessInvitationRequest
	35,  // 110: scql.pb.IntraBrokerService.CreateTable:input_type -> scql.pb.CreateTableRequest
	39,  // 111: scql.pb.IntraBrokerService.ListTables:input_type -> scql.pb.ListTablesRequest
	43,  // 112: scql.pb.IntraBrokerService.DropTable:input_type -> scql.pb.DropTableRequest
	36,  // 113: scql.pb.IntraBrokerService.CreateView:input_type -> scql.pb.CreateViewRequest
	41,  // 114: scql.pb.IntraBrokerService.ListViews:input_type -> scql.pb.ListViewsRequest
	45,  // 115: scql.pb.IntraBrokerService.DropView:input_type -> scql.pb.DropViewRequest
	47,  // 116: scql.pb.IntraBrokerService.GrantCCL:input_type -> scql.pb.GrantCCLRequest
	49,  // 117: scql.pb.IntraBrokerService.RevokeCCL:input_type -> scql.pb.RevokeCCLRequest
	51,  // 118: scql.pb.IntraBrokerService.ShowCCL:input_type -> scql.pb.ShowCCLRequest
	57,  // 119: scql.pb.IntraBrokerService.CheckAndUpdateStatus:input_type -> scql.pb.CheckAndUpdateStatusRequest
	60,  // 120: scql.pb.InterBrokerService.DistributeQuery:input_type -> scql.pb.DistributeQueryRequest
	62,  // 121: scql.pb.InterBrokerService.CancelQueryJob:input_type -> scql.pb.CancelQueryJobRequest
	64,  // 122: scql.pb.InterBrokerService.InviteToProject:input_type -> scql.pb.InviteToProjectRequest
	66,  // 123: scql.pb.InterBrokerService.ReplyInvitation:input_type -> scql.pb.ReplyInvitationRequest
	68,  // 124: scql.pb.InterBrokerService.SyncInfo:input_type -> scql.pb.SyncInfoRequest
	71,  // 125: scql.pb.InterBrokerService.AskInfo:input_type -> scql.pb.AskInfoRequest
	75,  // 126: scql.pb.InterBrokerService.ExchangeJobInfo:input_type -> scql.pb.ExchangeJobInfoRequest
	9,   // 127: scql.pb.IntraBrokerService.DoQuery:output_type -> scql.pb.QueryResponse
	10,  // 128: scql.pb.IntraBrokerService.SubmitQuery:output_type -> scql.pb.SubmitResponse
	14,  // 129: scql.pb.IntraBrokerService.FetchResult:output_type -> scql.pb.FetchResultResponse
	16,  // 130: scql.pb.IntraBrokerService.ExplainQuery:output_type -> scql.pb.ExplainQueryResponse
	18,  // 131: scql.pb.IntraBrokerService.CancelQuery:output_type -> scql.pb.CancelQueryResponse
	20,  // 132: scql.pb.IntraBrokerService.CreateProject:output_type -> scql.pb.CreateProjectResponse
	22,  // 133: scql.pb.IntraBrokerService.UpdateProject:output_type -> scql.pb.UpdateProjectResponse
	24,  // 134: scql.pb.IntraBrokerService.ListProjects:output_type -> scql.pb.ListProjectsResponse
	27,  // 135: scql.pb.IntraBrokerService.ArchiveProject:output_type -> scql.pb.ArchiveProjectResponse
	29,  // 136: scql.pb.IntraBrokerService.DeleteProject:output_type -> scql.pb.DeleteProjectResponse
	56,  // 137: scql.pb.IntraBrokerService.InviteMember:output_type -> scql.pb.InviteMemberResponse
	31,  // 138: scql.pb.IntraBrokerService.ListInvitations:output_type -> scql.pb.ListInvitationsResponse
	33,  // 139: scql.pb.IntraBrokerService.ProcessInvitation:output_type -> scql.pb.ProcessInvitationResponse
	38,  // 140: scql.pb.IntraBrokerService.CreateTable:output_type -> scql.pb.CreateTableResponse
	40,  // 141: scql.pb.IntraBrokerService.ListTables:output_type -> scql.pb.ListTablesResponse
	44,  // 142: scql.pb.IntraBrokerService.DropTable:output_type -> scql.pb.DropTableResponse
	37,  // 143: scql.pb.IntraBrokerService.CreateView:output_type -> scql.pb.CreateViewResponse
	42,  // 144: scql.pb.IntraBrokerService.ListViews:output_type -> scql.pb.ListViewsResponse
	46,  // 145: scql.pb.IntraBrokerService.DropView:output_type -> scql.pb.DropViewResponse
	48,  // 146: scql.pb.IntraBrokerService.GrantCCL:output_type -> scql.pb.GrantCCLResponse
	50,  // 147: scql.pb.IntraBrokerService.RevokeCCL:output_type -> scql.pb.RevokeCCLResponse
	52,  // 148: scql.pb.IntraBrokerService.ShowCCL:output_type -> scql.pb.ShowCCLResponse
	58,  // 149: scql.pb.IntraBrokerService.CheckAndUpdateStatus:output_type -> scql.pb.CheckAndUpdateStatusResponse
	61,  // 150: scql.pb.InterBrokerService.DistributeQuery:output_type -> scql.pb.DistributeQueryResponse
	63,  // 151: scql.pb.InterBrokerService.CancelQueryJob:output_type -> scql.pb.CancelQueryJobResponse
	65,  // 152: scql.pb.InterBrokerService.InviteToProject:output_type -> scql.pb.InviteToProjectResponse
	67,  // 153: scql.pb.InterBrokerService.ReplyInvitation:output_type -> scql.pb.ReplyInvitationResponse
	70,  // 154: scql.pb.InterBrokerService.SyncInfo:output_type -> scql.pb.SyncInfoResponse
	73,  // 155: scql.pb.InterBrokerService.AskInfo:output_type -> scql.pb.AskInfoResponse
	76,  // 156: scql.pb.InterBrokerService.ExchangeJobInfo:output_type -> scql.pb.ExchangeJobInfoResponse
...
func file_api_broker_proto_init() {
	...
	file_api_broker_proto_msgTypes[22].OneofWrappers = []any{
		(*ListInvitationsRequest_Status)(nil),
		(*ListInvitationsRequest_Inviter)(nil),
	}
	file_api_broker_proto_msgTypes[45].OneofWrappers = []any{}
	file_api_broker_proto_msgTypes[46].OneofWrappers = []any{}
	type x struct{}
...
func (c *intraBrokerServiceClient) DeleteProject(ctx context.Context, in *DeleteProjectRequest, opts ...grpc.CallOption) (*DeleteProjectResponse, error) {
	out := new(DeleteProjectResponse)
	err := c.cc.Invoke(ctx, "/scql.pb.IntraBrokerService/DeleteProject", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *intraBrokerServiceClient) CreateView(ctx context.Context, in *CreateViewRequest, opts ...grpc.CallOption) (*CreateViewResponse, error) {
	out := new(CreateViewResponse)
	err := c.cc.Invoke(ctx, "/scql.pb.IntraBrokerService/CreateView", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *intraBrokerServiceClient) ListViews(ctx context.Context, in *ListViewsRequest, opts ...grpc.CallOption) (*ListViewsResponse, error) {
	out := new(ListViewsResponse)
	err := c.cc.Invoke(ctx, "/scql.pb.IntraBrokerService/ListViews", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *intraBrokerServiceClient) DropView(ctx context.Context, in *DropViewRequest, opts ...grpc.CallOption) (*DropViewResponse, error) {
	out := new(DropViewResponse)
	err := c.cc.Invoke(ctx, "/scql.pb.IntraBrokerService/DropView", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedIntraBrokerServiceServer) DeleteProject(context.Context, *DeleteProjectRequest) (*DeleteProjectResponse, error) {
...
func (*UnimplementedIntraBrokerServiceServer) CreateView(context.Context, *CreateViewRequest) (*CreateViewResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateView not implemented")
}
func (*UnimplementedIntraBrokerServiceServer) ListViews(context.Context, *ListViewsRequest) (*ListViewsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListViews not implemented")
}
func (*UnimplementedIntraBrokerServiceServer) DropView(context.Context, *DropViewRequest) (*DropViewResponse, error) {
...
func _IntraBrokerService_DeleteProject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteProjectRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IntraBrokerServiceServer).DeleteProject(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/scql.pb.IntraBrokerService/DeleteProject",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IntraBrokerServiceServer).DeleteProject(ctx, req.(*DeleteProjectRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _IntraBrokerService_CreateView_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateViewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IntraBrokerServiceServer).CreateView(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/scql.pb.IntraBrokerService/CreateView",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IntraBrokerServiceServer).CreateView(ctx, req.(*CreateViewRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _IntraBrokerService_ListViews_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListViewsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IntraBrokerServiceServer).ListViews(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/scql.pb.IntraBrokerService/ListViews",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IntraBrokerServiceServer).ListViews(ctx, req.(*ListViewsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _IntraBrokerService_DropView_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DropViewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IntraBrokerServiceServer).DropView(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/scql.pb.IntraBrokerService/DropView",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IntraBrokerServiceServer).DropView(ctx, req.(*DropViewRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _IntraBrokerService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _IntraBrokerService_DeleteProject_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _IntraBrokerService_CreateView_Handler,
		},
		{
			MethodName: "ListViews",
			Handler:    _IntraBrokerService_ListViews_Handler,
		},
		{
			MethodName: "DropView",
			Handler:    _IntraBrokerService_DropView_Handler,
		},
		{
			MethodName: "GrantCCL",
